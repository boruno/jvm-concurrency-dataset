...
class AtomicArrayWithCAS2AndImplementedDCSS<E : Any>(size: Int, initialValue: E) {
    ...
    fun get(index: Int): E {
        ...
        if (cellState is AtomicArrayWithCAS2AndImplementedDCSS<*>.CAS2Descriptor) {
            if (cellState.status.get() == SUCCESS) {
                return cellState.getUpdateValue(index) as E
            } else {
                return cellState.getExpectedValue(index) as E
            }
        } else {
    ...
    inner class CAS2Descriptor(
        ...
        fun getExpectedValue(index: Int) =
            if (index == index1) expected1 else expected2

        fun getUpdateValue(index: Int) =
