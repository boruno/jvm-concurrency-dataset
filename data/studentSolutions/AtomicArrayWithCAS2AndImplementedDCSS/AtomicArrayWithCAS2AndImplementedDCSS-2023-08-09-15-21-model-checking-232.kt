...
class AtomicArrayWithCAS2AndImplementedDCSS<E : Any>(size: Int, initialValue: E) {
    ...
    fun dcss(
        ...
        val safeArray = AtomicArrayWithCAS2AndImplementedDCSS<Any>(2, expectedCellState as Any)
        safeArray.cas2(0, expectedCellState, expectedCellState, 1, expectedCellState, statusReference.get())
        return safeArray.cas2(0, expectedCellState, updateCellState as Any, 1, expectedStatus as Any, expectedStatus)
    }
//    =
