...
class AtomicArrayWithCAS2AndImplementedDCSS<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun helpToProcess(): Boolean {
            if (dcss(index1, expected1, this, status, UNDECIDED) || status.get() == SUCCESS || array.get(index1) == this) {
                if (dcss(index2, expected2, this, status, UNDECIDED) || status.get() == SUCCESS || array.get(index2) == this) {
