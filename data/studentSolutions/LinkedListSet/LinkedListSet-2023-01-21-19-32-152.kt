        ...
        while (true) {
            ...
            if (nextNode === last) {
                ...
                if (prevNode.casNext(nextNode, newNode)) {
                    newNode.casPrev(prevNode, newNode)
                    return true
                } else {
                    continue
                }
                ...
                while (true) {
                    ...
                    if (prevNode.element == element || nextNode!!.element == element) return false
                    if (prevNode.element < element && nextNode.element > element) break
