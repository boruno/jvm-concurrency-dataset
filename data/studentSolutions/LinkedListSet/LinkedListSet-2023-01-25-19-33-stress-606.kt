    ...
    fun add(element: E): Boolean {
        while (true) {
            ...
            if (curValue != null || nextValue != null) {
                if (curValue == null && element <= (nextValue as Node<E>).element) {
                    curValue = nextValue
                    nextValue = nextValue.next
                }

                while (element <= (curValue as Node<E>).element && element > (nextValue as Node<E>).element || nextValue != null) {
                    curValue = nextValue
            ...
            return (curValue as Node<E>).casNext(curValue, insertionNode)
        }
    }
