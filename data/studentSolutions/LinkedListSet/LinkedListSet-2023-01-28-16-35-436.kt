...
class LinkedListSet<E : Comparable<E>> {
    private val first = Node<E>(elem = Int.MIN_VALUE as E, next = null)
    private val last = Node<E>(elem = Int.MIN_VALUE as E, next = null)
    init {
...
private class Node<E : Comparable<E>>(val elem: E?, next: Node<E>?) {
