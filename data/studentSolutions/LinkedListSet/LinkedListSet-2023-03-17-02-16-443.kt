...
private class Window<E : Comparable<E>>(val pred : Node<E>, val curr : Node<E>) {
...
//    }
    ...
    private fun find (head : Node<E>, key : E) : Pair<Node<E>, Node<E>> {
        var (pred, curr, succ) = listOf<Node<E>?>(null, null, null)
        ...
        retry@ while (true)  {
            ...
            while (true) {
                ...
                while (marked[0]) {
                    snip = pred!!._next.compareAndSet(curr, succ, false, false)
                    if (! snip) {
                        continue@retry
                    }
                    curr = succ!!
