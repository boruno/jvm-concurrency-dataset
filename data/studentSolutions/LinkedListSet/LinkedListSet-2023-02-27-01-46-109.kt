    ...
    fun remove(element: E): Boolean {
        while (true) {
            ...
            if (second == last || second.element < element) {
                ...
                if (second.casNext(second.next, Wrapper(second.element, second.next))) {
...
private open class Node<E : Comparable<E>>(prev: Node<E>? = null, element: E?, next: Node<E>?) {
...
private class Wrapper<E : Comparable<E>>(element: E?, next: Node<E>?): Node<E>(element = element, next = next)