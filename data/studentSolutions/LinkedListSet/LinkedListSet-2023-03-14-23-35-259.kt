...
class LinkedListSet<E : Comparable<E>> {
    ...
    fun add(element: E): Boolean {
        while (true) {
            ...
            while (curr.element != null && curr.element!! < element && curr != last) {
                curr = curr.next!!
            }
    ...
    fun remove(element: E): Boolean {
        while (true) {
            ...
            if (curr.next == null || curr.element != element || curr == last || curr._deleted) {
                return false
            }
    ...
    fun contains(element: E): Boolean {
        var curr = head.value.next!!
        while (curr.next != last && curr.element!! < element) {
            curr = curr.next!!
        }
...
private class Node<E : Comparable<E>>(prev: Node<E>?, element: E?, next: Node<E>?) {
    ...
    val _deleted get() = deleted.value
