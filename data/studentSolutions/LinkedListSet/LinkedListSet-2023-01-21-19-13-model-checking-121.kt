...
class LinkedListSet<E : Comparable<E>> {
    ...
    fun remove(element: E): Boolean {
        ...
        while(true) {
            ...
            if ((rightElement === last) && (currentElement.element == element))
                found = true
            ...
            {
                currentElement.casNext(rightElement, rightElement.next)
                rightElement.next!!.casPrev(rightElement, currentElement)
                continue
            }
            if (leftElement!!.removed.get())
            {
                currentElement.casPrev(leftElement, leftElement.prev)
                leftElement.prev!!.casNext(leftElement, currentElement)
                continue
            }
            if(!leftElement.casNext(currentElement, currentElement.next))
            {
                continue
            }
            if(!rightElement.casPrev(currentElement, currentElement.prev))
            {
