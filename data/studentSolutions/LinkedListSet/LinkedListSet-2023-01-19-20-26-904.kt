...
class LinkedListSet<E : Comparable<E>> {
    private val first = Node<E>(element = null, next = null, Int.MIN_VALUE)
    private val last = Node<E>(element = null, next = null, Int.MAX_VALUE)
    init {
    ...
    fun add(element: E): Boolean {
        while (true) {
            ...
            if (curr.element == element) {
                ...
                val node = Node(element, curr, null)
    ...
    fun contains(element: E): Boolean {
        ...
        var curr = head
        while (curr.reference.element < element) {
...
private fun <E: Comparable<E>> find(head: Node<E>, key: E): Window<E> {
    ...
    loop@ while (true) {
        ...
        while (true) {
            ...
            if (curr!!.element>= key) return Window(pred!!, curr)
            pred = curr
            curr = succ
        }
    }
...
private class Node<E : Comparable<E>>(element: E?, next: Node<E>?, key: Int?) {
