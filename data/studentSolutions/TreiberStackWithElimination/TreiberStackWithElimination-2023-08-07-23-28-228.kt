...
open class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPopElimination(): E? {
        ...
        if (!eliminationArray.compareAndSet(randomIndex, CELL_STATE_RETRIEVED, CELL_STATE_RETRIEVED) && !eliminationArray.compareAndSet(randomIndex, CELL_STATE_EMPTY, CELL_STATE_EMPTY)) {
            return eliminationArray.getAndSet(randomIndex, CELL_STATE_RETRIEVED) as E?
        }
        return null
    }
