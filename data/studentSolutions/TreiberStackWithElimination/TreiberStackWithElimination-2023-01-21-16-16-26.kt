...
class TreiberStackWithElimination<E> {
    ...
    fun push(x: E) {
        ...
        while (true) {
            ...
            if(eliminationArray[index].value != null && eliminationArray[index].value!!.state == EliminationState.DONE && eliminationArray[index].value!!.elimIndex == elimIdx){
                val cur = eliminationArray[index].value
                eliminationArray[index].compareAndSet(cur, null)
                return
            }
            if(eliminationArray[index].value != null && eliminationArray[index].value!!.state == EliminationState.POP){
            ...
            if(eliminationArray[index].value != null && eliminationArray[index].value!!.state == EliminationState.PUSH && eliminationArray[index].value!!.elimIndex == elimIdx){
    ...
    fun pop(): E? {
        ...
        while(true) {
            ...
            if(eliminationArray[index].value != null && eliminationArray[index].value!!.state == EliminationState.PUSH){
                val curRecord = eliminationArray[index].value
                val newRecord = EliminationRecord<E>(null, EliminationState.DONE, elimIdx)
                if(eliminationArray[index].compareAndSet(curRecord, newRecord))
                    return curRecord!!.x
            }
            if(eliminationArray[index].value != null && eliminationArray[index].value!!.state == EliminationState.POP && eliminationArray[index].value!!.elimIndex == elimIdx){
                if(!eliminationArray[index].compareAndSet(eliminationRecord, null))
                    continue
            }
