...
open class TreiberStackWithElimination<E> : Stack<E> {
    ...
    protected open fun tryPushElimination(element: E): Boolean {
        ...
        val eliminator = eliminationArray.get(randomCellIndex)
        if (eliminator != CELL_STATE_EMPTY) return false

        if (eliminationArray.compareAndSet(randomCellIndex, CELL_STATE_EMPTY, element)) return false
    ...
    private fun tryPopElimination(): E? {
        ...
        return when {
            ...
            eliminationArray.compareAndSet(randomCellIndex, element, CELL_STATE_RETRIEVED) -> element as E?
