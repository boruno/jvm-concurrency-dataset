...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        if (eliminationCell.compareAndSet(CELL_STATE_EMPTY, element)) {
            ...
            // we should only get this far if eliminationCell.value == CELL_STATE_RETRIEVED
            eliminationCell.value = CELL_STATE_EMPTY
            return true
        } else {
            return false
        }
    ...
    private fun tryPopElimination(): E? {
        ...
        val eliminationCellIndex = randomCellIndex()
        val eliminationCell = eliminationArray[eliminationCellIndex]
        val element = eliminationCell.value ?: return CELL_STATE_EMPTY
