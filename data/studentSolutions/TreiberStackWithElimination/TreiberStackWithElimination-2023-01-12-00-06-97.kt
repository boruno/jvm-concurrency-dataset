...
class TreiberStackWithElimination<E> {
    ...
    fun push(x: E) {
        ...
        while (iterationsSearching > 0) {
            ...
            if (eliminationArray[index].compareAndSet(null, x)) {
                ...
                eliminationArray[index].compareAndSet(x, null)
                break
            }
    ...
    fun pop(): E? {
        ...
        while (iterationsSearching > 0) {
            val index = random()
            val eliminationElement = eliminationArray[index].getAndSet(null)
...
private const val ITERATIONS_WAITING = 10
private const val ITERATIONS_SEARCHING = 10