...
//        TODO("Implement me!")
        ...
        if (!cell.compareAndSet(CELL_STATE_EMPTY, element)) {
            return false // there are not enough pops, aka there are more considerably pushes than pops
        }
...
//        TODO("Implement me!")
        ...
        return if (cell.compareAndSet(value, CELL_STATE_RETRIEVED)) value as E
        else null
    }
