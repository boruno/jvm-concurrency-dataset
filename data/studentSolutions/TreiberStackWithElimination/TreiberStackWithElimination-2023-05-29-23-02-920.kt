...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPopElimination(): E? {
        ...
        eliminationArray[index].also {
            ...
            // check if retrieved value is empty
            if (returnedValue == CELL_STATE_RETRIEVED || returnedValue == null) return null

            // try to retrieve value
            if (it.compareAndSet(returnedValue, CELL_STATE_RETRIEVED)) {
                return returnedValue as E?
            }
            // this means value already changed, pop from stack
            return null
        }
    }
