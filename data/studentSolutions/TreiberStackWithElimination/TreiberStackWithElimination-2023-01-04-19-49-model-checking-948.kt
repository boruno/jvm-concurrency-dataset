...
class TreiberStackWithElimination<E> {
     ...
     */
    fun pop(): E? {
        var t1 = eliminationArray[ 1 ].value
        var t0 = eliminationArray[ 0 ].value
        if ( t1 != null )
            return eliminationArray[1].compareAndSet( t1, null ) as E?
        if ( t0 != null )
            return eliminationArray[ 0 ].compareAndSet( t0, null ) as E?
//        if ( eliminationArray[ 1 ].value != null ) {
////            return 88 as E?
//            return eliminationArray[ 1 ].getAndSet(  eliminationArray[0].value, null ) as E?
//        }
//        if ( eliminationArray[ 0 ].value != null ) {
////            return 44 as E?
//            return eliminationArray[ 0 ].compareAndSet( eliminationArray[0].value, null ) as E?
//        }
//        if ( checkNotNull( eliminationArray[ 1 ].value. ) {
