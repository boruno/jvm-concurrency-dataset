...
open class TreiberStackWithElimination<E> : Stack<E> {
    ...
    val eliminationArray = AtomicReferenceArray<Any?>(ELIMINATION_ARRAY_SIZE)
    ...
    private fun tryPopElimination(): E? {
        val cellIndex = randomCellIndex()
        val cellValue = eliminationArray[cellIndex] ?: return null

        val result = eliminationArray.compareAndSet(cellIndex, cellValue, CELL_STATE_RETRIEVED)
