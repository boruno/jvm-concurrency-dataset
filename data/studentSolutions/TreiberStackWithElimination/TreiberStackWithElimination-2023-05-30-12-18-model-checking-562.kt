...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        repeat(ELIMINATION_WAIT_CYCLES) {
            ...
            // TODO: returning `true`.
            if (randomElement.compareAndSet(CELL_STATE_RETRIEVED, CELL_STATE_EMPTY)) {
        ...
        while (true) {
            if (randomElement.compareAndSet(element, CELL_STATE_EMPTY)) return false
        }
    }
    ...
    private fun tryPopElimination(): E? {
        ...
        val element = randomElement.value
        if (
            element != CELL_STATE_EMPTY
            && element != CELL_STATE_RETRIEVED
            && randomElement.compareAndSet(element, CELL_STATE_RETRIEVED)
        ) {
