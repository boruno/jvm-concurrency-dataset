...
open class TreiberStackWithElimination<E> : Stack<E> {
    ...
    protected open fun tryPushElimination(element: E): Boolean {
        ...
        val res = eliminationArray[randIdx].getAndSet(CELL_STATE_EMPTY)
        return res == CELL_STATE_RETRIEVED
    ...
    private fun tryPopElimination(): E? {
        ...
        if (curVal.value != CELL_STATE_EMPTY
            && curVal.value != CELL_STATE_RETRIEVED
