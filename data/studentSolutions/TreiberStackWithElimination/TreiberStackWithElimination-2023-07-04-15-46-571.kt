...
//        System.err.println("helllo")
        ...
        if (value.value == CELL_STATE_EMPTY || value.value == CELL_STATE_RETRIEVED) {
            return null
        } else {
            if (eliminationArray[index].compareAndSet(value.value, CELL_STATE_RETRIEVED)) {

//                System.err.println("helllo")

//        if (value.value != CELL_STATE_EMPTY && value.value != CELL_STATE_EMPTY && eliminationArray[index].compareAndSet(value.value, CELL_STATE_RETRIEVED)) {
