...
/**
    ...
    /*var eliminationIndex = -1
        ...
        for(i in 0..MAX_ELIMINATION_ITERATIONS) {
            ...
            if (eliminationStates[eliminationIndex].compareAndSet(0, 5)) {
...
/**
     ...
     */
        ...
        for (i in 0..MAX_ELIMINATION_ITERATIONS) {
            ...
            if (eliminationStates[eliminationIndex].compareAndSet(1, 3)) {
                val k = eliminationArray[eliminationIndex].value
                eliminationStates[eliminationIndex].value = 4
                return k
            }
        }
