...
class TreiberStackWithElimination<E> {
    ...
    private val randomInteger = ThreadLocalRandom.current().nextInt()
    /**
    ...
    fun push(x: E) {
        ...
        for (i in 0..100 ) {
            val index = randomInteger % ELIMINATION_ARRAY_SIZE
            ...
            if (eliminationArray[index].compareAndSet(EliminationValue(null, "pop"), EliminationValue(x, "pop"))
            ){
                return
            }
        }
