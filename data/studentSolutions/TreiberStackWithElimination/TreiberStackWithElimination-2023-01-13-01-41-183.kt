...
class TreiberStackWithElimination<E> {
     ...
     */
    fun push(x: E) {
        val random_cell = ThreadLocalRandom.current().nextInt(0, 0)
     ...
     */
    fun pop(): E? {
        val random_cell = ThreadLocalRandom.current().nextInt(0, 1)
        val item = eliminationArray[random_ceil].value
        if (item != null) {
...
private const val random_ceil = 1