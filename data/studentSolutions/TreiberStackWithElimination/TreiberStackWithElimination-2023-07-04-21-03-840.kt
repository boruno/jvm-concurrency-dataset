...
//        TODO("Implement me!")
        ...
        val elementReset = eliminationArray[cellIndex].compareAndSet(element, CELL_STATE_EMPTY)
        if (elementReset) {
            return false
        }
        val retrievedReset = eliminationArray[cellIndex].compareAndSet(CELL_STATE_RETRIEVED, CELL_STATE_EMPTY)
        if (retrievedReset) {
            return true
        }
        return false
