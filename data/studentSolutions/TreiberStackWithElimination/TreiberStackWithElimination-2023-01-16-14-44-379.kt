...
class TreiberStackWithElimination<E> {
    ...
    fun push(x: E) {
        ...
        while (ch < 10 && idx != null) {
            if (eliminationArray[idx].value == -69420) {
                if (eliminationArray[idx].compareAndSet(-69420, null)) {
                    return
                }
            }
            ch++
    ...
    fun pop(): E? {
        ...
        if (task != null) {
            if (eliminationArray[0].compareAndSet(task, -69420)) {
                return task as E?
            }
        }
        val task1 = eliminationArray[1].value
        if (task1 != null) {
            if (eliminationArray[1].compareAndSet(task1, -69420)) {
                return task1 as E?
            }
        }
        while(true) {
