...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        return false
//        val witness = eliminationArray.getAndSet(cellIndex, CELL_STATE_EMPTY)
//        if (witness === element) {
//            return false
//        } else if (witness === CELL_STATE_RETRIEVED) {
//            return true
//        } else {
//            error("opa")
//        }
    ...
    override fun pop(): E? {
        val cellIndex = randomCellIndex()
        val value = eliminationArray.get(cellIndex)
        if (value != CELL_STATE_EMPTY && value != CELL_STATE_RETRIEVED) {
            if (eliminationArray.compareAndSet(cellIndex, value, CELL_STATE_RETRIEVED)) {
                return value as E?
            }
        }
        return stack.pop()
