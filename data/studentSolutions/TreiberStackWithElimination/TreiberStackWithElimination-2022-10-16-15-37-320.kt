...
class TreiberStackWithElimination<E> {
    ...
    private fun tryPushToEliminationArray(x: E): Boolean {
        val i = Random.nextInt(
            ELIMINATION_ARRAY_SIZE
        )
        for (j in 0 until ELIMINATION_ARRAY_SIZE) {
            val cell = eliminationArray[(i + j) % ELIMINATION_ARRAY_SIZE];
     ...
     */
    fun pop(): E? {
        var result: E? // tryPopFromEliminationArray()
//        if (result != null) {
//            return result
//        }
        do {
