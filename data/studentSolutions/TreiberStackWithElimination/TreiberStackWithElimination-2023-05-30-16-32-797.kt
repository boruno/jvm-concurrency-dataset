...
//        TODO("Implement me!")
        ...
        return eliminationArray[index].compareAndSet(CELL_STATE_RETRIEVED, CELL_STATE_EMPTY)
    }
...
//        TODO("Implement me!")
        ...
        val elementUnknownType = eliminationArray[index].value

        if (elementUnknownType == CELL_STATE_EMPTY || elementUnknownType == CELL_STATE_RETRIEVED) {
            return null
        }

        val element = elementUnknownType as E?
