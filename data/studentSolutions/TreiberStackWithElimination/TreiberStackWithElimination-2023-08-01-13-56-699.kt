...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        if (eliminationArray[index].compareAndSet(CELL_STATE_EMPTY, element)) {
            ...
            for (i in 0..ELIMINATION_WAIT_CYCLES) {
                retrieved = eliminationArray[index].value == CELL_STATE_RETRIEVED
            }
    ...
    private fun tryPopElimination(): E? {
        ...
        //if(prevValue == CELL_STATE_EMPTY || prevValue == CELL_STATE_RETRIEVED) return null
        eliminationArray[index].compareAndSet(prevValue, CELL_STATE_RETRIEVED)
        //val prevValueCasted = prevValue as E
        //eliminationArray[index].compareAndSet(prevValue, CELL_STATE_RETRIEVED)
//        if (eliminationArray[index].compareAndSet(prevValue, CELL_STATE_RETRIEVED)) {
//            return prevValue.value as? E
//        } else {
//            return null
//        }
