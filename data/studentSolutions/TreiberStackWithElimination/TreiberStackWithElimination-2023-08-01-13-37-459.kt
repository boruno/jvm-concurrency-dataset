...
//        TODO("Implement me!")
    ...
    private fun tryPopElimination(): E? {
        ...
        while (i < ELIMINATION_WAIT_CYCLES) {
            ...
            val index = randomCellIndex()
            val ref = eliminationArray[index]
            val element = ref.value
            if (element == CELL_STATE_EMPTY || element == CELL_STATE_RETRIEVED) continue
            if (ref.compareAndSet(element, CELL_STATE_RETRIEVED)) return element as E
        }
