...
open class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPopElimination(): E? {
        ...
        return if (element != CELL_STATE_EMPTY && element != CELL_STATE_RETRIEVED) {
            println("Updating to retreived for $element")
            if (eliminationArray.compareAndSet(index, element, CELL_STATE_RETRIEVED)) println("Update for retrieved for $element done")
