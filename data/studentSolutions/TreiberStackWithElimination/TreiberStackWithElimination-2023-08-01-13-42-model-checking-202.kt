...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        val result = eliminationArray[index].compareAndSet(CELL_STATE_EMPTY, element)
    ...
    private fun tryPopElimination(): E? {
        ...
        val result = eliminationArray[randomCell].compareAndSet(CELL_STATE_EMPTY, CELL_STATE_RETRIEVED)
