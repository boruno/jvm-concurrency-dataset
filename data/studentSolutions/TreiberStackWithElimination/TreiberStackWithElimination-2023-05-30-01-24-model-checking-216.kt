    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        eliminationArray[index].also {
            ...
            if (it.compareAndSet(CELL_STATE_EMPTY, element)) {
                ...
                val value = it.getAndSet(CELL_STATE_EMPTY)

                while (it.compareAndSet(value, CELL_STATE_EMPTY)) {

                }
                return value == CELL_STATE_RETRIEVED
    ...
    private fun tryPopElimination(): E? {
        ...
        eliminationArray[index].also {
            ...
            if (it.compareAndSet(retrievedValue, CELL_STATE_RETRIEVED)) {
                if (retrievedValue != CELL_STATE_RETRIEVED) return retrievedValue as E?
            }
        }
        return null
    }
