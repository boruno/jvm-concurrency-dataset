...
class TreiberStackWithElimination<E> {
    ...
    private fun getRandomEliminationElement(): Int = Random.nextInt(ELIMINATION_ARRAY_SIZE)
    ...
    fun push(x: E) {
        ...
        val currRandomValue = randomCell.value
        if (currRandomValue == null) {
            if (randomCell.compareAndSet(null, x)) {
                //
                for (i in 0..FOR_REPEAT_DELAY_COUNT) {}
    ...
    fun pop(): E? {
        ...
        while (true) {
            val currValue = randomCell.value ?: return baseStackPop()

            if (randomCell.compareAndSet(currValue, null)) {
                return currValue
            }
