...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        if (randomCell.compareAndSet(CELL_STATE_EMPTY, element)) {
            ...
            return if (randomCell.compareAndSet(CELL_STATE_RETRIEVED, CELL_STATE_EMPTY)) {
                true
            } else {
    ...
    private fun tryPopElimination(): E? {
        ...
        if (value == CELL_STATE_EMPTY || value == CELL_STATE_RETRIEVED) {
            ...
            return if (randomCell.compareAndSet(value, CELL_STATE_RETRIEVED)) value as E else null
        }
    }
