...
open class TreiberStackWithElimination<E> : Stack<E> {
    ...
    protected open fun tryPushElimination(element: E): Boolean {
        ...
        if (eliminationArray.compareAndSet(cellIndex, CELL_STATE_EMPTY, element)) {
            ...
            return eliminationArray.compareAndSet(cellIndex, element, CELL_STATE_EMPTY)
        } else return false
    }
    ...
    private fun tryPopElimination(): E? {
        ...
        val cellIndex = randomCellIndex()
        return eliminationArray.getAndUpdate(cellIndex) { state ->
            if (state == CELL_STATE_EMPTY || state == CELL_STATE_RETRIEVED) return@getAndUpdate null
