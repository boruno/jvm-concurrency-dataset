...
open class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPopElimination(): E? {
        ...
        val cellIndex = randomCellIndex()
        val result = eliminationArray.getAndUpdate(cellIndex) {
            if (it == CELL_STATE_EMPTY || it == CELL_STATE_RETRIEVED) CELL_STATE_EMPTY
            else CELL_STATE_RETRIEVED
        }
        if (result == null || result == CELL_STATE_RETRIEVED) return null
        return result as E
    }
