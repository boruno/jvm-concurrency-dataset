...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        val randomCellIndexValue = randomCellIndex()
        val cell = eliminationArray[randomCellIndexValue]


        val result = cell.compareAndSet(null, element)
    ...
    private fun tryPopElimination(): E? {
        ...
        val cell = eliminationArray[randomCell]
