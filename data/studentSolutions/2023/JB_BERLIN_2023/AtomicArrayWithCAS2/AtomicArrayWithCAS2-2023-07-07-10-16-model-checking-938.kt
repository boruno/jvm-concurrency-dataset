...
*/
    ...
    fun cas2(
        ...
        if (!descriptor.tryInstallDescriptor1()) return false
        descriptor.apply()
    ...
    inner class CAS2Descriptor(
        ...
        private fun tryInstallDescriptor(): Boolean {
            return tryInstallDescriptor1() &&
                    tryInstallDescriptor2()
        }

        fun tryInstallDescriptor1(): Boolean {
            return tryInstallDescriptor(index1, expected1, false)
        }

        private fun tryInstallDescriptor2(): Boolean {
            return tryInstallDescriptor(index2, expected2, true)
        }
