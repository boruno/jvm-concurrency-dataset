...
//            value.apply()
    ...
    inner class CAS2Descriptor(
        ...
        inner class DSSDescriptor(val index: Int, val expected: Any?, val update: Any?, val setStatus: Status) {
            ...
            fun apply() {
                while (true) {
                    ...
                    if (localStatus == Status.SUCCESS) {
                        ...
                        status.compareAndSet(this, setStatus)
                        return
                    }
                    ...
                    if (!status.compareAndSet(setStatus, this)) {
