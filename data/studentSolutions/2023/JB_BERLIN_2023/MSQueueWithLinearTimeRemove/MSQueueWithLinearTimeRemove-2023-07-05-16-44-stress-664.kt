    ...
    override fun enqueue(element: E) {
        ...
        while(true) {
            ...
            if (curTail.next.compareAndSet(null, node)) {
                //
//                if (node.extractedOrRemoved) return
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (this == head.value || this == tail.value) return logicallyRemoved
        ...
        fun removePhysically() {
            val prevNode = getPrev()
            if (prevNode == null) return

            val nextNode = next.value

            prevNode.next.compareAndSet(this, nextNode)
            if (prevNode.extractedOrRemoved == true) prevNode.remove()
