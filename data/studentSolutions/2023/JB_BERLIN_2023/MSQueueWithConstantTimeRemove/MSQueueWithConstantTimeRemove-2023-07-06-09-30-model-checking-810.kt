...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            val localPrev = localNext.prev.value


            if (head.compareAndSet(localHead, localNext)) {
                localNext.prev.compareAndSet(localPrev, null)
                if (localNext.markExtractedOrRemoved())
...
//        return
    ...
    private inner class Node<E>(
        ...
        fun removePhysically() {
            val localNext = this.next.value ?: return
            val localPrev = this.prev.value ?: return
