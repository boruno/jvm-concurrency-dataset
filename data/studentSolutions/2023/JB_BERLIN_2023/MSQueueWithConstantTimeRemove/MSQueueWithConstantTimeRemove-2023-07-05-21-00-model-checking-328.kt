...
//            TODO("Implement me!")
        ...
        internal fun forceRemove() {
            ...
            while (true) {
                ...
                val oldPrevValue = nextValue.prev.value
                ...
                if (prevValue != null && prevValue.next.compareAndSet(this, nextValue)) {
                    if (prevValue.extractedOrRemoved) prevValue.forceRemove()
                }
                if (!nextValue.prev.compareAndSet(prevValue, oldPrevValue)) {
                    throw IllegalStateException("Can't revert state")
                }
