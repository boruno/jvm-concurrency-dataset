...
//        TODO("Implement me!")
        ...
        if (eliminationArray[randomIndex].value == CELL_STATE_EMPTY || eliminationArray[randomIndex].value == CELL_STATE_RETRIEVED) {
            return null
        } else {
            if (eliminationArray[randomIndex].compareAndSet(randomCell.value, CELL_STATE_RETRIEVED)) {
                println("hhh")
