...
//        TODO("Implement me!")
        while (true) {
            ...
            val curHeadNextElem = curHead.next.get() ?: return null
            if (head.compareAndSet(curHead, curHeadNextElem)) {
                if (!curHeadNextElem.markExtractedOrRemoved()) return curHeadNextElem.element
            }
        }
    }
