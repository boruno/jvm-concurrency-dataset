...
class MSQueueWithLinearTimeNonParallelRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            // Remove physically
            if (t.extractedOrRemoved) {
                t = t.removePhysically() ?: continue // TODO without this the test should fail 
            }
...
//                tail.value = t.next.value!!
    ...
    private inner class Node(
        ...
        fun removePhysically(): Node? {
            val curNext = next.value // ?: return
            val prev = findPrev() ?: return null
