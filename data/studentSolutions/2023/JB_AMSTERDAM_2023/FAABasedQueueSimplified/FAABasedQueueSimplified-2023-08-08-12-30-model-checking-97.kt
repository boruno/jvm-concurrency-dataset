...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        while (true) {
            ...
            if (infiniteArray.compareAndSet(enqIndex.toInt(), null, element)) return
        }
    }
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            if (infiniteArray.compareAndSet(deqIndex.toInt(), null, POISONED)) continue
            val res = infiniteArray.get(deqIndex.toInt()) as E
            infiniteArray.set(deqIndex.toInt(), null)
            return res
        }
    }
