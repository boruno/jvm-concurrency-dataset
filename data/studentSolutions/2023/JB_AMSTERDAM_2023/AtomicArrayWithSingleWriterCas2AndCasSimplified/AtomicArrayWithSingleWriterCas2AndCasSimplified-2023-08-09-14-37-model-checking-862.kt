...
import day3.AtomicArrayWithSingleWriterCas2AndCasSimplified.Status.*
import java.util.concurrent.atomic.*

class AtomicArrayWithSingleWriterCas2AndCasSimplified<E : Any>(size: Int, initialValue: E) {
    ...
    fun get(index: Int): E {
        ...
        return if (cell is AtomicArrayWithSingleWriterCas2AndCasSimplified<*>.CAS2Descriptor) {
    ...
    fun cas(index: Int, expected: E, update: E): Boolean {
        val cell = array[index]
        if (cell is AtomicArrayWithSingleWriterCas2AndCasSimplified<*>.CAS2Descriptor) {
            cell.apply()
        }
        ...
        private fun install(index: Int, expected: E): Boolean {
            ...
            while (true) {
                when (val cell = array[index]) {
                    ...
                    is AtomicArrayWithSingleWriterCas2AndCasSimplified<*>.CAS2Descriptor -> {
                        cell.apply()
                    }
