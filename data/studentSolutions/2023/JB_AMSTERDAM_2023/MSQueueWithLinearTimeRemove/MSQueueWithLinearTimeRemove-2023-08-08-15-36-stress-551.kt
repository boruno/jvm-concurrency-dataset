        ...
        while (true) {
            ...
            if (curTail.next.compareAndSet(null, node)) {
                ...
                if (curTail.extractedOrRemoved) {
                    var ptr = head.get()
                    while (ptr != null) {
                        if (ptr.next.compareAndSet(curTail, node)) {
                            return
                        }
                        ptr = ptr.next.get()
                    }
                ...
                // HELPING: a different thread tries to move the tail forward
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (markExtractedOrRemoved()) {
                if (this != tail.get()) {
                    var ptr = head.get()
                    while (ptr.next.get() != this) {
                        val next = ptr.next.get()
                        if (next == null) {
                            return true
                        }
                        ptr = next
                    }
                    ptr.next.compareAndSet(this, this.next.get())
                    val next = ptr.next.get()
