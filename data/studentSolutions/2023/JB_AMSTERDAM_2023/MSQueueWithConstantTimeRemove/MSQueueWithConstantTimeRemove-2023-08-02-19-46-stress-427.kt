...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        while (true) {
            val node = Node(element = element, prev = null)
            ...
            if (curTail.next.compareAndSet(null, node)) {
                ...
                val currentNextTail = curTail.next.value!!
                tail.compareAndSet(curTail, currentNextTail)
                currentNextTail.prev.compareAndSet(null, curTail)
            }
        }
