...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
        ...
        while (true) {
            ...
            if (currentTail.next.compareAndSet(null, newNode)) {
                if (tail.compareAndSet(currentTail, newNode)) {
                    newNode.prev.value = currentTail
                }
                ...
                currentTail.next.value?.let {
                    if (tail.compareAndSet(currentTail, it)) {
                        it.prev.value = currentTail
                    }
    ...
    private class Node<E>(
        ...
        private fun findPreviousNode(): Node<E>? = this.prev.value
    }
}