...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> { // TODO TBD
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            while (true) {
                val curPrev1 = prev.get()
                val curNext = next.get()
                val curPrev2 = prev.get()
                if (curPrev1 != curPrev2) {
                    continue
                }
                // head or tail
                if (curPrev1 != null && curNext != null) {
                    curPrev1.next.compareAndSet(this, curNext)
                    curNext.prev.compareAndSet(this, curPrev1)
