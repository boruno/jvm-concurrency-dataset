...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun tryRemovePhysically() {
            while (true) {
                val previous1 = this.prev.get() // TODO: this can be non-working
                val curNext = this.next.get()
                val previous2 = this.prev.get()

                if (previous1 === previous2) {
                    if (previous1 != null && curNext != null) {
                        previous1.next.compareAndSet(this, curNext)
                        curNext.prev.compareAndSet(this, previous1)
