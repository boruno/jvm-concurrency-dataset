...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            val newNewHead = Node(newHead.element, null)
            if (head.compareAndSet(curHead, newNewHead) && newNewHead.markExtractedOrRemoved()) {
...
//            prev.set(null)
            ...
            val newNext = Node(myNext.element, this)
            next.set(newNext)
