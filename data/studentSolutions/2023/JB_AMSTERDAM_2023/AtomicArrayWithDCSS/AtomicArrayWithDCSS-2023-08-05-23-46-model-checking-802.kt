...
//        return true
    ...
    inner class DCSSDescriptor(
        ...
        fun tryToHelp (descr : AtomicArrayWithDCSS<*>.DCSSDescriptor) = when (descr.status.value) {
            ...
            Status.FAILED -> array[descr.index1].compareAndSet(descr, descr.expected1) as Unit
            Status.SUCCESS -> array[descr.index1].compareAndSet(descr, descr.update1) as Unit
        }
