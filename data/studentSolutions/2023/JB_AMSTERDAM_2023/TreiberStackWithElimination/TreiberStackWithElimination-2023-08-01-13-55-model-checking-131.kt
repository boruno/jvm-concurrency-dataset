...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        if (cell.compareAndSet(CELL_STATE_EMPTY, element)) {
            ...
            val result = cell.compareAndSet(element, CELL_STATE_EMPTY)
            assert(result)
            //cell.getAndSet(CELL_STATE_EMPTY)
        }
        return false
    }
    ...
    private fun tryPopElimination(): E? {
        ...
        return if (currentValue == CELL_STATE_EMPTY || currentValue == CELL_STATE_RETRIEVED) {
            null
        } else {
            return if (cell.compareAndSet(currentValue, CELL_STATE_RETRIEVED)) {
                currentValue as E
            } else {
                null
            }
