    ...
    inner class CAS2Descriptor(
        ...
        private fun installAt(cell: Int, expecting: E): Boolean {
            while (true) {
                ...
                val potentialDescriptor = (value.value.takeIf { it is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && it != this } as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor)
                if (potentialDescriptor != null) {
                    potentialDescriptor.apply()
                    continue
                }
