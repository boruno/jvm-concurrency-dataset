    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor(i1: Int, e1: E, i2: Int, e2: E): Boolean {
            ...
            if (array.compareAndSet(i1, e1, this)) {
                ...
                var result = if (descStatus === UNDECIDED) {
                ...
                result = descriptor.updateStatus(result)
        ...
        private fun updateStatus(result: Boolean) =
            if (status.compareAndSet(UNDECIDED, if (result) SUCCESS else FAILED)) {
                true
            } else {
                status.get() == SUCCESS
            }
