...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        fun completeRunningOperation() {
            val caS2Descriptor = array[index1].value as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor
            if (caS2Descriptor != this) {
                caS2Descriptor?.apply()
            }
            val caS2Descriptor1 = array[index2].value as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor
