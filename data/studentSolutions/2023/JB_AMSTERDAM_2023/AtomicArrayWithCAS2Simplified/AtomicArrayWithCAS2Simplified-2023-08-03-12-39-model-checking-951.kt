...
//            val id1 = array[index1]
//            if (id1.value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) {
//                (id1.value as AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor).completeRunningOperation()
//            }
//
//            val id2 = array[index1]
//            if (id2.value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) {
//                (id2.value as AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor).completeRunningOperation()
//            }
