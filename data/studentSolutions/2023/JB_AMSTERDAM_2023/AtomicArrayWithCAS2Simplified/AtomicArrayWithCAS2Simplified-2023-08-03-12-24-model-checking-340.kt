...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun install(): Status {
            ...
            if ((array[index1].value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor || array[index1].compareAndSet(expected1, this))
                && array[index2].value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor || array[index2].compareAndSet(expected2, this))
       {
                return SUCCESS
            } else {
                return FAILED
