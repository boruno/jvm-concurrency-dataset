...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private lateinit var currentValue1: E
        private lateinit var currentValue2: E
        ...
        private fun tryInstallDescriptors(): Boolean {
            val success1 = tryInstallDescriptor(index1, expected1)
            if (!success1) {
                return false
            }

            val success2 = tryInstallDescriptor(index2, expected2)
            if (!success2) {
                array.compareAndSet(index1, this, currentValue1)
                return false
            }
            ...
            while (true) {
                ...
                when {
                    ...
                    value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor -> {
                        ...
                        if (index == index1) {
                            currentValue1 = value as E
                        } else {
                            currentValue2 = value as E
                        }
        ...
        private fun setDescriptorStatus(success: Boolean) {
            if (success) {
        ...
        private fun helpAnother(another: AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) {
