    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor(i1: Int, e1: E, i2: Int, e2: E): Boolean {
            if (array.compareAndSet(i1, e1, this)) {
                return installTwoOrHelp(i1, i2, e2)
            } else {
                val descriptor = array[i1] as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor ?: return false
                val result = if (i1 == descriptor.index1) {
        ...
        private fun installTwoOrHelp(i1: Int, i2: Int, e2: E): Boolean {
            if (array.compareAndSet(i2, e2, this)) {
                return true
            }
            val descriptor = array[i2] as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor ?: return false
            val result = if (i2 == descriptor.index2) {
                array.compareAndSet(descriptor.index1, descriptor.expected1, descriptor)
                        || array[i1] == descriptor
            } else {
                array.compareAndSet(descriptor.index2, descriptor.expected2, descriptor)
