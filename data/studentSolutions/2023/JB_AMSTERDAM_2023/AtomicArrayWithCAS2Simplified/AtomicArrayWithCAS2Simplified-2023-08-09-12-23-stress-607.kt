...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun help(descriptor: AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) =
            if (index1 == descriptor.index1) {
                array.compareAndSet(descriptor.index2, descriptor.expected2, descriptor) || array[index2] == descriptor
            } else {
                array.compareAndSet(descriptor.index1, descriptor.expected1, descriptor) || array[index1] == descriptor
            }
