...
//        }
        ...
        fun apply() {
            ...
            if (array[smallerIndex].compareAndSet(smallerExpected, this) || array[smallerIndex].value == this || array[smallerIndex].value == smallerUpdate) {
                if (array[biggerIndex].compareAndSet(biggerExpected, this) || array[biggerIndex].value == this || array[biggerIndex].value == biggerUpdate) {
