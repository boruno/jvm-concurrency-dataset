...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        fun installDescriptor(firstIndex: Int, firstExpected: E, secondIndex: Int, secondExpected: E): Boolean {
            ...
            val isFirstSet = array[firstIndex].value == this
            val isSecondSet = array[secondIndex].value == this

            if (isFirstSet) {
                return if (isSecondSet) {
                    true
                } else {
            ...
            if (array[firstIndex].compareAndSet(firstExpected, this)) {
                return array[secondIndex].compareAndSet(secondExpected, this)
            }
