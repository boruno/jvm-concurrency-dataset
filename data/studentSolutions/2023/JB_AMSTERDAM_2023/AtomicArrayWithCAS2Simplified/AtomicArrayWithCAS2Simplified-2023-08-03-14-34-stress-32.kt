    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor() {
            while (true) {
                ...
                when {
                    current1 == expected1 -> if (!array[index1].compareAndSet(expected1, this)) shouldBreak = false
                    current1 == this -> Unit
                ...
                when {
                    current2 == expected2 -> if (!array[index2].compareAndSet(expected2, this)) shouldBreak = false
                    current2 == this -> Unit
