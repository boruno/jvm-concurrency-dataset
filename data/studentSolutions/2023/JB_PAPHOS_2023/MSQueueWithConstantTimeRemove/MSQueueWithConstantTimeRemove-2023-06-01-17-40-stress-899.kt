...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            val newHead = currentHead.next.value?.apply { prev.value = null } ?: return null
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            // TODO: don't remove tail
            val prev = prev.value ?: return res
            val next = next.value ?: return res
