...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        return false
        //if (eliminationArray[id].compareAndSet(element, CELL_STATE_EMPTY)) {
        //    return false
        //} else {
        //    eliminationArray[id].compareAndSet(CELL_STATE_RETRIEVED, CELL_STATE_EMPTY)
        //    return true
        //}
        return false
    ...
    private fun tryPopElimination(): E? {
        ...
        if (element == CELL_STATE_EMPTY || element == CELL_STATE_RETRIEVED) {
            ...
            if (eliminationArray[i].compareAndSet(element, CELL_STATE_RETRIEVED)) {
                return res
            } else {
                return null
            }
