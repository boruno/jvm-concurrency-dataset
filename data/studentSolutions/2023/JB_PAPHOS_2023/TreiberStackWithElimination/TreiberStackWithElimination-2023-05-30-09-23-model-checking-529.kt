...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPopElimination(): E? {
        ...
        return if (!ref.compareAndSet(CELL_STATE_EMPTY, CELL_STATE_EMPTY) && !ref.compareAndSet(CELL_STATE_RETRIEVED, CELL_STATE_RETRIEVED)) {
            if(ref.compareAndSet(value, CELL_STATE_RETRIEVED)) {
                value as E?
            }
            null
        } else {
