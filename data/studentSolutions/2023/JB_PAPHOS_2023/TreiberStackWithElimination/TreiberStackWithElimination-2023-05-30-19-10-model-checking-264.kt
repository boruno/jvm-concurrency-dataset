...
class TreiberStackWithElimination<E> : Stack<E> {
    ...
    private fun tryPushElimination(element: E): Boolean {
        ...
        val cell = eliminationArray[randIdx]
        if (cell.compareAndSet(CELL_STATE_EMPTY, element)) {
            ...
            return if (cell.compareAndSet(element, CELL_STATE_EMPTY)) {
                ...
                // Pop happens
                cell.value = CELL_STATE_RETRIEVED
                true
            }
        }
        return false
    ...
    private fun tryPopElimination(): E? {
        ...
        if (curValue == CELL_STATE_EMPTY || curValue == CELL_STATE_RETRIEVED) {
            return null
        }

        return if (cell.compareAndSet(curValue, CELL_STATE_RETRIEVED)) {
            curValue as E?
        } else {
            null
        }
    ...
    private fun randomCellIndex(): Int =
        rand.nextInt(0, eliminationArray.size)
