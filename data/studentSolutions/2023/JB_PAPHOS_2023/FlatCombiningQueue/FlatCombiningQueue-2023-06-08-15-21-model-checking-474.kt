...
//                    if (!tasksForCombiner[currentCell].compareAndSet(null, Operation(DEQUE_TASK))) {
//                        currentCell = null
//                        continue
//                    }
//                }
//
//                if (!tasksForCombiner[currentCell].compareAndSet(Operation(DEQUE_TASK), Operation(DEQUE_TASK))) {
//
//                    // Success, our element has been added
//                    val operation = tasksForCombiner[currentCell].getAndSet(null)
//                    return operation  .task as E?
//                }
//            }
//        }
//    }
