...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (nextNode != null) {
                // swap element field with nextNode
                element = nextNode.element
                nextNode.markExtractedOrRemoved()

                // now remove nextNode physically from the list
                next.compareAndSet(nextNode, nextNode.next.value)
            }
