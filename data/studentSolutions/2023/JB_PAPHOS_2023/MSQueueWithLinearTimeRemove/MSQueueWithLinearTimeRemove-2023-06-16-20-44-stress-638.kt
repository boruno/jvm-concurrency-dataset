...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (head.compareAndSet(originalHead, curHeadNext)) // TODO эта проверка при сдвиге ломается
            {
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (curPrev.element == this.element) return mark // Don't delete first element
