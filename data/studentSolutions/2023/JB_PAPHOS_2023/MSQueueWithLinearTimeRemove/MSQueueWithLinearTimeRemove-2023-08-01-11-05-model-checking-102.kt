    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (curTail.next.compareAndSet(null, node) ||
                    curTail.next.value != null) {
                tailShiftAndRemoveIfNeeded(curTail, node)
                return
            }
        }
    }

    private fun tailShiftAndRemoveIfNeeded(curTail: Node, node: Node) {
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (markExtractedOrRemoved()) {
                if (this == tail.value || this == head.value || this.next.value == null) return true
                val prevNode = findPrev() ?: return true
