    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (curTail.extractedOrRemoved) {
                ...
                val nextNode = curTail.next.value // Assuming Node class has a reference to the next node
                if (nextNode != null) {
                    tail.compareAndSet(curTail, nextNode)
                }
            } else {
                if (curTail.next.compareAndSet(null, newTail)) {
                    // Now we can successfully add new node and move tail to the new node
