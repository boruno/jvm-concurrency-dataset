    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (head.compareAndSet(currHeadNode, elementNode)) {
                ...
                // TODO comment
                if (elementNode.markExtractedOrRemoved()) return elementNode.element
            }
        }
    }
...
//                val prevNode = prev.value ?: return wasLogicallyRemoved
//                val nextNode = next.value
//
//                prevNode.next.value = nextNode
//
//                if (nextNode != null) {
//                    val nextPrev = nextNode.prev.value
//                    if (nextPrev != null) {
//                        nextNode.prev.compareAndSet(nextPrev, prevNode)
//                    }
//                }
//
