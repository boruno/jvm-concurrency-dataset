...
class CoarseGrainedBank(accountsNumber: Int) : Bank {
    ...
    override fun getAmount(id: Int): Long = locked {
        // TODO: Make this operation thread-safe via coarse-grained locking.
        return@locked accounts[id].amount
    }
    ...
    override fun deposit(id: Int, amount: Long): Long = locked {
        // TODO: Make this operation thread-safe via coarse-grained locking.
    ...
    override fun withdraw(id: Int, amount: Long): Long = locked {
        // TODO: Make this operation thread-safe via coarse-grained locking.
        require(amount > 0) { "Invalid amount: $amount" }
        val account = accounts[id]
