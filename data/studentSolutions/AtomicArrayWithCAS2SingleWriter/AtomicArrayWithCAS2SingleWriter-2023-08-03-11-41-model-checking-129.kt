...
class AtomicArrayWithCAS2SingleWriter<E : Any>(size: Int, initialValue: E) {
    ...
    fun get(index: Int): E {
        ...
        return if (value is AtomicArrayWithCAS2SingleWriter<*>.CAS2Descriptor) {
            when (index) {
                value.index1 -> if (value.status.value == SUCCESS) value.expected1 as E else value.update1 as E
                value.index2 -> if (value.status.value == SUCCESS) value.expected2 as E else value.update2 as E
