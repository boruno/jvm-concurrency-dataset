...
class AtomicArrayWithCAS2SingleWriter<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        if (index1 == index2) {
            return when {
                expected1 != expected2 -> throw IllegalArgumentException()
                update1 != update2 -> throw IllegalArgumentException()
                else -> throw IllegalArgumentException() // array[index1].compareAndSet(expected1, update1)
            }
        }
