...
class IntIntHashMap {
    ...
    private class Core internal constructor(capacity: Int) {
        ...
        fun rehash(): Core {
            ...
            while (index < map.length()) {
                ...
                if (isValue(value)) {
                    ...
                    copyValue(newCore, index, key, value)
        ...
        private fun copyValue(core: Core, index: Int, key: Int, value: Int) {
            ...
            while (true) {
                ...
                if (currentKey == NULL_KEY) {
                    ...
                    val valueInserted = core.map.compareAndSet(currentIndex + 1, NULL_VALUE, copyingValue)
                    assert(valueInserted) { "Unexpected result during rehash: $valueInserted" }
                    return
                } else if (currentKey == key) {
                    if (core.map.compareAndSet(currentIndex + 1, NULL_VALUE, copyingValue))
                        return
                }
