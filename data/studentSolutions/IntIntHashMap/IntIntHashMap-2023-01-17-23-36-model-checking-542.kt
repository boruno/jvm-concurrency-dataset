...
//        require(isValue(value)) { "Invalid value: $value" }
    ...
    class Core internal constructor(capacity: Int) {
        ...
        fun rehash(): Core {
            nextCore.compareAndSet(null, Core(map.size * 2))
            val newCore = nextCore // map.length is twice the current capacity
            var index = 0
