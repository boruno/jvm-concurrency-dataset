            ...
            while (index < map.size) {
                ...
                if (isValue(value)) {
                    if(map[index + 1].compareAndSet(value, value * -1)) {
                        ...
                        map[index + 1].compareAndSet(value * -1, DEL_VALUE)
                    } else {
                        continue
                    }
                }
                if (beingMoved(value)) {
                    ...
                    map[index + 1].compareAndSet(value, DEL_VALUE)
                }
                if (value == NULL_VALUE || value == DEL_VALUE) {
                    if (!map[index + 1].compareAndSet(value, DEL_VALUE)) {
                        continue
                    }
                }
                index += 2
...
private fun beingMoved(value: Int): Boolean = value < 0 && value != DEL_VALUE