...
//                }
                val tmp = map[index + 1]
                tmp.value!!
                if (tmp.compareAndSet(oldValue, value)) return oldValue // maybe if with Moved check to optimize
            }
        }
...
private const val DEL_VALUE = Int.MAX_VALUE - 5 // mark for removed value
