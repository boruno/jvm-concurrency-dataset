...
class IntIntHashMap {
    ...
    private class Core internal constructor(val capacity: Int) {
        ...
        fun putInternal(key: Int, value: Int, preDelete: Boolean): Int {
            var index = index(key)
            var probes = 0
            while (true) {
            ...
            while (true) {
                ...
                if (oldValue == MOVED_VALUE || oldValue < 0) {
                    return next.value!!.putInternal(key, value, true)
                }
                    ...
                    val success = when (curValue) {
                        ...
                        MOVED_VALUE -> {
                            ...
                            kotlin.run {
                                ...
                                nextCore.putInternal(curKey, abs(curValue), true)
                                true
                            }
                        }
                    }
