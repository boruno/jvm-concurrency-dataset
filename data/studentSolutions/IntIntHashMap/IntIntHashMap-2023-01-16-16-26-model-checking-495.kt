...
class IntIntHashMap {
    ...
    private class Core(capacity: Int) {
        ...
        init {
            ...
            assert(capacity < 65536) {"what th e hell"} // fixme
        ...
        fun rehash(): Core {
            ...
            while (index < map.size) {
                if (isValue(map[index + 1].value ?: 0)) {
                    val result = newCore.putInternal(map[index].value ?: 0, map[index + 1].value ?: 0)
