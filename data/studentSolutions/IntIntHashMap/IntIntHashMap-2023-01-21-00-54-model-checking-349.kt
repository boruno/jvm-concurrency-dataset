            ...
            loop1@ while (true) {
                ...
                while (expectedKey != key) { // optimize for successful lookup
                    if (expectedKey == NULL_KEY) {
                        ...
                        if (map[index].compareAndSet(expectedKey, key)) {
                            break
                        }
                    }
                ...
                while (index < map.size) {
                    ...
                    if (expectedValue == S_MARK) {
                        ...
                        if (isValue(expectedValue)) {
                            ...
                            val result = newCore.putInternal(expectedKey, expectedValue)
                        ...
                        if (isVMod(expectedValue)) {
                            val result = newCore.putInternal(expectedKey, -1 * expectedValue)
                            assert(result == 0) { "Unexpected result during rehash: $result" }
