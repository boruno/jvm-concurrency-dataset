    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        if ( a[ indexx1 ].compareAndSet( expectedd1, desc1 as E? ) ) {
            if ( a[indexx2 ].compareAndSet( expectedd2, desc2 as E? ) ) {
                a[ indexx1 ].compareAndSet( desc1 as E?, ( updatee1 as Int + SUCC ) as E? )
                a[ indexx2 ].compareAndSet( desc2 as E?, ( updatee2 as Int + SUCC ) as E? )
                desc1 = updatee1 as Int + SUCC
                desc2 = updatee2 as Int + SUCC
                a[ indexx1 ].compareAndSet( desc1 as E?, updatee1 )
                a[ indexx2 ].compareAndSet( desc2 as E?, updatee2 )
                return true
            } else {
