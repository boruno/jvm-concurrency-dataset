...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        if (a[index1].value!!.v.compareAndSet(expected1, descriptor)) {
            ...
            if (a[index1].value!!.v.value is AtomicArrayNoAba<*>.Descriptor) {
                (a[index1].value!!.v.value as AtomicArrayNoAba<*>.Descriptor).complete()
            } else {
        ...
        override fun complete() : Boolean {
            ...
            if (a[bindx].value!!.v.value != this) {
                if (a[bindx].value!!.v.compareAndSet(expectB, rdcssDescriptor)) {
                    ...
                    if (a[bindx].value!!.v.value is AtomicArrayNoAba<*>.Descriptor) {
                        (a[bindx].value!!.v.value as AtomicArrayNoAba<*>.Descriptor).complete()
                    } else {
