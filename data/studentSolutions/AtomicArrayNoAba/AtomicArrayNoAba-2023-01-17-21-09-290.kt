...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun dcss(index1: Int, expected1: E, update1: E, id2 : CAS2Descriptor<E>): Boolean {
    ...
    class CAS2Descriptor<E>(val index1: Int, val expected1: E, val update1: E,
                            val index2: Int, val expected2: E, val update2: E, val arr : AtomicArrayNoAba<E>) {
        val result : AtomicRef<Boolean?> = atomic(null)
        fun complete() {
            if (arr.dcss(index2, expected2, update2, this)) {
    ...
    class DCSSDescriptor<E>(val index1: Int, val expected1: E, val update1: E,
                            val id2: CAS2Descriptor<E>, val arr : AtomicArrayNoAba<E>) {
        val result : AtomicRef<Boolean?> = atomic(null)
        fun complete() {
