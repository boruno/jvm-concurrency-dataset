...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        /*if (index1 == index2 && update1 != update2) {
            return false
        }*/
    ...
    fun DCAS(desc: DCASDescriptor<E>) : Boolean {
        ...
        if (success) {
            /*cas(desc.descriptors[0]!!.index, desc.descriptors[0]!!.expected, desc.descriptors[0]!!.update)
            cas(desc.descriptors[1]!!.index, desc.descriptors[1]!!.expected, desc.descriptors[1]!!.update)*/
