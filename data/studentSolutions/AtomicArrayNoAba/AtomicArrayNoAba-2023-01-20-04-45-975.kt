...
//        }
        if ( copy.a.value == a[command.indexA!!].value!!.a.value && copy.a.value == command.a.value && a[ command.indexA!! ].compareAndSet( copy, command ) ) {
            if ( copy1.a.value == a[command.indexB!!].value!!.a.value && copy1.a.value == command.a.value && a[ command.indexB ].compareAndSet( copy1, command )  ) {
                ...
                a[ command.indexB ].compareAndSet( copy1, Value( command.b, null, null, null, null, null, null) )
                return false
            }
        } else {
            return false
    ...
    private fun complete( copy : Value<E>, index: Int) {
        while ( true ) {
...
//                if ( cop)
                if ( cop.indexB != index )
                    complete( cop, cop.indexB!! )
                else
                    complete( cop, cop.indexA!! )
                return
            } else {
