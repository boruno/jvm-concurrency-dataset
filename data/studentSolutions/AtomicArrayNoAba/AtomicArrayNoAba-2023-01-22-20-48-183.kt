...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        return if (index1 == index2) {
            ...
            return when {
                index1 > index2 ->
                    CAS2Descriptor(arrayOf(part2, part1)).run(a[index2], expected2)
                else ->
                    CAS2Descriptor(arrayOf(part1, part2)).run(a[index1], expected1)
            }
        }
    }
}
...
class CAS2Descriptor<E>(
    ...
    override fun complete() : Boolean{
        val part1 = parts[0]
        val part2 = parts[1]
        val descriptor = RDCSSDescriptor(part2.value, part2.expected, this, this)
        val res = part2.value.inValue.value == this || if (part2.value.cas(part2.expected, descriptor)) {
            descriptor.complete()
        } else {
            false
        }
