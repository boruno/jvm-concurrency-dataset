...
class AtomicArrayNoAba(size: Int, initialValue: Int) {
    ...
    fun helpCAS2(casnDescriptor: CASNDescriptor<Int>) {
        while (true) {
            ...
            if (conflictingCAS2(casnDescriptor, index1Element.second)) {
                resolveCAS2Conflict(index1Element.second, casnDescriptor)
            }
            else {
            ...
            if (conflictingCAS2(casnDescriptor, index2Element.second)) {
                resolveCAS2Conflict(index2Element.second, casnDescriptor)
            }
            else {
