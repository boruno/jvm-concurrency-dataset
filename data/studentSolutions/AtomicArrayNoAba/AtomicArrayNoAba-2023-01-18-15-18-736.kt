...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        val descriptor = if (index1 < index2)
            CasDescriptor(a[index1], expected1, update1, a[index2], expected2, update2)
        else
            CasDescriptor(a[index2], expected2, update2, a[index1], expected1, update1)
    ...
    inner class CasDescriptor(
        private val a: Ref<E>, private val expected1: E, private val update1: E,
        private val b: Ref<E>, private val expected2: E, private val update2: E,
        private val outcome: Ref<State> = Ref(State.UNDECIDED)
    ) : Descriptor() {
        //private val f = a[index1]
        //private val s = a[index2]
        override fun complete(): Boolean {
            val res = b.v.value === this || b.dcssDescriptor(expected2, this, outcome, State.UNDECIDED)
