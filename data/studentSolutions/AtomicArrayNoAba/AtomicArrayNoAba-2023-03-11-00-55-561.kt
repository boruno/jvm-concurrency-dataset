...
class Descriptor<E>(val element1: Ref<E>, val expected1: E, val update1: E,
                    val element2: Ref<E>, val expected2: E, val update2: E,
                    val outcome: Ref<String> = Ref(UNDECIDED)) {
    fun complete() {
        if (element2.ref.value != this && element2.cas(expected2, this)) {
            outcome.cas(UNDECIDED, SUCCESS)
            element1.cas(this, update1)
            element2.cas(this, update1)
        } else {
