...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        var descriptor = Descriptor2(expected1, update1, expected2, update2)
...
private class Descriptor2<E>(val expected1: E, val update1: E, val expected2: E, val update2: E, var outcome: Outcome = Outcome.UNDECIDED)