...
class AtomicArrayNoAba<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        return when {
            /*index1 == index2 -> {
                expected1 == expected2 && update1 == update2 && cas(index1, expected1, update1+2)
            }*/
            index1 < index2 -> {
...
{
    val outcome : Ref<Boolean?> = Ref(null)
    val descriptor = DCSSDescriptor(b, expectB, this, outcome, null)
...
fun <A, B> dcss(descriptor: DCSSDescriptor<A, B>): Boolean {
    descriptor.a.v.compareAndSet(descriptor.expectA, descriptor)
    descriptor.complete()
    return descriptor.outcome.get()!!
}
