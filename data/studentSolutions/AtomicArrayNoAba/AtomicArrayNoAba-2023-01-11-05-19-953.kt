...
//    }
    ...
    fun dcssMod(a: Ref, expectA: E, updateA: Any, b: Ref, expectB: E, aVal: Any): Boolean {
        if (aVal == expectA && b.v.value == expectB) {
            a.set(updateA)
            return true
        } else {
            return false
...
//        }
        ...
        if (descr.outcome.value == "UNDECIDED") {
            ...
            if (dcssMod(second, exp2, descr2, first, exp1, secondVal)) {
