...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        if (i1 == i2) {
            if (update1 != expected2) return false
            if(!cas(i1, expected1, update2)) return false
            // if (!cas(i1, expected1, update1)) return false
            // if (!cas(i1, expected2, update2)) return false
            return true
        }
