...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    private inner class CASNDescriptor<A, B>(
        ...
        override fun complete() {
            val res = b.v.value == this || dcssMod(b, expectB, this, outcome, ConsensusResult.UNDECIDED)
    ...
    fun cas2(
        ...
        val (t1, t2) = if (index1 > index2) Triple(a[index1]!!, expected1, update1) to
                Triple(a[index2]!!, expected2, update2) else Triple(a[index2]!!, expected2, update2) to Triple(a[index1]!!, expected1, update1)
