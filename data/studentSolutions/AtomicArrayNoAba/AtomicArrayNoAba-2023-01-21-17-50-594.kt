...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        if (index1 == index2) {
            return if ((expected1 == expected2)) cas(index1, expected1, (expected2 as Int + 2) as E) else false
        }
        val caS2Descriptor =
            if (index1 <= index2) CAS2Descriptor(a[index1].value!!, expected1, update1, a[index2].value!!, expected2, update2)
