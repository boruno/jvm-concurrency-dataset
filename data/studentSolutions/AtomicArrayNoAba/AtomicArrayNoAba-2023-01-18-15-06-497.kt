   ...
   */
    inner class CasDescriptor(
        ...
        override fun complete(): Boolean {
            val res = f.v.value === this || f.dcssDescriptor(expected2, this, outcome, State.UNDECIDED)
    ...
    class DCSSDescriptor<E, B>(
        private val a: Ref<E>, private val expected1: E, private val update1: Descriptor,
