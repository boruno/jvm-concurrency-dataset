...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: Int, update1: Int,
        ...
        val start = get(index1)
        if (start.javaClass.name == "DescriptorCAS2") {
            completeCAS2(start as DescriptorCAS2)
        }
    ...
    fun dcss(index1: Int, expected1: E, update1: DescriptorCAS2,
        ...
        if (start.javaClass.name == "DescriptorDCSS") {
            completeDCSS(start as DescriptorDCSS)
        }
