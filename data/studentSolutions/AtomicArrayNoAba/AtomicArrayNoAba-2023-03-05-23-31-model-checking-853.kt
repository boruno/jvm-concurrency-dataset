...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        if (ind1 == ind2) {
            return exp1 == exp2 && cas(ind2, exp2, upd2) //?
        }
...
class CASNDescriptor(
    ...
    override fun complete() {
        if (outcome.value == Outcome.UNDEFINED) {
            ...
            if (bValue === this) {
                ...
                if (bValue != expectB) {
                    ...
                    // переход между 2 -> 3
                    val rdcssDescriptorMod =
                        RDCSSDescriptorMod(b, expectB, this, outcome as Ref<Any>, Outcome.UNDEFINED)
