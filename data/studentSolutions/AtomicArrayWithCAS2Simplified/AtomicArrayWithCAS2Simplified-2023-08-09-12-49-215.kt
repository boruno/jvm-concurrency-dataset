...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun tryInstallDescriptor(): Boolean {
            ...
            val (expectedA, expectedB) = if (index1 >= index2) {
                expected2 to expected1
            } else {
            ...
            return array.compareAndSet(indexA, expectedA, this)
                    && array.compareAndSet(indexB, expectedB, this)
        }
