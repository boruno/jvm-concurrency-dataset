...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun Any?.needsHelp(): Boolean = when(this) {
            ...
            is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor -> !helping.value
            else -> false
        }

        private fun Any?.provideHelp() {
            if (this@CAS2Descriptor.helping.compareAndSet(false, true)) {
                (this as AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor).apply()
            }
        }
