    ...
    inner class CAS2Descriptor(
        ...
        private fun installCell(cellIndex: Int, expected: E): Boolean =
            when(val value = array[cellIndex]) {
                is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor -> helpDescriptor(cellIndex, value, expected)
                else -> array.compareAndSet(cellIndex, expected, this)
            }
        ...
        private fun helpDescriptor(
            ...
            expected: E
        ) : Boolean = if (foreignDescriptor == this) {
            true
        } else {
