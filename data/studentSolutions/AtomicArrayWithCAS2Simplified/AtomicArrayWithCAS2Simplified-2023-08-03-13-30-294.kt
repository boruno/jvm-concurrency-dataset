...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        fun installDescriptor(firstIndex: Int, firstExpected: E, secondIndex: Int, secondExpected: E) {

            if (status.value != UNDECIDED)
                return

            if (array[firstIndex].compareAndSet(firstExpected, this) && array[secondIndex].compareAndSet(secondExpected, this))
                return
            ...
            if (cell1 is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && cell1 != this) {
                cell1.apply()
            }
            else if (cell2 is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && cell2 != this) {
                cell2.apply()
            }
            else {
                return
