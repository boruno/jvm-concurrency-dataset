...
//        }
        ...
        fun apply(help : Boolean) {
            ...
            if (array[smallerIndex].compareAndSet(smallerExpected, this) || array[smallerIndex].value == this || (help && array[smallerIndex].value == smallerExpected)) {
                if (array[biggerIndex].compareAndSet(biggerExpected, this) || array[biggerIndex].value == this || (help && array[biggerIndex].value == biggerExpected)) {
