...
//            while (array[index1].value != this && !array[index1].compareAndSet(expected1, this)) {
            if (array[index1].value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && desc1 != this) {
...
//            }
            ...
            if (array[index1].value == this || array[index1].compareAndSet(expected1, this)) {
                ...
                if (array[index2].value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && desc2 != this) {
