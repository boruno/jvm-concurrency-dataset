...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun installAt(cell: Int, expecting: E): Boolean {
            while (true) {
                val value = array[cell]
                if (value.value == this) return true
                (value.value.takeIf { it is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor } as AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor).apply()
//                if (value.value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) {
//                    (value.value as AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor).apply()
//                    continue
//                }
                return value.compareAndSet(expecting, this)
            }
        }
