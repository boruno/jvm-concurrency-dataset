    ...
    inner class CAS2Descriptor(
        ...
        private fun applyLogically(): Boolean {
            ...
            val foreignDescriptor =
                array.get(index1) as? AtomicArrayWithCAS2SingleWriter<*>.CAS2Descriptor ?: return false
            array.compareAndSet(foreignDescriptor.index2, foreignDescriptor.expected2, foreignDescriptor)
            return false
        }
