...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        fun apply(): Boolean {
            val descriptor = this
            val index1 = if (index1 < index2) index1 else index2
            val index2 = if (index1 < index2) index2 else index1
            val expected1 = if (index1 < index2) expected1 else expected2
            val expected2 = if (index1 < index2) expected2 else expected1
            val update1 = if (index1 < index2) update1 else update2
            val update2 = if (index1 < index2) update2 else update1
