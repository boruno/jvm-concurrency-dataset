...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun helpAndGet(idx: Int): Any? {
            ...
            while (cell is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && cell.status.value == UNDECIDED) {
                cell.apply()
        ...
        private fun helpIfNeeded(idx: Int) {
            val cell = array[idx].value
            if (cell is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && cell.status.value == UNDECIDED) {
                cell.apply()
            }
        }
