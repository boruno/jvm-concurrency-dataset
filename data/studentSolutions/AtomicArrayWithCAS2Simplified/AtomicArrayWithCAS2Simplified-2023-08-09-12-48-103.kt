...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor(): Boolean {
            fun installIndex1(): Boolean =
                array[index1] == this || array.compareAndSet(index1, expected1, this)
            fun installIndex2(): Boolean =
                array[index2] == this || array.compareAndSet(index2, expected2, this)
            return if (index1 < index2) installIndex1() && installIndex2()
                else installIndex2() && installIndex1()
//            val firstInstalled =
//                array[index1] == this || array.compareAndSet(index1, expected1, this)
//            val secondInstalled =
//                array[index2] == this || array.compareAndSet(index2, expected2, this)
//            return firstInstalled && secondInstalled
        }
