        ...
        private fun installDescriptor(): Boolean {
            if (array.compareAndSet(index1, expected1, this)) {
                if (array.compareAndSet(index2, expected2, this)) {
                    ...
                    val descriptor = array[index2] as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor
                    if (descriptor == null
                    ...
                    descriptor.updateStatus(true)
                    descriptor.updateCells(true)
                }
            } else {
                val descriptor = array[index1] as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor
                if (descriptor == null
