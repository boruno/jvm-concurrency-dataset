...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun Any?.needsHelp(): Boolean = when(this) {
            ...
            is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor -> this.isUndecided()
            else -> false
        }

        private fun Any?.provideHelp() = (this as AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor).apply()
