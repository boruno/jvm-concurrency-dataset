...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor(): Boolean =
            (clearInterlopers(index1) || array[index1].compareAndSet(expected1, this)) &&
                (clearInterlopers(index2) || array[index2].compareAndSet(expected2, this))

        private fun clearInterlopers(i: Int): Boolean =
