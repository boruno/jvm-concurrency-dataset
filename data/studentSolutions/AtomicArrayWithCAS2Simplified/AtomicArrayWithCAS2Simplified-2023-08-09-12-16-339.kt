    ...
    inner class CAS2Descriptor(
        ...
        private fun applyLogically(): Boolean {
            ...
            val foreignDescriptor =
                array.get(index1) as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor
                    ?: array.get(index2) as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor
            if (foreignDescriptor != this) foreignDescriptor?.applyLogically()
            return false
        }
        ...
        private fun applyPhysically() {
            ...
            val foreignDescriptor =
                array.get(index1) as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor
                    ?: array.get(index2) as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor
            if (foreignDescriptor != this) foreignDescriptor?.applyPhysically()
        }
