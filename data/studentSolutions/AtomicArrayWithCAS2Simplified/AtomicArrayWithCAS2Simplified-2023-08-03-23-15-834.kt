        ...
        private fun installDescriptor(): Boolean {
            ...
            while (true) {
                ...
                if (install(index1)) {
                    ...
                    if (array[index2].value !is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) return false
                }
                value1 = array[index1].value
                if (value1 !is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) return false
            }
        }
