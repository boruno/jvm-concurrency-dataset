...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun applyLogically() {
            ...
            array.compareAndSet(minIndex, minIndExpected, this)
            array.compareAndSet(maxIndex, maxIndexExpected, this)
        ...
        private fun applyPhysically() {
            ...
            if (status.get() == SUCCESS) {
                array.compareAndSet(minIndex, this, minIndUpdate)
                array.compareAndSet(maxIndex, this, maxIndUpdate)
            }
            if (status.get() == FAILED) {
                array.compareAndSet(minIndex, this, minIndExpected)
                array.compareAndSet(maxIndex, this, maxIndExpected)
            }
        }
