...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        while (true) {
            ...
            val otherDescriptor = array[firstIndex].value
            if (otherDescriptor is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) {
                otherDescriptor.apply()
            }

            val anotherDescriptor = array[secondIndex].value
