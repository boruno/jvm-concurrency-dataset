    ...
    inner class CAS2Descriptor(
        ...
        private fun install(): Boolean {
            while (true) {
                ...
                if (array.get(cell1.first) == this || array.compareAndSet(cell1.first, cell1.second, this)) {
                    return if (array.get(cell2.first) == this || array.compareAndSet(cell2.first, cell2.second, this)) {
                        true
                    } else {
                    ...
                    tryHelpForeignDescriptor(cell1.first)
                }
            }
        }
