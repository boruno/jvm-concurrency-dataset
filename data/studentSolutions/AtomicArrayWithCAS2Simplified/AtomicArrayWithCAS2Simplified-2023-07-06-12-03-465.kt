...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        array[firstIndex].compareAndSet(firstIndexExpected, caS2Descriptor)
        array[secondIndex].compareAndSet(secondIndexExpected, caS2Descriptor)
        caS2Descriptor.apply()
        array[firstIndex].compareAndSet(caS2Descriptor, firstIndexUpdated)
        array[secondIndex].compareAndSet(caS2Descriptor, secondIndexUpdated)
        return true
    }
