    ...
    inner class CAS2Descriptor(
        ...
        private fun installAt(cell: Int, expecting: E): Boolean {
            while (true) {
                ...
                if (value == this && status.value == UNDECIDED) return true
                if ((value as? E) != null) {
                    return value == expecting && array[cell].compareAndSet(value, this)
                }
                (value as? AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor)?.apply()
            }
        }
