...
//        }
    ...
    inner class CAS2Descriptor(
        ...
        fun apply():Boolean {
            ...
            array[index1].value?.checkWorkFinished()
            if (array[index1].compareAndSet(expected1, this)) {
                array[index2].value?.checkWorkFinished()
...
//                array[index2].compareAndSet(descriptor, expected2)
        ...
        private fun Any.checkWorkFinished() {
            if(this is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) this.apply()
        }
    }
