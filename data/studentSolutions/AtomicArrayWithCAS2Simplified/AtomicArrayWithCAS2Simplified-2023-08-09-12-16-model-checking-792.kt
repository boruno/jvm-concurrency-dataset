    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor(): Boolean {
            if (array.compareAndSet(index1, expected1, this)) {
                ...
                val result = array.compareAndSet(descriptor.index2, descriptor.expected2, descriptor)
        ...
        private fun installTwoOrHelp(): Boolean {
            ...
            val result = array.compareAndSet(descriptor.index1, descriptor.expected1, descriptor)
