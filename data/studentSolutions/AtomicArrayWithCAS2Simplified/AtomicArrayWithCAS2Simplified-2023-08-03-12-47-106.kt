    ...
    inner class CAS2Descriptor(
        ...
        private fun install(): Boolean {
            ...
            if (array[minIndex].compareAndSet(minExpected, this)) {
                return if (array[maxIndex].compareAndSet(maxExpected, this)) {
                    true
                } else {
                    array[minIndex].value = minExpected
                    false
                }
            }
            else {
                val value = array[minIndex].value
                if (value is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) value.receiveHelp(minIndex)
