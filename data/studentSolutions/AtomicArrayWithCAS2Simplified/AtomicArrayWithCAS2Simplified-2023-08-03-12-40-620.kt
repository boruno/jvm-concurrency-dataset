        ...
        private fun installDescriptor() {
            while (true) {
                ...
                if (currentValue1 is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && currentValue1 !== this) {
                    if (currentValue1.status.value !== UNDECIDED) {
                        currentValue1.updatePhysically()
                    } else {
                        currentValue1.apply()
                    }
                } else {
            ...
            while (true) {
                ...
                if (currentValue2 is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && currentValue2 !== this) {
                    if (currentValue2.status.value !== UNDECIDED) {
                        currentValue2.updatePhysically()
                    } else {
                        currentValue2.apply()
                    }
                } else {
