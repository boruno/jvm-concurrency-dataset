...
//        }
        ...
        fun apply(help : Boolean) {
            ...
            if (array[smallerIndex].compareAndSet(smallerExpected, this) || (help && (array[smallerIndex].value == this || array[smallerIndex].value == smallerUpdate))) {
                if (array[biggerIndex].compareAndSet(biggerExpected, this) || (help && (array[biggerIndex].value == this || array[biggerIndex].value == biggerUpdate))) {
                    if (status.compareAndSet(UNDECIDED, SUCCESS) || (help && status.value == SUCCESS)) {
