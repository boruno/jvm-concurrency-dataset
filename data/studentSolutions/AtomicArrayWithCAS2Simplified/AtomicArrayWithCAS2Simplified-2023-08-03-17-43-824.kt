    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor(): Boolean {
            ...
            while (true) {
                ...
                if (!installed1 && cell1 is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) {
                    if (cell1 != this) {
                        cell1.apply()
                        continue
                    }
                ...
                installed1 = installed1 || array[index1].compareAndSet(expected1, this)

                var installed2 = false
                val cell2 = array[index2].value
                if (installed1 && !installed2 && cell2 is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) {
                    if (cell2 != this) {
                        cell2.apply()
                        continue
                    }
