...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor(): Boolean {
            ...
            return installCellDescriptor(indexes[0]) && installCellDescriptor(indexes[1])
        }
        ...
        private fun installCellDescriptor(i: Int): Boolean {
            ...
            when {
                ...
                cellValue is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor -> {
                    cellValue.apply()
                    return false
                }
                cellValue == expectedValue -> {
                    return array.compareAndSet(i, expectedValue, this) || array.compareAndSet(i, this, this)
                } else -> {
                    return false
                }
            }
