    ...
    fun get(index: Int): E {
        ...
        if (value is AtomicArrayWithCAS2SingleWriter<*>.CAS2Descriptor) {
            when (value.status.value) {
                AtomicArrayWithCAS2SingleWriter.Status.SUCCESS -> return value.getUpdatedValue(index) as E
                AtomicArrayWithCAS2SingleWriter.Status.FAILED -> return value.getOldValues(index) as E
