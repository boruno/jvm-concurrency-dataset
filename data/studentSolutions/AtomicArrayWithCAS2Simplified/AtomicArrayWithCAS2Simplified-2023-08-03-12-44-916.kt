...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        fun apply() {
            ...
            if (index1 < index2) {
                installDescriptor(index1, expected1) && installDescriptor(index2, expected2)
            }
            else {
                installDescriptor(index2, expected2) && installDescriptor(index1, expected1)
            }
