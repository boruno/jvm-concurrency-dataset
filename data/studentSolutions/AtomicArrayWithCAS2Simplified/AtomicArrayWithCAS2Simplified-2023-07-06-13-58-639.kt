...
//                }
    ...
    inner class CAS2Descriptor(
        ...
        private fun CAS2Descriptor.tryInstallDescriptors() =
            tryDescriptor(index1, expected1) && tryDescriptor(index2, expected2)


        private fun setValues(i1: Int, i2: Int, value1: Any, value2: Any) {
            array[i1].compareAndSet(this, value1)
            array[i2].compareAndSet(this, value2)
        }
