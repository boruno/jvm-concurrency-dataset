...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        fun toDescriptor(e: Any?): AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor? {
            return when(e) {
                is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor -> (e as AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor)
                else -> null
            }
        }
        ...
        fun apply() {
            ...
            val firstDescIfExists = toDescriptor(array.get(index1))
            val firstDescIsSet = firstDescIfExists == this || array.compareAndSet(index1, expected1, this)
            if (firstDescIsSet) {
                val secDescIsSet = toDescriptor(array.get(index2)) == this || array.compareAndSet(index2, expected2, this)
                if (secDescIsSet) {
