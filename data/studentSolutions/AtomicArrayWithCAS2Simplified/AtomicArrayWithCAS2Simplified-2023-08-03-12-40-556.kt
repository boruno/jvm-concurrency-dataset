...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun installAt(cell: Int, expecting: E): Boolean {
            while (true) {
                if (array[cell].value == this) return true
                if (array[cell].value !is AtomicArrayWithCAS2SingleWriter<*>.CAS2Descriptor)
                    return array[cell].compareAndSet(expecting, this)
                (array[cell].value as AtomicArrayWithCAS2SingleWriter<*>.CAS2Descriptor).apply()
            }
        }
