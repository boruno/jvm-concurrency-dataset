...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        return if (index1 > index2) {
            CAS2Descriptor(index1, expected1, update1, index2, expected2, update2).applyDescr()
        } else {
            CAS2Descriptor(index2, expected2, update2, index1, expected1, update1).applyDescr()
        }
    }
