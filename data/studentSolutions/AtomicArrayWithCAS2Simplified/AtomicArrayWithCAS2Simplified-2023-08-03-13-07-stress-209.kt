...
//        }
        ...
        fun apply() {
            ...
            if (array[smallerIndex].compareAndSet(smallerExpected, this) || array[smallerIndex].value == this) {
                if (array[biggerIndex].compareAndSet(biggerExpected, this) || array[biggerIndex].value == this) {
