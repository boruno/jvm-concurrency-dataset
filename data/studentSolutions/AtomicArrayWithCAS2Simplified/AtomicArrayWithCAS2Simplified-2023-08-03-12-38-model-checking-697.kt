...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        val descriptor = CAS2Descriptor(
            idx1 = index1, expected1 = expected1, update1 = update1,
            idx2 = index2, expected2 = expected2, update2 = update2
        )
        descriptor.apply()
    ...
    inner class CAS2Descriptor(
        ...
        private val index1: Int = min(idx1, idx2)
        private val index2: Int = max(idx1, idx2)
