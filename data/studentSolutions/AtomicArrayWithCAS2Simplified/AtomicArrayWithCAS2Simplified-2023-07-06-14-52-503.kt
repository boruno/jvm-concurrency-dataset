...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun tryInstallDescriptors(): Boolean = tryDescriptor(index1, expected1) && tryDescriptor(index2, expected2)
        private fun tryInstallDescriptors2(): Boolean = setDescriptor(index1, expected1) && setDescriptor(index2, expected2)
