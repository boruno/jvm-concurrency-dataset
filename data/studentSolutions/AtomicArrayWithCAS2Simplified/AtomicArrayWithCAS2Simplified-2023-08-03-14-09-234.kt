...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        fun apply() {
            ...
            val succeeded1 = if (old1 != this) installDescriptor(index1, expected1) else true
            val succeeded2 = if (old2 != this) installDescriptor(index2, expected2) else true
        ...
        private fun installDescriptor(idx: Int, exp: E): Boolean {
            ...
            if (!installed) {
                if (cell is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) {
                    if (cell.status.value != UNDECIDED) { cell.apply() }
                }
                return false
            }
            return true
