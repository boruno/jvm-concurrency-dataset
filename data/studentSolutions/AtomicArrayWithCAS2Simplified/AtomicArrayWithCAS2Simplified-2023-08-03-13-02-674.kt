    ...
    inner class CAS2Descriptor(
        ...
        private fun install() {
            ...
            if (!array[index1].compareAndSet(expected1, this)) {
                ...
                while (descriptor1 != this && descriptor1 is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && descriptor1.status.value == UNDECIDED) {
                    descriptor1.apply()
            ...
            if (!array[index2].compareAndSet(expected2, this)) {
                ...
                while (descriptor2 != this && descriptor2 is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor && descriptor2.status.value == UNDECIDED) {
                    descriptor2.apply()
