...
class AtomicArrayWithCAS2Simplified<E : Any>(size: Int, initialValue: E) {
    ...
    private inner class CAS2Descriptor(
        ...
        val expected2: E,
        val update2: E
    ): Comparable<AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor> {
        val status = atomic(UNDECIDED)

        override fun compareTo(other: AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor): Int {
            return index1.compareTo(other.index1)
        }
