...
//        return array[index] as E
    ...
    inner class CAS2Descriptor(
        ...
        fun apply(fromThread: Boolean) {
            // TODO: Install the descriptor, update the status, and update the cells;
            // TODO: create functions for each of these three phases.

            // 1. TRY TO INSTALL DESCRIPTOR
            tryToInstallDescriptor(fromThread)
        ...
        private fun tryToInstallDescriptor(fromThread: Boolean) {
            // help another descriptor if there is one
            val firstElem = array.get(index1)
            if (fromThread) {
                if (firstElem is AtomicArrayWithCAS2Simplified<*>.CAS2Descriptor) firstElem.apply(true)
            }
        ...
        private fun updateCellsPhysically() {
            if (array.compareAndSet(index1, this, update1)) {
                if (array.compareAndSet(index2, this, update2)) return
            }
        }
    }
