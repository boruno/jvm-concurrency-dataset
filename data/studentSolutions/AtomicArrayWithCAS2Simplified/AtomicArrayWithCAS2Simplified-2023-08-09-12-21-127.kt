    ...
    inner class CAS2Descriptor(
        ...
        private fun installDescriptor(): Boolean {
            if (array.compareAndSet(index1, expected1, this)) {
                ...
                val result = if (index1 == descriptor.index1) array.compareAndSet(descriptor.index2, descriptor.expected2, descriptor)
                        || array[index2] == descriptor else  array.compareAndSet(descriptor.index1, descriptor.expected1, descriptor)
