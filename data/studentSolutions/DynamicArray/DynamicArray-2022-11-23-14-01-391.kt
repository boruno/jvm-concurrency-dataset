...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun pushBack(element: E) {
        while(true) {
            ...
            {
                if(newArray.compareAndSet(null, Core(currentCore!!.capacity + 1))) // Если вышел CAS на перекладывание, то перекладываем спокойно, так как newArray мы забрали себе
                {
                    for(i in 0..size)
                    {
