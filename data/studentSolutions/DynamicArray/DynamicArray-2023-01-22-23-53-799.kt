...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun pushBack(element: E) {
        while (true) {
            ...
            val cnstCoreSize = cnstCore.capacity1
            ...
            if (cnstSize < core.value.capacity1 && core.value.array[cnstSize].compareAndSet(null, Pair(element, false))) {
