...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun pushBack(element: E) {
        ...
        selectedCore.next.compareAndSet(null, Core(selectedCore.maxSize * 2, true))
...
//        newCore.compareAndSet(null, Core(oldCore.maxSize * 2))
        newCore.value?.trySetSize(0, selectedCore.getSize())
        ...
        while (true) {
            if (selectedCore.next.value?.tryPlace(selectedCore.next.value!!.getSize(), element) == true) {
                break
            }
        }
...
//        newCore.compareAndSet(newCore.value, null)
        ...
        println(selectedCore.next.value!!.getSize())
    }
