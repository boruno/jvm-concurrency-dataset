...
//    }
    ...
    override fun pushBack(element: E) {
        while (true) {
            ...
            if (push(element, currentCore)) {
                ...
                newCore._size.value = currentCore.capacity + 1
    ...
    private fun push(elem: E, cor: Core<E>): Boolean {
        var currentCore: Core<E>? = cor
        while (true) {
            if (currentCore == null) {
                return false
            }
            ...
            if (where < currentCore.capacity) {
                if (currentCore.array[where].compareAndSet(null, elem)) {
                    return true
                } else {
                    throw Exception1()
                }
