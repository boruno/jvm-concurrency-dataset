...
private class Core<E>(
    ...
    fun moveToNewCore() {
        ...
        for (i in 0 until capacity) {
            ...
            while (true) {
                ...
                if (newCore.value!!.casElement(i,null, oldValue) && array[i].value != oldValue) {
                    continue
                }
                break
            }
    ...
    fun set(index: Int, element: E) {
        ...
        if (newCore.value == null || !labelArray[index]) {
            return
        }
        while (newCore.value!!.array[index].value == null) {
            moveToNewCore()
        }
        if (index == capacity) {
            newCore.value!!.setAfterMove = true
        }
