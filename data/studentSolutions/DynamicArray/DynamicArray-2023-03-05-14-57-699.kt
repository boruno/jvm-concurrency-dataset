...
private open class ArrayElement<E>(val element: E, val flag: Boolean)
...
//        return array[index].value!!.element
    ...
    fun put(index: Int, element: E): Boolean {
        ...
        return array[index].compareAndSet(prev, ArrayElement(element, false))
    }
    ...
    fun pushBack(element: E): Boolean {
        while (true) {
            ...
            if (array[curSize].compareAndSet(null, ArrayElement(element, false))) {
                casSizeInc(curSize)
                return true
            }
        }
    ...
    fun resize() : Core<E> {
        ...
        for (i in 0 until capacity) {
            while (true) {
                ...
                if ((value.flag) || (array[i].compareAndSet(value, ArrayElement(value.element, true)))) {
                    newCore.value!!.array[i].compareAndSet(null, ArrayElement(value.element, false))
                    break
                }
            }
        }
