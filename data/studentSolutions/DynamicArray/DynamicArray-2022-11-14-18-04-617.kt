    ...
    override fun pushBack(element: E) {
        ...
        synchronized(x) {
            ...
            if (currentCore.locked[i].compareAndSet(true, false)) {
                ...
                while (!(i + 1 < indexFactory.current())) {
                    var _curr = indexFactory.current()
                    indexFactory.nextCas(_curr)
                }
...
//                continue
                ...
                if (locked[i].value != null) {
                    ...
                    while (!(i < arr.indexFactory.current())) {
                        var _curr = arr.indexFactory.current()
                        arr.indexFactory.nextCas(_curr)
                    }
