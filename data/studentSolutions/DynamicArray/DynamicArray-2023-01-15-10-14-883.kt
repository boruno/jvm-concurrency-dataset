    ...
    override fun pushBack(element: E) {
        while (true) {
            ...
            if (cur_size < cur_core.getCapacity()) {
                ...
                var cur_element = cur_core.get(0)
                if (cur_element != null) {
                    val destination = cur_element.second

                    if (destination == null) {
                        if (cur_core.CAS(0, cur_element, Pair(element, new_core))) {
                            for (i in 1 until cur_size) {
                        ...
                        for (i in 0 until cur_size) {
                            cur_element = cur_core.get(i)
                            if (cur_element != null) {
                                destination.CAS(i, null, Pair(cur_element.first, null))
                            }
                        }
                    }
                }
