            ...
            if (currentElement == null)
            {
                if (currentCore.putCas(currentIndex, null, Node(element)))
                {
                    ...
                    if (size < currentIndex + 1) {
                        println(String.format("Size have not advanced in PUSH_BACK!. Our core is current: %b", currentCore === core.value));
                        throw Exception(String.format("Size have not advanced in PUSH_BACK!. Our core is current: %b", currentCore === core.value))
                    }
                    return true
                }
                else
