    ...
    override fun pushBack(element: E) {
        ...
        while (true) {
            ...
            if (currentSize < currentCore.capacity && !needNew) {
                ...
                while (true) {
                    if (currentCore.nextList.compareAndSet(null, Core(currentCore.capacity * 2, currentCore.size))) {
                        ...
                        for (i in 0 until currentCore.capacity)
                        {
                            while(true) {
                                ...
                                if (currentElement == null) {
                                    currentCore.putCas(i, null, NodeMoved(element))
                                    break
                                }
                                if (i > newCore.value!!.size - 1) // If we have some thread pushing back its value, its size increment could be lost
