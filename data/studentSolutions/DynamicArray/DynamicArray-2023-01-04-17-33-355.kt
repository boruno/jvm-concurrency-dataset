...
//    private val core: AtomicRef<Core<T>> = atomic(Core(INITIAL_CAPACITY, 0, null))
//
...
//                }
//            } else {
//                val nextCore = Core<T>(2 * curCore.getCapacity(), curCore.getCapacity(), null)
...
//    val size: AtomicInt = atomic(length)
