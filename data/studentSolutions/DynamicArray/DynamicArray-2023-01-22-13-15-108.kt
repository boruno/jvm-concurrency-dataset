...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun get(index: Int): E {
        ...
        while (true) {
            ...
            when (elementAtIndex.status) {
                ...
                STATUS.MOVED -> {
                    val curCoreNext = curCore.next.value ?: continue
    ...
    override fun put(index: Int, element: E) {
        ...
        while (true) {
            ...
            if (curElementAtIndex == null) {
                curCore.array[index].compareAndSet(null, elementToPut)
                return
            }

            when (curElementAtIndex.status) {
                STATUS.REAL -> { curCore.array[index].compareAndSet(curElementAtIndex, elementToPut) }
    ...
    override fun pushBack(element: E) {
        ...
        while (true) {
            ...
            if (localSize < curCapacity) {
                if (core.value.array[localSize].compareAndSet(null, elementToPush)) {
