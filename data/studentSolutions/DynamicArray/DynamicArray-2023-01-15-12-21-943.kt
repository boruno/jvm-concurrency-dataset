...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun get(index: Int): E {
        ...
        var cur_element = cur_core.get(index)
        return cur_element!!
    }
    ...
    override fun put(index: Int, element: E) {
        ...
        while (true) {
            ...
            if (destination == null) {
                if (cur_core.CAS(index, cur_element, element)) {
                    if (cur_core.next.get() == null) return
                }
            }
            else {
                val destination_element = destination.get(index)
                if (destination.CAS(index, destination_element, element)) {
