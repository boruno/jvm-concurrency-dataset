...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun pushBack(element: E) {
        while (true) {
            ...
            val containerSize = currentArray._elementsCount.value
            ...
            if (containerSize >= currentArray.array.size) {
                ...
                if (currentArray.next.compareAndSet(null, newArray)) {
                    newArray._elementsCount.value = containerSize + 1
...
//                    }
                ...
                if (currentArray.array[containerSize].compareAndSet(null, element)) {
                    currentArray._elementsCount.compareAndSet(containerSize, containerSize + 1)
                    return
                } else {
                    currentArray._elementsCount.compareAndSet(containerSize, containerSize + 1)
                }
