...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun get(index: Int): E {
        ...
        if (index >= curHead.size || index < 0) {
            throw IllegalArgumentException()
        }
        return curHead.array[index].value ?: throw RuntimeException() // maybe remove runtime
    }
    ...
    override fun pushBack(element: E) {
        while (true) {
            ...
            if (curSize < curHead.getCapacity()) {
                ...
                val newNode = Core<E>(2 * curHead.getCapacity(), curHead.getCapacity(), null)
