...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun put(index: Int, element: E) {
        while (true) {
            ...
            if ( copy != null ) {
                if ( (copy as Int) % BROKEN_VALUE != BROKEN_VALUE1 && ( copy as Int ) % BROKEN_VALUE != BROKEN_VALUE1 ) {
            ...
            if ( sizeC >= core.value.cap.value ) {
                ...
                for (i in 0 until old_core._size.value) {
                    while (true) {
                        ...
                        if ( intValue % BROKEN_VALUE != BROKEN_VALUE1 && intValue % BROKEN_VALUE != BROKEN_VALUE - BROKEN_VALUE1 ) {
...
private class Core<E>(
    ...
    fun get(index: Int): E {
       ...
       if ( result % BROKEN_VALUE == BROKEN_VALUE1 ) {
