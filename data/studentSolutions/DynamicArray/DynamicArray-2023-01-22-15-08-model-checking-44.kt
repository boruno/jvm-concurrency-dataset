...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun get(index: Int): E {
        checkBounds(index, core.value._size.value)
    ...
    override fun put(index: Int, element: E) {
        ...
        while (true) {
            ...
            if (curElementAtIndex == null) {
                val curCoreNext = curCore.next.value ?: break
                core.compareAndSet(curCore, curCoreNext)
                continue
            }
    ...
    private fun resizeArray(prevCore: Core<E>, prevCapacity: Int) {
        ...
        newCore._size.compareAndSet(0, prevCapacity)
