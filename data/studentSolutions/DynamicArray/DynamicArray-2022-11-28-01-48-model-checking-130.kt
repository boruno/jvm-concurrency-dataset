...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun pushBack(element: E) {
        ...
        while (true) {
            ...
            moveElementsToExtendedCore(currentCore, newCore, currentCapacity)
    ...
    private fun moveElementsToExtendedCore(currentCore: Core<E>, extendedCore: Core<E>, currentCapacity: Int) {
        ...
        for (index in 0 until currentCoreBound) {
            ...
            extendedCore.copyElement(movableElement.element)
    ...
    private fun forceCoreExtending() {
        ...
        if (nextCore != null) {
            val currentCapacity = currentCore.getCapacity()
            moveElementsToExtendedCore(currentCore, nextCore, currentCapacity)
...
private data class PushBackResult(val isSuccessful: Boolean, val index: Int) {
    override fun toString(): String {
        return "IsSuccessful: $isSuccessful, Index: $index"
    }
}