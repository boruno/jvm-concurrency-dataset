...
//                }
//            } else {
//                if ( coreCope.array[ index ].compareAndSet( null, element ) )
//                    return
//            }
            if ( copy != null ) {
                if ( (copy as Int) % BROKEN_VALUE != BROKEN_VALUE1 && ( copy as Int ) % BROKEN_VALUE != ( BROKEN_VALUE - BROKEN_VALUE1 ) && ( copy as Int ) % BROKEN_VALUE != ( BROKEN_VALUE1 - BROKEN_VALUE ) ) {
                    ...
                    if ( coreCope.next.value != null ) {
                        var c = coreCope.next.value!!.array[ index ].value
                        if ( c != null) {
                            if ( (c as Int) % BROKEN_VALUE != BROKEN_VALUE1 && ( c as Int ) % BROKEN_VALUE != ( BROKEN_VALUE - BROKEN_VALUE1 ) && ( c as Int ) % BROKEN_VALUE != ( BROKEN_VALUE1 - BROKEN_VALUE ) ) {
                                if ( coreCope.next.value!!.array[index].compareAndSet( c, element) ) {
                                    return
                                }
                            }
                        }
                ...
                if ( coreCope.next.value != null ) {
                    ...
                    if ( c != null) {
                        if ( (c as Int) % BROKEN_VALUE != BROKEN_VALUE1 && ( c as Int ) % BROKEN_VALUE != ( BROKEN_VALUE - BROKEN_VALUE1 ) && ( c as Int ) % BROKEN_VALUE != ( BROKEN_VALUE1 - BROKEN_VALUE ) ) {
                            coreCope.next.value!!.array[index].compareAndSet( c, element)
                        }
                    }
                    if ( coreCope.array[index].compareAndSet( null, element ) )
                        return
                ...
                for (i in 0 until old_core._size.value) {
                    while (true) {
                        ...
                        if ( intValue % BROKEN_VALUE != BROKEN_VALUE1 && intValue % BROKEN_VALUE != ( BROKEN_VALUE - BROKEN_VALUE1 ) && intValue % BROKEN_VALUE != ( BROKEN_VALUE1 - BROKEN_VALUE ) ) {
                            ...
                            copyC.array[ i ].compareAndSet( null, ( intValue - BROKEN_VALUE1 ).div( BROKEN_VALUE ) as E )
                            break
                        }
                    }
                }
