...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    private val publicIndexFactory = IndexFactory()


    override fun get(index: Int): E {
        require(index < size)
        return core.value.get(index, indexFactory.current())
    }

    override fun put(index: Int, element: E) {
        require(index < size)
        core.value.put(index, element, indexFactory.current())
    }

    override fun pushBack(element: E) {
        return pushBack(element, indexFactory.current())
    }
...
//            }
        ...
        if (currentCore.locked[i].compareAndSet(true, false)) {
            currentCore.array[i].value = element
            publicIndexFactory.next()
            return
        } else {
