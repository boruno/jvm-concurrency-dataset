...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    override fun pushBack(element: E) {
        while (true) {
            ...
            if (pushBackAttemptResult.isSuccessful) {
                ...
                break
            } else if (!tryMarkCoreAsExtending(currentCore)) {
                continue
            }
    ...
    private fun tryMarkCoreAsExtending(core: Core<E>): Boolean {
        return core.isExtending.compareAndSet(expect = false, update = true)
    }
    ...
    private fun moveElementsToExtendedCore(currentCore: Core<E>, extendedCore: Core<E>) {
        ...
        for (index in 0 until currentCoreBound) {
            ...
            if (movableElement == null) {
                extendedCore.incrementSize(index)
                continue
            }
