    ...
    override fun pushBack(element: E) {
        while (true) {
            ...
            if (sz == cor.array.size) {
                ...
                newcore._size.getAndSet(cor.array.size + 1);
                newcore.array[sz].compareAndSet(null, element)
            ...
            if (curcor.array[sz].compareAndSet(null, element)) {
                curcor._size.compareAndSet(sz, sz + 1)
                return
            }
        }
    }
