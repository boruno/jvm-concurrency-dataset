...
class DynamicArrayImpl<E>() : DynamicArray<E> {
    private val memory: AtomicArray<Array<AtomicReference<E>>?>
    private val descriptor = atomic(Descriptor<E>(0, null))

    init {
//        memory[0].value = Array(INITIAL_CAPACITY) { AtomicReference<E>(null) }
        memory = atomicArrayOfNulls<Array<AtomicReference<E>>>(32)
    }
