        ...
        while (true) {
            ...
            if (pushBackAttemptResult.isSuccessful) {
                ...
                if (currentCore.next.value != null) {
                    ...
                    if (!nextCore.copyElement(pushBackAttemptResult.index, element)) {
                        continue
                    }
                }
...
private class Core<E>(
    ...
    fun copyElement(index: Int, element: E?): Boolean {
        return array[index].compareAndSet(null, CommonElement(element))
    }
