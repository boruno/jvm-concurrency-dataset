...
class DynamicArrayImpl<E> : DynamicArray<E> {
    ...
    private val end_index = atomic(0)
    private val next_filled = atomic(false)
    ...
    override fun get(index: Int): E {
        while (true) {
            ...
            val e = next.value.array[index].value ?: continue
            return e.element()
        }
    }
    ...
    override fun put(index: Int, element: E) {
        while (true) {
            ...
            if (next.value.array[index].compareAndSet(State(value.element()), State(element))) {
                return
            }
        }
    }
