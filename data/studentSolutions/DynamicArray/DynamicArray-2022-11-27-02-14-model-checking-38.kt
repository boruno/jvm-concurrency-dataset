...
class DynamicArrayImpl<E> : DynamicArray<E> {
    private val memory = Array<AtomicReference<Array<AtomicReference<E>>>>(32) { AtomicReference(null) }
    private val descriptor = atomic(Descriptor<E>(0, null))

    init {
        memory[0].set(Array(INITIAL_CAPACITY) { AtomicReference(null) })
    }
