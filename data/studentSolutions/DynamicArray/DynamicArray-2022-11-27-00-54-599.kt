...
class DynamicArrayImpl<E> : DynamicArray<E> {
            ...
            if (index < currentCore.capacity ) {
                ...
                if (currentValue == null)
                {
                    ...
                    if (currentCore.nextList.value != null)
                        ...
                        throw Exception(
                            String.format(
                                "NULLPTR in GET. Index: %d, Size %d. Is currentCore mainCore: %b",
                                index,
                                size,
        ...
        while (currentCore != null) {
            ...
            if (currentElement == null)
            {
                if (currentCore.putCas(currentIndex, null, Node(element)))
                {
                    ...
                    if (size < currentIndex + 1)
                        throw Exception("WHAT THE FUCK WITH SIZE????")
                    return true
                }
                else
                    continue
            ...
            if (currentElement.getType() == "NodeFixed")
            {
                ...
                if (nextElement.getType() == "Node" || nextElement.getType() == "NodeMoved" || nextElement.getType() == "NodeFixed")
                {
                    currentCore = core.value
                    currentIndex++
                    continue
    ...
    private fun tryResizeArray() {
        var currentCore = core.value
        while (true) {
            if (currentCore.nextList.compareAndSet(null, Core(currentCore.capacity * 3, 0))) {
