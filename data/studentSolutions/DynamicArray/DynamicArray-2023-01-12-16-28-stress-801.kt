...
//                    newCore = Core<E>(curCore.cap * 2)
//                    newCore.setSize(curCore.cap + 1)
//                } else if (curNextCore.cap > curCore.cap * 2){
//                    newCore = Core<E>(curNextCore.cap)
//                    newCore.setSize(curCore.cap * 2 + 1)
//                } else {
//                    newCore = Core<E>(curCore.cap * 2)
//                    newCore.setSize(curCore.cap + 1)
//                }
//
//                if (curNextCore.cap == curCore.cap * 2 && curNextCore.size < curNextCore.cap){ // && curNextCore.size >= curNextCore.cap
//                    curCore.size
//                    curCore = curNextCore
//                    newCore = Core<E>(curCore.cap * 2)
//                    newCore.setSize(curCore.cap + 1)
...
//                    }
                    core.compareAndSet(copy, newCore)
                    core.compareAndSet(curCore, newCore)
//                    if (core.compareAndSet(copy, newCore) || core.compareAndSet(curCore, newCore)){
                        break
//                    }
                }
            }
