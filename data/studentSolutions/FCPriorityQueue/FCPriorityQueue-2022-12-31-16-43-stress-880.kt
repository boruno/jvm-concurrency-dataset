...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    private val stages = arrayListOf(AtomicInteger(0), AtomicInteger(0), AtomicInteger(0))
    private val tasks = arrayListOf(Task<E>(-1, null), Task<E>(-1, null), Task<E>(-1, null))
    private val results = arrayListOf(Task<E>(-1, null), Task<E>(-1, null), Task<E>(-1, null))
