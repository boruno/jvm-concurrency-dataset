...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    private val arrayIsLocked = atomic(false)
    ...
    fun poll(): E? {
        while(true) {
            if (!tryLock()) {
                ...
                if (fc_array[index].compareAndSet(null, operation) and !arrayIsLocked.value) {
    ...
    fun lockArray(): Boolean{
        return arrayIsLocked.compareAndSet(false,true)
    }
