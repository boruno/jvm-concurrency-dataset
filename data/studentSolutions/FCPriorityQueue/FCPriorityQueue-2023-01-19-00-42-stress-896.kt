...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    private fun getNext(): Int {
        return threadCnt.getAndSet((threadCnt.value % THREAD_NUMBER + 1) % THREAD_NUMBER)
        //return if (threadCnt.value >= THREAD_NUMBER - 1) (threadCnt.getAndIncrement()) else threadCnt.getAndIncrement() % THREAD_NUMBER
    }
