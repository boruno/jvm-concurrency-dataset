...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    private val stages = Array(arraySize) {it -> AtomicInteger(0)}
    private val tasks = Array(arraySize) {it -> Task<E>(-1, null)}
    private val results = Array(arraySize) {it -> Task<E>(-1, null)}
