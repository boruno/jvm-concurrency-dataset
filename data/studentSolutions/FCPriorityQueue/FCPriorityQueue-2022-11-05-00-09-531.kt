            ...
            if (tryLock()) {
                if (combined) {
                    if (flatCombiningArray[combineIndex].value?.value != null) {
                        ...
                        val result3 = flatCombiningArray[combineIndex].getAndSet(null)
...
private data class FcElement<E>(val operation: FcElementOperationType, var value: E?)
