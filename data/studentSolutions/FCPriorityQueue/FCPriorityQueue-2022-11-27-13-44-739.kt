...
private const val LenghtOfFlat = 1000

class FCPriorityQueue<E : Comparable<E>> {
    private val q = PriorityQueue<E>()
    private val flatArray = atomicArrayOfNulls<Flat<E>>(LenghtOfFlat)
    ...
    private fun addToFlat(flat: Flat<E>): Int {
        while (true) {
            val pos: Int = ThreadLocalRandom.current().nextInt(LenghtOfFlat)
