...
class FCPriorityQueue<E : Comparable<E>> {
     ...
     */
    fun poll(): E? {
        return commitOperation(CustomOperation { return@CustomOperation q.poll() })
    }
     ...
     */
    fun peek(): E? {
        return commitOperation(CustomOperation { return@CustomOperation q.peek() })
    }
     ...
     */
    fun add(element: E) {
        commitOperation(CustomOperation {
            q.add(element)
            null
        })
    }
