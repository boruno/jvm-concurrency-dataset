...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    val poll_request = atomicArrayOfNulls<Int>(SIZE) // null -- empty, 1 -- waiting, 2 -- result
    val poll_result: MutableList<E?> = MutableList(SIZE) { null }

    val peek_result: AtomicRef<E?> = atomic(null)

    val add_request = atomicArrayOfNulls<E>(SIZE)
