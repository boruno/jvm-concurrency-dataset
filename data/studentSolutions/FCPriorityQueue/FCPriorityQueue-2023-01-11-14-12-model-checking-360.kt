...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    private fun flatWaiter(anyAction: FlatCombingQueueType, lockFunction: () -> E?): E? {
    ...
    fun add(element: E) {
        ...
        while (true) {
            if (tryLock()) {
                ...
                flatWaiter(Add(element), lockFunction)
                return
            }
        }
    }
