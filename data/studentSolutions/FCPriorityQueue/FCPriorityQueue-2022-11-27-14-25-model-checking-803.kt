...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    private val lock = atomic(false) // лок имеет проблему при инициализации
    ...
    private fun process(function: () -> E?, type: OperationType, element: E?) : E? {
        ...
        while (true) {
            ...
            if (flatPlace != null) {
                flatPlace = addToFlat(Flat(type, element))
            }
        }
    }
