...
class FineGrainedBank(accountsNumber: Int) : Bank {
    ...
    override fun getAmount(id: Int): Long {
        ...
        account.lock.lock()
        return account.amount.also { account.lock.unlock() }
    }
    ...
    private fun lock(l1 : ReentrantLock, l2 : ReentrantLock) {
    ...
    private fun unlock(l1 : ReentrantLock, l2 : ReentrantLock) {
        if (l1.hashCode() < l2.hashCode()) {
            l1.unlock()
            l2.unlock()
        } else {
