...
class FineGrainedBank(n: Int) {
     ...
     */
    fun getAmount(index: Int): Long = lock.withLock {
     ...
     */
    fun totalAmount(): Long = lock.withLock  {
        // TODO: this method has to be made thread-safe.
     ...
     */
    fun deposit(index: Int, amount: Long): Long = lock.withLock {
        // TODO: this method has to be made thread-safe.
     ...
     */
    fun withdraw(index: Int, amount: Long): Long  = lock.withLock {
        // TODO: this method has to be made thread-safe.
        require(amount > 0) { "Invalid amount: $amount" }
        val account = accounts[index]
     ...
     */
    fun transfer(fromIndex: Int, toIndex: Int, amount: Long) = lock.withLock {
        // TODO: this method has to be made thread-safe.
        require(amount > 0) { "Invalid amount: $amount" }
