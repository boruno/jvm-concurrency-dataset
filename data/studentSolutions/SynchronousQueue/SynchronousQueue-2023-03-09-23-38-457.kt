...
class SynchronousQueue<E> {
    ...
    suspend fun receive(): E{
        while(true){
            val curTail = tail.value
            val curHead = head.value
            return if (curTail == curHead || curTail.operation.value == RECEIVE){
    ...
    private fun enqueue(curtail: Node<E>, newTail: Node<E>): Boolean {
        return if (curtail.next.compareAndSet(null, newTail)){
