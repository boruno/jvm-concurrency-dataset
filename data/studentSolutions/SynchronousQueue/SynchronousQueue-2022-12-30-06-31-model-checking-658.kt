    ...
    suspend fun send(element: E) {
        while (true) {
            ...
            if (curHead == curTail || curTail.operation.value == "SEND") {
                ...
                if (curHead.next.value!!.cor != null && head.compareAndSet(curHead, curHead.next.value!!)) {
