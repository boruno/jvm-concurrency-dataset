...
//        }
        while (true) {// добавить себя и заснуть
            ...
            // next node, first is dummy

            if (currHead.next.value != null) {
                val currHeadNext = sendersHead.value.next.value
                if (currHeadNext != null) {
                    if (currHeadNext.x is Receiver<*> && sendersHead.compareAndSet(currHead, currHeadNext)) {
    ...
    suspend fun receive(): E {
        while (true) {// добавить себя и заснуть
            ...
            if (currHead.next.value != null) {
                val currHeadNext = sendersHead.value.next.value
                if (currHeadNext != null) {
                    if (currHeadNext.x is Sender<*> && sendersHead.compareAndSet(currHead, currHeadNext)) {
