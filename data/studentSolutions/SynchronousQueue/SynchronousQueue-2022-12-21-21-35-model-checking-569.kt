...
class SynchronousQueue<E> {
    ...
    suspend fun send(element: E) {
        while (true) {
            ...
            val cur_tail_value = cur_tail.x.value as Pair<Continuation<Any>, Optional<E>?>?
            if (cur_head == cur_tail || cur_tail_value != null && cur_tail_value.second != null) {
                ...
                val res = suspendCoroutine<Any> sc@ { cont ->
                    ...
                    if (cur_head.next.compareAndSet(null, next) && head.compareAndSet(cur_head, next)) {
                        return@sc
                    } else {
