...
class SynchronousQueue<E> {
    ...
    suspend fun send(element: E): Unit {
        while (true) {
            ...
            //     continue
            // }
            if (tail == head || value == null || value.isSender()) {
                ...
                if (res == true) return
            // } else if (head.x != null && head.x.isReceiver()) {
            } else if (headNext != null && headNext.x != null && headNext.x.isReceiver()) {
    ...
    suspend fun receive(): E {
        while (true) {
            ...
            //     continue
            // }
            if (tail == head || value == null || value.isReceiver()) {
