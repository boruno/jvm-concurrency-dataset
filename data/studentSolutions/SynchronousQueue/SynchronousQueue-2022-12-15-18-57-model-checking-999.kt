...
class SynchronousQueue<E> {
    ...
    suspend fun send(element: E) {
        ...
        while (true) {
            ...
            if (curHead == curTail || curTail.isSender()) {
                ...
                enqueueAndSuspend(curTail, element, Operation.SEND)
            } else {
                dequeueAndResume(curTail, curHead)
            }
        }
    }
    ...
    suspend fun receive(): E {
        ...
        while (true) {
            ...
            if (curHead == curTail || curTail.isReceiver()) {
                ...
                enqueueAndSuspend(curTail, null, Operation.RECEIVE)
            } else {
                dequeueAndResume(curTail, curHead)
    ...
    private fun dequeueAndResume(curTail: Node<E>, curHead: Node<E>): E? {
    ...
    private suspend fun enqueueAndSuspend(curTail: Node<E>, element: E?, operation: Operation) {
