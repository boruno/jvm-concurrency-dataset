...
class ConcurrentHashTableWithoutResize<K : Any, V : Any>(initialCapacity: Int) : HashTable<K, V> {
    ...
    class Table<K : Any, V : Any>(val capacity: Int) {
        ...
        private fun getAndSetValue(index : Int, value: V?): V? {
            val oldVal = values[index]
            while (!values.compareAndSet(index, oldVal, value)){}
            return oldVal
        }
            ...
            repeat(MAX_PROBES) {
                ...
                when (curKey) {
                    ...
                    key -> {
                        ...
                        // values[index] = value
                        return getAndSetValue(index, value)
                    }
            ...
            repeat(MAX_PROBES) {
                ...
                when (curKey) {
                    ...
                    key -> {
                        ...
                        return getAndSetValue(index, null)
                    }
                    // Empty cell.
                    null -> {
                        // The key has not been found.
