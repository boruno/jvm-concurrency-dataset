            ...
            while(true) {
                ...
                when (curKey) {
                    ...
                    key -> {
                        ...
                        val sell = values[index]
                        while (true) {
                            val oldValue = sell.value
                            if (sell.compareAndSet(oldValue, value)) {
                                return oldValue
                            }
                        }
                    }
                    ...
                    null -> {
                        ...
                        val keySell = keys[index]
                        if (keySell.compareAndSet(null, key) || keySell.value == key) {
                            continue
                        }
            ...
            repeat(MAX_PROBES) {
                ...
                when (curKey) {
                    ...
                    key -> {
                        ...
                        while (true) {
                            val oldValue = sell.value
                            if (oldValue == null || sell.compareAndSet(oldValue, null)) {
                                return oldValue
                            }
                        }
                    }
