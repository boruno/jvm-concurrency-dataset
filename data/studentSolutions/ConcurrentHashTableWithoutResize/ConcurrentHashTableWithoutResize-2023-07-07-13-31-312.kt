            ...
            repeat(MAX_PROBES) {
                ...
                when (curKey) {
                    ...
                    key -> {
                        ...
                        if (values[index].compareAndSet(v, value))
                            return v
                    ...
                    null, REMOVED_KEY -> {
                        ...
                        val previous = values[index].value
                        if (keys[index].compareAndSet(null, key)) {
                            if (values[index].compareAndSet(previous, value))
                                return previous
                        }
                    }

                    else -> // Process the next cell, use linear probing.
