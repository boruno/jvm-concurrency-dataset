            ...
            repeat(MAX_PROBES) {
                ...
                when (curKey) {
                    ...
                    key -> {
                        ...
                        while (!values.compareAndSet(index, oldValue, value)) {
                    ...
                    null -> {
                        ...
                        while (!keys.compareAndSet(index, null, key)) {

                        }
                        while(!values.compareAndSet(index, null, value)){}
...
//                        keys[index] = REMOVED_KEY
                        ...
                        var oldValue = values[index]
                        while(!values.compareAndSet(index, oldValue, null)) {
                            oldValue = values[index]
                        }
                        return oldValue
                    }
