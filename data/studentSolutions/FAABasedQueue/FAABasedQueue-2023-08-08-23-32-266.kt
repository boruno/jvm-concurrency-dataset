...
class FAABasedQueue<E> : Queue<E> {
    ...
    override fun validate() {
        ...
        val deqSegIdDelta = deqSeg.id - head.get().id
        check(0 <= deqSegIdDelta && deqSegIdDelta <= 1) {
        ...
        val enqSegIdDelta = enqSeg.id - tail.get().id
        check(0 <= enqSegIdDelta && enqSegIdDelta <= 1) {
