...
class FAABasedQueue<E> : Queue<E> {
    private val start: AtomicReference<Segment>
    ...
    init {
        ...
        start = AtomicReference(startingSegment)
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            return segment.cells[cellIndex].also { segment.cells.compareAndSet(cellIndex, it, POISONED) } as E
        }
//        TODO("")
    }
