...
class FAABasedQueue<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        while (true) {
            ...
            moveTailForward()
            if (segment.cells.compareAndSet((i % 64).toInt(), null, element)) {
                return
            }
        }
    }
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            if (segment.cells.compareAndSet((i % 64).toInt(), null, POISONED)) {
                continue
            }

            return segment.cells.get((i % 64).toInt()) as E?
        }
    }
