...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        while (true) {
            val eIdx = enqIdx.getAndIncrement()

            if (infiniteArray.compareAndSet(eIdx.toInt(), null, element)) return
        }
...
//        infiniteArray.set(i.toInt(), element)
    ...
    override fun dequeue(): E? {
        ...
        while (infiniteArray.compareAndSet(i.toInt(), null, POISONED)) {
            // loop until non-empty element is found
        }
