...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    override fun dequeue(): E? {
        ...
        var element: E? = infiniteArray[i].getAndSet(POISONED) // Atomically mark the cell as POISONED
        while (element == POISONED) {
            element = infiniteArray[i].get() // Retry until a non-POISONED element is retrieved
        }
        return element
    }
}
