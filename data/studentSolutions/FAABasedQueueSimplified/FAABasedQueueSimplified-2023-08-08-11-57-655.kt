...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        while(true) {
            ...
            if (infiniteArray.compareAndSet(index.toInt(), null, element)) break
        }
    }
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            if (infiniteArray.compareAndSet(index.toInt(), null, POISONED)) continue
            return infiniteArray.get(index.toInt()) as E
        }
    }
