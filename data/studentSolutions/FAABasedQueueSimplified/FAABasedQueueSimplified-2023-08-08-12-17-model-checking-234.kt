...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            val newIndex = enqIdx.getAndIncrement() + 1
            if (infiniteArray.compareAndSet(newIndex.toInt(), null, element)) {
                return
            }
        }
...
//        if (enqIdx.get() <= deqIdx.get()) return null
            ...
            if (!infiniteArray.compareAndSet(oldIndex.toInt() + 1, null, POISONED)) {
                return infiniteArray[oldIndex.toInt() + 1] as E
            }
        }
//
//        // TODO: Increment the counter atomically via Fetch-and-Add.
