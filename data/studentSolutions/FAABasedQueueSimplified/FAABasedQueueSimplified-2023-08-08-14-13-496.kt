...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    private fun isQueueEmpty(curDeq: Long): Boolean {
        while (true) {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (!isQueueEmpty(curDeq)) {
                return null
            }

            // TODO: Try to retrieve an element if the cell contains an
            // TODO: element, poisoning the cell if it is empty.
            infiniteArray.compareAndSet(curDeq.toInt(), null, POISONED)

            val element = infiniteArray.getAndSet(curDeq.toInt(), null) as E
            if (element != null)
                return element
        }
