...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    override tailrec fun enqueue(element: E) {
        ...
        if (!infiniteArray.compareAndSet(i.toInt(), null, element)) return enqueue(element)
    }
    ...
    override tailrec fun dequeue(): E? {
        ...
        if (infiniteArray.compareAndSet(i, null, POISONED)) return dequeue()
        // TODO: Try to retrieve an element if the cell contains an
        // TODO: element, poisoning the cell if it is empty.
        return infiniteArray.get(i) as E
    }
