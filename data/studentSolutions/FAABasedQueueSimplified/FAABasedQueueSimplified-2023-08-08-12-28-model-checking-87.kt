...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        while (true) {
            ...
            if (infiniteArray.compareAndSet(enqIdx.toInt(), null, element)) {
                return
            }
        }
    }
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            if (infiniteArray.compareAndSet(deqIdx.toInt(), null, POISONED))
                continue
            else {
                val element = infiniteArray.get(deqIdx.toInt())
                infiniteArray.set(deqIdx.toInt(), element)
                return element as E
//                return infiniteArray.getAndSet(deqIdx.toInt(), null) as E 
            }
        }
    }
