...
class FAABasedQueueSimplified<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        while(true) {
            ...
            val ret = infiniteArray.getAndUpdate(i.toInt()) {
                if (it == null) {
                    return@getAndUpdate element
                } else {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            val element = infiniteArray.getAndSet(i.toInt(), POISONED)
            if (element != null && element != POISONED) return element as E
        }
