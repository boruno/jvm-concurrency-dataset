...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        if (curTail.next.compareAndSet(null, newNode)) {
            ...
            if (curTail.extractedOrRemoved) curTail.doRemove()
        } else {
    ...
    private inner class Node(
        ...
        fun doRemove() {
            val h = this@MSQueueWithLinearTimeRemove.head.value
            val t = this@MSQueueWithLinearTimeRemove.tail.value
            if (this == h || this == t) return

            var n = h
            while (n.next.value != this && n.next.value != null) {
                n = n.next.value!!
            }
            if (n.next.value == this) n.next.lazySet(this.next.value)
        }
    }
}
