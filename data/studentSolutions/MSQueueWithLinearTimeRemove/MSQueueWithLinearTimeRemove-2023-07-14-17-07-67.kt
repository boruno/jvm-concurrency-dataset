...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            // Phase 2: Remove node physically. It should be done in the subsequent nodes
            // as we don't have a reference to the previous node in a singly linked list
            val nextNode = next.value
            if (nextNode != null) {
                nextNode.next.compareAndSet(this, nextNode)
            }
