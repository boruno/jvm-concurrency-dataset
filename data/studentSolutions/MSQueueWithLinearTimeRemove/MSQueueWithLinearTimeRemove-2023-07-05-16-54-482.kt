...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true){
            ...
            if (curTail.next.compareAndSet(null, newNode)) {
                val isTailMarked = curTail.extractedOrRemoved
                ...
                if (nextValue is Node) {
                    tail.compareAndSet(curTail, nextValue as Node)
                }
            }
        }
    }
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            var prevNode = this@MSQueueWithLinearTimeRemove.head.value
            while(true) {
                ...
                if (prevNode.next.compareAndSet(this, next.value)) {
                    ...
                    // we can safely set next.value to null
                    next.value = null
                    break
                }
