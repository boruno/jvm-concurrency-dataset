...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (this.next.value == null) return isMarkedExtractedOrRemoved
            var prev: Node = head.value
            while (prev.next.value != this){
                prev = prev.next.value ?: return isMarkedExtractedOrRemoved
            }
            prev.next.value = this.next.value
            if (this.next.value!!.extractedOrRemoved) this.next.value!!.extractedOrRemoved
