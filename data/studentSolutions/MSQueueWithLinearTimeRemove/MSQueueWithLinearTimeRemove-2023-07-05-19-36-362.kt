...
//            if (tail.value != this) {
            ...
            while (true) {
                ...
                if (next == null) break
                if (next == this) {
                    node.next.value = this.next.value
/*
                    if (node.next.compareAndSet(this, this.next.value)) {
                        break
                    } else {
                        println(node.next.value?.element)
                        break
//                        throw IllegalStateException("value " + node.next.value)
                    }
*/
                }
                node = next
