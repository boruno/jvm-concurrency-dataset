...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (witness === null) {
                ...
                if (tail.extractedOrRemoved) tail.removePhysically()
                return
            } else {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (witness === head && next.markExtractedOrRemoved()) {
    ...
    private inner class Node(
        ...
        fun removePhysically() {
            val next = next.get() ?: return
            val previousNode = findPrevNode() ?: return
            previousNode.next.compareAndSet(this, next)
        }
