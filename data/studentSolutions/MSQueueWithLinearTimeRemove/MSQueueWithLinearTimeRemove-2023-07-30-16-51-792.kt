...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (currentTail.next.compareAndSet(null, toEnqueue)) {
                ...
                if (currentTail.next.value == null) {
                    continue
                }
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            val headNext = head.value.next.value ?: return null
            check (head.compareAndSet(head.value, headNext) && headNext.markExtractedOrRemoved()) {
    ...
    private inner class Node(
        ...
        fun deleteNode() {
            check (this == tail.value || this == head.value || this.next.value == null) { return }
            ...
            previous.next.getAndSet(nextNode)
            if (previous.extractedOrRemoved || (nextNode != null && nextNode.extractedOrRemoved)) {
                previous.deleteNode()
            }
        }
    }
