...
//        TODO("Implement me!")
        while (true) {
            ...
            val referrer = curTail.referrer()
            if (curTail.extractedOrRemoved && referrer != null) {
                if (referrer.next.compareAndSet(curTail, node)) {
                    tail.compareAndSet(curTail, node)
                    return
                } else {
                    tail.compareAndSet(curTail, referrer.next.value!!)
                }
