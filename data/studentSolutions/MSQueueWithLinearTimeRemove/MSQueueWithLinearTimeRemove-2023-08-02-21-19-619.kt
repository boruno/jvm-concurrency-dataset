...
//            removed := tryMarkRemoved()
//            curPrev := findPrev()
//            curNext := next
//            curPrev.next = curNext
//            if curNext.isRemoved: curNext.remove()
//            return removed
...
//            val currentPrevious = findPreviousNode()
...
//            return remove
        ...
        fun physicalRemove() {
            ...
            if (previousNode != null) {
                previousNode.next.value = currentNodeNext.value

                if (currentNodeNext.value!!.extractedOrRemoved) {
                    currentNodeNext.value?.remove()
                }
            }
        }
