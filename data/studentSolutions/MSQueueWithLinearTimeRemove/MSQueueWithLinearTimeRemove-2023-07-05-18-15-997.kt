...
//        TODO("Implement me!")
        while (true) {
            ...
            if (head.compareAndSet(current, next.value!!) && next.value?.markExtractedOrRemoved() == true) {
...
//
//            val currentPrev = findPrev(this)
//            val currentNext = next
//            val curPrevNext = currentPrev?.next
//
//            (currentPrev?.next ?: return false).value = next.value
//            while (true) {
//                currentPrev?.next?.value = currentNext.value
//                currentPrev.compareAndSet(curNext, next.value)
//            }
        ...
        fun findPrev(node: Node): Node? {
            var prevNode: Node? = head.value
            while (prevNode != null && prevNode != tail.value && node.next.value != prevNode) {
