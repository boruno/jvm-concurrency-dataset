...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
                ...
                if (next == null) {
                    if (curTail.next.compareAndSet(null, newNode)) {
                        ...
                        if (curTail.extractedOrRemoved) {
                            val prev = curTail.getPrev() ?: break
                            prev.next.compareAndSet(curTail, curTail.next.value)
                        }
                        break
                    }
                }
    ...
    private inner class Node(
         ...
         */
        fun remove(kek: Boolean = false): Boolean {
        ...
        fun getPrev(): Node? {
            if (this == head.value || this == tail.value || this.next.value == null) return null
