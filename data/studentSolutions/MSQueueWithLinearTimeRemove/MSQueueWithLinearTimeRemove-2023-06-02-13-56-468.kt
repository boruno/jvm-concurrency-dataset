    ...
    override fun enqueue(element: E) {
        while (true) {
            ...
            if (curTail.next.compareAndSet(null, node)) {
                ...
                moveTail(curTail, next)
            }
        }
    }

    private fun moveTail(curTail: Node, next: Node) {
...
//                }
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            } else if (curPrev == head.value) {
                head.value.next.compareAndSet(this, null)
                tail.compareAndSet(this, head.value)
            }
            return result
        }
