...
//        while (true) {
//            val currentDeqIdx = head.value
//            val currentEnqIdx = tail.value
//            if (currentDeqIdx != head.value) continue
...
//    }
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (this === head.value || this === tail.value) return extractedOrRemoved
            ...
            val nextNode = this.next.value ?: return extractedOrRemoved
            someNode.next.compareAndSet(this, nextNode)
            if (someNode.extractedOrRemoved) someNode.remove()
            if (nextNode.extractedOrRemoved) someNode.remove()
            return extractedOrRemoved
        }
    }
}
