    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (curHeadNext.markExtractedOrRemoved()) {
                val newHead = curHeadNext.next.get()
...
//                }
//            }
            while (!prevNode.next.compareAndSet(this, nextNode)) {
                // The nextNode has been changed by another thread
                // Retry the findPreviousNode and compareAndSet operation
                prevNode.next.compareAndSet(this, nextNode)
            }
