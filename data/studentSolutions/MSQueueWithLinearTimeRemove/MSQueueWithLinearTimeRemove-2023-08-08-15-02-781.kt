...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (head.compareAndSet(curHead, curHeadNext)) {
                if (curHeadNext.tryMarkExtractedOrRemoved()) {
    ...
    private inner class Node(
        ...
        fun tryMarkExtractedOrRemoved(): Boolean =
        ...
        fun remove(): Boolean {
            ...
            val marked = tryMarkExtractedOrRemoved()
        ...
        private fun findPrevNode(): Node {
            var pointer = head.get()
            while (pointer != null && pointer.next.get() != this) {
