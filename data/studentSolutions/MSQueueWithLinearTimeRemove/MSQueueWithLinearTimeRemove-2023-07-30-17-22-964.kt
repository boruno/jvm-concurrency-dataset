...
class MSQueueWithLinearTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (currentTail.next.compareAndSet(null, toEnqueue)) {
                tail.compareAndSet(currentTail, toEnqueue)
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (afterHead.markExtractedOrRemoved() && head.compareAndSet(head.value, afterHead)) {
        ...
        fun deleteNode() {
            ...
            fun getPrevious(): Node? {
                ...
                while (prevNode.next.value !== this) {
                    requireNotNull(prevNode.next.value) { return null }
                    prevNode = prevNode.next.value!!
                }
                return prevNode
            }

            val nextNode = next.value
            val previousNode = getPrevious() ?: return
