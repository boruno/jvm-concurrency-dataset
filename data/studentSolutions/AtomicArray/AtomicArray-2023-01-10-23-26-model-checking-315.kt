...
class AtomicArray<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas(index: Int, expected: Any, update: E) =
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        val result = CAS2Descriptor(Ref<E>(a[index1].value as E), expected1, update1,
            Ref<E>(a[index2].value as E), expected2, update2, index1, index2, this).complete()
        return result
    }
    ...
    class CAS2Descriptor<E : Any>(
        ...
        val index1: Int, val index2: Int, val array: AtomicArray<E>) : Descriptor(){
        ...
        override fun complete(): Boolean {
            ...
            array.cas(index1, expectA, if (outcome.value == 1) updateA else expectA)
            array.cas(index2, expectB, if (outcome.value == 1) updateB else expectB)
