...
class AtomicArray<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        val result = CAS2Descriptor(Ref<E>(a[index1].value as E), expected1, update1,
            Ref<E>(a[index2].value as E), expected2, update2).complete()
        cas(index1, expected1, if (result) update1 else expected1)
        cas(index2, expected2, if (result) update2 else expected2)
        return result
    }
