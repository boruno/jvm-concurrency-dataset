...
class AtomicArray<E>(size: Int, initialValue: E) {
    ...
    fun cas(index: Int, expected: E, update: E) =
        array[index].value!!.ref.compareAndSet(expected, update)
    ...
    private fun cas2(a: MyRef<Any?>, expectedA: E, updateA: E,
        ...
        if (a === b) {
            if (expectedA == expectedB) {
                // а почему так? просто опыт - говно
                // https://www.youtube.com/watch?v=0JEiqacI5k8
                return b.ref.compareAndSet(expectedB, (expectedB as Int + 2) as E)
            }
            return false
        }
