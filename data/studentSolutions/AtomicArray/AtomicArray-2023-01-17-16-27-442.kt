        ...
        val updateB: E) : Descriptor
    {
        ...
        override fun complete() {
            ...
            if (b is AtomicArray<*>.DcssDescriptor && b != this) {
                var s = "A: $indexA; B: $indexB; DCSS: A${b.indexA}, B: ${b.indexB}, eA: ${b.expectedA}, eB: ${b.expectedB}, uA: ${b.updateA}, o: ${b.outcome.value}"
                b.complete()
                s += '\n'
                s += "A: $indexA; B: $indexB; DCSS: A${b.indexA}, B: ${b.indexB}, eA: ${b.expectedA}, eB: ${b.expectedB}, uA: ${b.updateA}, o: ${b.outcome.value}"
                error(s)
            }
