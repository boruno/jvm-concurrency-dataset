...
class AtomicArray<E : Any>(size: Int, initialValue: E) {
    ...
    private fun doubleCompareSingleSwap(
        ...
        while (true) {
            ...
            if (a[indexA].compareAndSet(expectedA, descriptor)) {
                descriptor.complete()
                return a[indexA].value == descriptor.updateA
            }
        }
    }
    ...
    private inner class DcssDescriptor(
        ...
        override fun complete() {
            val result = if (updateA.isUndecided()) updateA
                         else expectedA

            println(updateA.outcome.value)

            if (a[indexB].value != expectedB)
                return

            a[indexA].compareAndSet(this, result)
        }
    }
        ...
        val updateB: E) : Descriptor
    {
        ...
        override fun complete() {
            ...
            if (!doubleCompareSingleSwap(indexA = indexB, expectedA = expectedB, updateA = this, indexB = indexA, expectedB = this)) {
