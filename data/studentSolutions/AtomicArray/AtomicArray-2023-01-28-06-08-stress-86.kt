...
class AtomicArray<E>(size: Int, initialValue: E) {
    ...
    fun get(index: Int) : E = getImpl(index, null)

    private fun getImpl(index : Int, notSkippedDesc : Descriptor?) : E {
        do {
            val v = a[index].value
            if (v is Descriptor) {
                if (v !== notSkippedDesc) {
    ...
    private fun equalsIndexes(index1: Int, expected1: E, update1: E, expected2: E, update2: E) : Boolean {
        ...
        //val upd = update1.value + update2.value
        return casImpl(index1, expected2 as Any, (update1 as Int + update2 as Int - expected1 as Int) as Any)
    }
}
