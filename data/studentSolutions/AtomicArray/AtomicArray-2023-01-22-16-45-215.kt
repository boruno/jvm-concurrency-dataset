...
class AtomicArray<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        /*if (index1 == index2) {
            return if (expected1 == expected2) cas(index1, expected1, expected2) else false
        } else {
            if(index1 > index2) {
                return CAS2Descriptor(a[index2], expected2, update2, a[index1], expected1, update1).complete()
            } else {
                return CAS2Descriptor(a[index1], expected1, update1, a[index2], expected2, update2).complete()
            }
        }*/
        fun getValues(): Triple<Int, E, CAS2Descriptor<E>> = when {
            index1 > index2 ->
                ...
                Triple(index1, expected1, CAS2Descriptor(a[index2], expected2, update2, a[index1], expected1, update1))
        }
...
class CAS2Descriptor<E>(
    ...
    override fun complete() /*: Boolean*/{
        ...
        //val succ = this.status.value != FAIL
