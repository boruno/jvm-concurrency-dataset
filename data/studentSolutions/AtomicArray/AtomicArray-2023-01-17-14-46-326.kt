...
class AtomicArray<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        if (!doubleCompareSingleSwap(descriptor.indexB, descriptor.expectedB, descriptor, descriptor.indexA, descriptor) && a[descriptor.indexB].value != descriptor) {
    ...
    private fun doubleCompareSingleSwap(indexA: Int, expectedA: Any, updateA: Any,
                                        indexB: Int, expectedB: Any): Boolean {
        ...
        val updateB: E)
    {
        ...
        fun complete() {
            ...
            if (!doubleCompareSingleSwap(indexB, expectedB, this, indexA, this) && a[indexB].value != this) {
