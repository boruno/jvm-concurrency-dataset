...
class AtomicArray<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        return if (index1 == index2) {
            ...
            val d: CAS2Descriptor<E>
            if (index2 >= index1) {
                d = CAS2Descriptor(a[index1], expected1, update1, a[index2], expected2, update2)
            } else {
                d = CAS2Descriptor(a[index2], expected2, update2, a[index1], expected1, update1)
            }
