...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        if ( index1 < index2 ) {
            var copy = a[ index1].value
            var copy1 = a[ index2 ].value
            ...
            var copy = a[ index2].value
            var copy1 = a[ index1 ].value
...
//        if ( copy.c != null ) {
//            cas2( copy.indexA!!, copy.a.value!!, copy.updateA!!, copy.indexB!!, copy.b!!, copy.updateB!! )
//            return false
//        }
//
//        if ( copy1.c != null ) {
//            cas2( copy1.indexA!!, copy1.a.value!!, copy1.updateA!!, copy1.indexB!!, copy1.b!!, copy1.updateB!! )
//            return false
//        }

        if ( copy.a.value == command.a.value && a[ command.indexA!! ].compareAndSet( copy, command ) && copy.a.value == command.a.value ) {
            if ( copy1.a.value == a[command1.indexA!!].value!!.a.value && a[ command1.indexA ].compareAndSet( copy1, command1 ) && copy1.a.value == command1.a.value ) {
                command.c = SUCC
                command1.c = SUCC
