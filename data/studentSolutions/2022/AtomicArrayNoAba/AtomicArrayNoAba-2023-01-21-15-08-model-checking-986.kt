    ...
    fun cas2(index1: Int, expected1: Int, update1: Int,
        ...
        if (index1 == index2) {
            if (expected1 == expected2 && update1 == update2) {
                ...
                return cas(index1, expected2, update2)
            }
        }

        val thisCASNDescriptor: CASNDescriptor<Int>
        if (index1 < index2) {
            thisCASNDescriptor = CASNDescriptor(index1, expected1, update1, index2, expected2, update2)
        }
        else {
            thisCASNDescriptor = CASNDescriptor(index2, expected2, update2, index1, expected1, update1)
        }
