...
class AtomicArrayNoAba<E>(size: Int, initialValue: E) {
    ...
    private fun applyDescriptor(descriptor: CAS2Descriptor<E>): Boolean {
        if (descriptor.status != CAS2Descriptor.Status.Updated) {
            ...
            if (value1 != descriptor && !a[descriptor.index1].compareAndSet(descriptor.expected1, descriptor)) {
                return false
            }
            if (value2 != descriptor && !a[descriptor.index2].compareAndSet(descriptor.expected2, descriptor)) {
