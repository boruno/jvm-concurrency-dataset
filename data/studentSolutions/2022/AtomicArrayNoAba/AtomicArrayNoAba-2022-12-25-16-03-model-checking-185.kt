...
//        println("v2: $v2")
        ...
        if (v1 !is Descriptor<*> && v2 !is Descriptor<*>) {
            v1 = Descriptor(expected1, if (index1 == index2 && update1 is Int) update1 + 1 else update1, st)
            v2 = Descriptor(expected2, if (index1 == index2 && update2 is Int) update2 + 1 else update2, st)
