    ...
    override fun pushBack(element: E) {
        while (true){
            ...
            if (curCore.actualSize.value < curCore.cap){
                ...
                if (result == 2){
//                    if (curCore.actualSize.value == curCore.cap){
////                        if(core.compareAndSet(copy, curCore) || curCore.isFixed(curCore.cap - 1) || core.value == curCore){
//////                            break
//////                        }
//                        break
////                        if (core.compareAndSet(copy, curCore)){
////                            break
////                        }
////                        if (curCore.isFixed(curCore.cap - 1) || copy == curCore || core.value == curCore){
////                            break
////                        }
////                        continue
////                        if (copy != curCore && core.value != curCore && !curCore.isFixed(curCore.cap - 1))
////                            continue
////                        break
//                    }
                    break
