...
private class Core<E>(
    ...
    fun get(index: Int): E {
        require(index < size && index < array.size)
        return when (val ans = array[index].value) {
    ...
    fun pushBack(element: E): Boolean {
        ...
        val a = array[index].value
        if (a is Continue<E> || !array[index].compareAndSet(a, OK(element))) {
            next.value!!.putNull(index, element)
        }
