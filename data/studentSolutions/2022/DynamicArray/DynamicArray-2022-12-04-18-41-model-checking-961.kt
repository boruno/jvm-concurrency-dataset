...
private class Core<E>(
    ...
    fun get(index: Int): E {
        ...
        if (curValue is Closed<*>) {
            return (next.value!!.array[index].value as E) ?: throw IllegalArgumentException()
        }

        return curValue as E ?: throw IllegalArgumentException()
    }
