...
class TreiberStackWithElimination<E> {
    ...
    fun push(x: E) {
        ...
        while (true) {
            ...
            if(curRecord.state == EliminationState.DONE && curRecord.elimIndex == elimIdx){
            ...
            if(curRecord.state == EliminationState.PUSH && curRecord.elimIndex == elimIdx){
    ...
    fun pop(): E? {
        ...
        while(true) {
            ...
            if(curRecord.state == EliminationState.POP && curRecord.elimIndex == elimIdx){
                if(!eliminationArray[index].compareAndSet(curRecord, null))
                    continue
            }
