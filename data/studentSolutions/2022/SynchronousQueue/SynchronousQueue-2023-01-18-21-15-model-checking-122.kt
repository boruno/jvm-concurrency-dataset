...
class SynchronousQueue<E> {
    ...
    suspend fun send(element: E): Unit {
        while (true) {
            ...
            val s = sendSeg.value//findSegment(curSendSeg, i / SEGMENT_SIZE)
    ...
    suspend fun receive(): E {
        while (true) {
            ...
            val s = sendSeg.value//findSegment(curReceiveSeg, i / SEGMENT_SIZE)
    ...
    //private val node : Segment<Continuation<CoroutineElement<E>>>
...
const val SEGMENT_SIZE = 100 // DO NOT CHANGE, IMPORTANT FOR TESTS
