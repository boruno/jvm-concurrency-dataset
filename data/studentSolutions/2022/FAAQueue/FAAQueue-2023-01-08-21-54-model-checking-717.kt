...
class FAAQueue<E> {
    ...
    fun enqueue(element: E) {
        while (true) {
            ...
            if (tail.value.getId() > segment.getId()) continue
            else if (tail.value.getId() == segment.getId()) tail.value = segment
            else tail.value.next.value = segment
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            if (head.value.getId() > segment.getId()) continue
            else if (head.value.getId() == segment.getId()) head.value = segment
            else head.value.next.value = segment
