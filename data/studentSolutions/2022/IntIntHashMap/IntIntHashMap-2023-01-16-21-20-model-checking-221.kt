        ...
        fun putInternal(key: Int, value: Int): Int {
            ...
            while (true) {
                ...
                if (nextCore.value != null) {
                    val index2 = nextCore.value!!.getInternalIndex(key)
                    nextCore.value!!.map[index2 + 1].compareAndSet(null, value)
                    nextCore.value!!.map[index2 + 1].compareAndSet(prev, value)
                }
        ...
        fun rehash(): Core {
            ...
            while (index < map.size) {
                ...
                if (isValue(v ?: 0) || v == DEL_VALUE) {
                    ...
                    while (false) {//i dont particularly like it
                        val v2 = map[index + 1].value
                        if (map[index + 1].compareAndSet(v2, MOVED)) {
                            break
                        }
                    }
                }
