...
class IntIntHashMap {
    ...
    fun put(key: Int, value: Int): Int {
        ...
        if (!isValue(previousValue) && previousValue != 0)
            println("Previous value in put operation = $previousValue, Key = $key, Map: ${core.value}")
    ...
    fun remove(key: Int): Int {
        ...
        if (!isValue(previousValue) && previousValue != 0)
            println("Previous value in remove operation = $previousValue, Key = $key, Map: ${core.value}")
