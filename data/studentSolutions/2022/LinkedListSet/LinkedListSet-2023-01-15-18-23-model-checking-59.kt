...
//            }
            ...
            val currentValue = currNode.elementNullable
            val nextValue = currNext!!.elementNullable
            if (currentValue == null) {
                if (nextValue == null) {
                    val newNode = Node(currNode, element, currNext)
                    if (currNode.casNext(currNext, newNode)) {
                        currNext.casPrev(currNode, newNode)
                        return true
                    } else {
                ...
                if (nextValue == null) {
                    ...
                    } else currNode = currNext
                } else {
                    if (element <= currentValue) return false
