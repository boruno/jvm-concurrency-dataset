...
class LinkedListSet<E : Comparable<E>> {
    private val first = Node<E>(element = -1000000 as E, next = Node(element = 1000000000 as E, next = null))
    ...
    fun findWindow(x: E): Window<E> {
       loop@ while (true) {
            ...
            while (nextNode!!.element < x) {
                val (nextNextNode, nextNextRemoved) = nextNode.nextAndRemoved.value
                if (nextNextRemoved) {
