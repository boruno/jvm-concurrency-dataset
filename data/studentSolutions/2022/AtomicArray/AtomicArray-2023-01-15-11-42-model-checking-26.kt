...
class AtomicArray<E>(size: Int, initialValue: E) {
    ...
    fun cas2(_index1: Int, _expected1: E, _update1: E,
             _index2: Int, _expected2: E, _update2: E): Boolean {
        var index1: Int = _index1
        var expected1: E = _expected1
        var update1: E = _update1
        var index2: Int = _index2
        var expected2: E = _expected2
        var update2: E = _update2
        if (_index1 > _index2) {
            index1 = _index2
            expected1 = _expected2
            update1 = _update2
            index2 = _index1
            expected2 = _expected1
            update2 = _update1
        }
        if(index1 == index2) {
...
private class Cas2Descriptor(
    ...
    override fun complete() {
        ...
        if (b.v.compareAndSet(expectedB, rdcssDescriptor)) {
            ...
            if (b.v.value is Descriptor) { return }
            outcome.cas(DStatus.UNDECIDED, DStatus.FAIL)
