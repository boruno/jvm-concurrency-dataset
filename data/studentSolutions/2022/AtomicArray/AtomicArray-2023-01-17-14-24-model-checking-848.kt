...
class AtomicArray<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        if (!doubleCompareSingleSwap(descriptor.indexA, descriptor.expectedA, descriptor.updateA, descriptor.indexB, descriptor.expectedB))
            return false
    ...
    private fun doubleCompareSingleSwap(indexA: Int, expectedA: E, updateA: E,
