...
class AtomicArray<E : Any>(size: Int, initialValue: E) {
        ...
        val updateB: E) : Descriptor
    {
        ...
        override fun complete() {
            ...
            if (b is AtomicArray<*>.DcssDescriptor && b != this) {
                println("A: $indexA; B: $indexB; DCSS: A${b.indexA}, B: ${b.indexB}, eA: ${b.expectedA}, eB: ${b.expectedB}, uA: ${b.updateA}, o: ${b.outcome.value}")
                b.complete()
                error("A: $indexA; B: $indexB; DCSS: A${b.indexA}, B: ${b.indexB}, eA: ${b.expectedA}, eB: ${b.expectedB}, uA: ${b.updateA}, o: ${b.outcome.value}")
            }
