...
class AtomicArray<E : Any>(size: Int, initialValue: E) {
    ...
    class DCSSDescriptor<E : Any>(
        val index1: Int, val expect1: Any, val update1: Any, val array: AtomicArray<E>,
        val b: Ref<Int>, val expect2: Any) : Descriptor() {
        override fun complete() : Boolean{
            val update = if (b.value == expect2) update1 else expect1
            array.cas(index1, this, update)
    ...
    class CAS2Descriptor<E : Any>(
        ...
        override fun complete(): Boolean {
            ...
            array.cas(index2, this, if (outcome.value == 1) update1 else expect1)
