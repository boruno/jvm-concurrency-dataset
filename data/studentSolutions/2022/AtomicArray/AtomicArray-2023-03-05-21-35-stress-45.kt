...
class AtomicArray<E>(size: Int, initialValue: E) {
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        if (ind1 == ind2) {
            return exp1 == exp2 && upd1 == upd2 && cas(ind1, exp1, upd1)
        }
        ...
        while (casnDescriptor.outcome.value == Outcome.UNDEFINED) {
            // переход между 2 -> 4 / 8
...
class CASNDescriptor(
    ...
    override fun complete() {
        ...
        // переход между 2 -> 3
        val rdcssDescriptorMod = RDCSSDescriptorMod(b, expectB, this, outcome as Ref<Any>, Outcome.UNDEFINED)
        if (b.compareAndSet(expectB, rdcssDescriptorMod)) {
            ...
            if (rdcssDescriptorMod.outcome.value == Outcome.FAIL) {
                // 2 -> 8
                outcome.compareAndSet(Outcome.UNDEFINED, Outcome.FAIL)
                // 8 -> 9
                a.v.compareAndSet(this, expectA)
