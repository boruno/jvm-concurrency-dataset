...
class AtomicArray<E>(size: Int, initialValue: E) {
    private class CAS2Descriptor<A, B>(
        ...
        override fun complete() {
//            val updateOutcome = if (b.v.value == this || b.cas(expectB, this)) { SUCCESS } else { FAIL } // Or DCSS instead of CAS
    ...
    fun cas2(index1: Int, expected1: E, update1: E,
        ...
        if (index1 == index2) {
            ...
            return cas(index1, expected1, (update1 as Int + update2 as Int) as E)
        }
        val index11: Int
        val index22: Int
        val expected11: E
