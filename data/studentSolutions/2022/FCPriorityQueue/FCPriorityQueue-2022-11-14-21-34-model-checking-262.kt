...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    private fun performPendingOps() {
        for (i in PENDING_ARRAY_SIZE - 1 downTo 0) {
            ...
            {
                if (pendingOperations[i].value != null && !pendingOperations[i].value!!.isDone.value) {
                    ...
                    if (pendingOperations[i].value != null && pendingOperations[i].value!!.action == Operation.DEQUEUE) {
                        val result = q.poll()
