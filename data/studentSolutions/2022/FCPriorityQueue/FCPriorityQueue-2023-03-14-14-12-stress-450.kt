...
class FCPriorityQueue<E : Comparable<E>> {
    ...
    private fun commitOperation(operation: () -> Any?): E? {
    ...
    private fun placeOperation(operation: () -> Any?): Int {
        while (true) {
            if (lock.lock()) {
                return -1
            }
    ...
    private fun combinerOperation(operation: () -> Any?): E? {
        return operation() as E?
    }
//        when (operation) {
