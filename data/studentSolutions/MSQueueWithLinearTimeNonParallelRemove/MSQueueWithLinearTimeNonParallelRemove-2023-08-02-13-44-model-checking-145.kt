    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (curTail.next.compareAndSet(null, newNode)) {
                if (tail.compareAndSet(curTail, newNode) && curTail.extractedOrRemoved)
                    curTail.remove()
                return
            } else {
                if (tail.compareAndSet(curTail, curTail.next.value!!) && curTail.extractedOrRemoved) curTail.remove()
            }
        }
    }
...
//            if (node == this) {
//                head.compareAndSet(node, node.next.value!!)
//            }
