        ...
        fun remove(): Boolean {
            ...
            if (markExtractedOrRemoved()) {
                ...
                while (nextNode != null) {
                    ...
                    val nextToStore = nextNode.next.value

                    currentNode = nextNode
                    nextNode = nextToStore
                }

                currentNode.next.value = this.next.value
                return true

//                return currentNode.next.compareAndSet(nextNode, this.next.value)
            }
