...
class MSQueueWithLinearTimeNonParallelRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (currentTailValue.next.compareAndSet(null, next)) {
                ...
                if (currentTailValue.extractedOrRemoved && head.value == currentTailValue) {
                    val prev = findPrevNode(currentTailValue.element!!)
                    prev.next.compareAndSet(currentTailValue, next)
                }
                return
            } else {
    ...
    private fun findPrevNode(element: E): Node {
        ...
        while (true) {
            ...
            if (nextNode == null) {
                error("found null before element")
            }
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (markExtractedOrRemoved()) {
                ...
                if (head.value != this && tail.value != this) {
                    prev.next.compareAndSet(this, thisNodeNext)
                }
                return true
            }
            return false
