...
class MSQueueWithLinearTimeNonParallelRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        ...
        while(true) {
            ...
            val curHeadAfterNext = curHeadNext.next.get()

            //if (curHeadNext.physicallyRemoved) continue

            if (curHead.next.compareAndSet(curHeadNext, curHeadAfterNext)) {
    ...
    private inner class Node(
        ...
        private val _physicallyRemoved = AtomicBoolean(false)
        val physicallyRemoved get() = _physicallyRemoved.get()
        ...
        fun remove(): Boolean {
            ...
            if (_physicallyRemoved.compareAndSet(false, true)) {
                val curPrev = previous() ?: return result
                val curNext = next.get() ?: return result
