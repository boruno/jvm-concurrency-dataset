...
class MSQueueWithLinearTimeNonParallelRemove<E> : QueueWithRemove<E> {
            ...
            if (tailNext.compareAndSet(null, node)) {
                ...
                if (currentTail.extractedOrRemoved) {
                    ...
                    while (true) {
                        ...
                        if (node.next.compareAndSet(currentTail, currentTail.next.get())) {
                            node.next.compareAndSet(currentTail.next.get(), null)
                            break
                        }
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (!headNext.markExtractedOrRemoved()) continue
