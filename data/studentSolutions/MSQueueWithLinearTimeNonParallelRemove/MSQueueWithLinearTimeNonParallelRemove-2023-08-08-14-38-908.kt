    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            return if (extractedOrRemoved) {
                var headNextNode: Node? = head.get().next.get()
                while (headNextNode != null && headNextNode != this) {
                    headNextNode = headNextNode.next.get()
                }

                headNextNode?.next?.compareAndSet(this, next.get()) ?: false
            } else {
