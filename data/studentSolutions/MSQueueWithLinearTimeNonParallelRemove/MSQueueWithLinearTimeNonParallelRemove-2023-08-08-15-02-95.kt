...
//                if (prev != null) {
//                    if (prev.next.compareAndSet(prev.next.get(), newTail)) {
...
//            }
        ...
        if (curTail?.extractedOrRemoved == true) {
            curTail.removeUnconditionally()
        }
    }
    ...
    private inner class Node(
        ...
        fun removeUnconditionally(): Boolean {
            val next = next.get()
            if (next == null) {
                return false
            }
            ...
            return prev.next.compareAndSet(this, next)
