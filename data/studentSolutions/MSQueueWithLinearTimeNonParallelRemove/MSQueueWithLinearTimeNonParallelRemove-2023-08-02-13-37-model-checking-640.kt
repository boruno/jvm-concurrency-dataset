        ...
        fun remove(): Boolean {
            ...
            if (markExtractedOrRemoved()) {
                ...
                while (currentNode != null) {
                    ...
                    val currentToStore = currentNode.next.value
                    currentNode = currentToStore
                }

                return previousNode.next.compareAndSet(currentNode, this.next.value)
            }
