...
//    }
    ...
    private fun Node.pRemove(): Boolean {
        var cur = head.value.next.value ?: return false
        while (cur.next.value != this && cur.next.value != tail.value) {
            cur = cur.next.value ?: return true
        }
        cur.next.value = this.next.value
        return true
    }
}
