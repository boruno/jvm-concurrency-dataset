...
//            val curHeadNext = curHead.next.get() ?: return null
            ...
            var curHeadNext: Node? = null
            head.getAndUpdate { curHead ->
                curHead.next.get().let {
                    if (it == null) curHead else {
                        curHeadNext = it
                        it
                    }
                }
            ...
            val nextHead = curHeadNext
            if (nextHead == null) {
                return null
            } else {
                if (nextHead.markExtractedOrRemoved()) return nextHead.element
            }
