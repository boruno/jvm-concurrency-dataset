...
class MSQueueWithLinearTimeNonParallelRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (curTail.extractedOrRemoved) {
                val beforeTail = curTail.findPrevious()
                if (beforeTail != null) {
                    if (beforeTail.next.compareAndSet(curTail, node)) {
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            if (previous != null && this.next.get() != null) {
                previous.next.compareAndSet(this, this.next.get())
            }
