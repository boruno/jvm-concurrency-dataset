...
class MSQueueWithLinearTimeNonParallelRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (curTail.extractedOrRemoved) {
                val prevTail = curTail.previousNode() ?: continue
                prevTail.next.compareAndSet(curTail, null)
                curTail = prevTail
            }
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            while (true) {
                val prevNode = previousNode() ?: continue
                val nextNode = next.value
                if (prevNode.next.compareAndSet(this, nextNode)) return true
            }
        }
