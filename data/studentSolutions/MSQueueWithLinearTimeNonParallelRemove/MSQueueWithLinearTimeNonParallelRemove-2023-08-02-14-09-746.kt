...
class MSQueueWithLinearTimeNonParallelRemove<E> : QueueWithRemove<E> {
    ...
    private inner class Node(
        ...
        fun remove(): Boolean {
            ...
            val previousNode: Node = findPreviousNode() ?: return removed

            previousNode.next.value = this.next.value

            return removed
        }

        private fun findPreviousNode(): Node? {
            var previousNode: Node = head.value

            while (previousNode.next.value != this || previousNode.next.value == null) {
                previousNode = previousNode.next.value!!
            }
