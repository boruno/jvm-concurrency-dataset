...
class TreiberStack<E> {
    ...
    fun push(x: E) {
        ...
        while (timeout < TIMEOUT && !record.type.compareAndSet(EliminationRecordType.Done, EliminationRecordType.DoneApproved)) {
            timeout++
        }
    ...
    fun pop(): E? {
        ...
        while (timeout < TIMEOUT && (currElim == null || !currElim.type.compareAndSet(EliminationRecordType.Push, EliminationRecordType.Done))) {
            timeout++
            i = rndElimination()
