...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            val node = Node(element, prev = currentTail)
...
//                val newHead = head.get()
//                val newHeadPrev = newHead.prev.get()
//                newHead.prev.compareAndSet(newHeadPrev, null)
    ...
    private class Node<E>(
        ...
        fun physicalRemove() {
            val currentNext = next.get() ?: return
            val currentPrev = prev.get() ?: return
            currentPrev.next.set(currentNext)
            currentNext.prev.setIfNotNull(currentPrev)
            if (currentPrev.extractedOrRemoved) currentPrev.physicalRemove()
            if (currentNext.extractedOrRemoved) currentNext.physicalRemove()
        }
