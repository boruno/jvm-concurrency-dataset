    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            if (prevNode != null && nextNode != null) {
                ...
                if (nextNode.extractedOrRemoved) prevNode.remove()
            }
...
//            var nextNode: Node<E>
//            do {
//                prevNode = prev.value ?: return wasLogicallyRemoved
//                nextNode = next.value ?: return wasLogicallyRemoved
//            } while (prev.value != prevNode || next.value != nextNode)
//            // TODO comment
//            (prev.value ?: return wasLogicallyRemoved).next.compareAndSet(this, nextNode)
//            (next.value ?: return wasLogicallyRemoved).prev.compareAndSet(this, prevNode)
//            // TODO comment
//            if (prevNode.extractedOrRemoved) prevNode.remove()
