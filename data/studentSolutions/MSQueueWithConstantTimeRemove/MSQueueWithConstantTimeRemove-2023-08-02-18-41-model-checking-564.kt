...
//        TODO("Implement me!")
        while (true) {
            ...
            val el = Node<E>(element, curTail)
            if (curTail.next.compareAndSet(null, el)) {
                tail.compareAndSet(curTail, el)
...
//        TODO("Implement me!")
        while (true) {
            ...
            // curHeadNext.prev.value = curHead.prev.value
            curHeadNext.prev.compareAndSet(curHead, curHead.prev.value)
            // if (curHeadNext.prev.compareAndSet(curHead, curHead.prev.value)) {
