...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            if (head.compareAndSet(curHead, chNext)) {
                chNext.prev.value = null
                if (chNext.remove()) {
                    return chNext.element
                }
            }
        }
    }
...
//        }
    ...
    private class Node<E>(
        ...
        fun removePhysically() {
            ...
            if (curPrev != null) curPrev.next.value = curNext
            if (curNext != null) {
                val p = if (curPrev != null) curPrev else {
                    this
                }
                curNext.prev.value = p
            }

            if (curNext != null && curPrev != null && curPrev.prev.value == null) {
                curPrev.next.value = null
                curPrev.prev.value = null
//                if (curNext != null) curNext.prev.value = this
            }

            if (curNext != null && curNext.extractedOrRemoved) curNext.removePhysically()
            if (curPrev != null && curPrev.extractedOrRemoved) curPrev.removePhysically()
        }
    }
}