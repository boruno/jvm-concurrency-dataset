...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        while (true) {
            ...
            val newElement = Node(element = element, prev = curTail)

            if (!curTail.extractedOrRemoved) {
                if (tail.compareAndSet(curTail, newElement)) {
                    return
                }
            }
            else {
...
//        TODO("Implement me!")
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            val curNextHead = curNode.next.value ?: return null
            if (head.compareAndSet(curNode, curNextHead) && curNextHead.markExtractedOrRemoved()) {
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            val prevValue = this.prev.value
            if (prevValue != null) {
                prevValue.next.value = this.next.value
            }
            return res
