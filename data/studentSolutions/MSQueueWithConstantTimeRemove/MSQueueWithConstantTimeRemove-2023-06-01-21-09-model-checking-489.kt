...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (head.compareAndSet(curHeadValue, curHeadNextValue) && curHeadNextValue.markExtractedOrRemoved())
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            // TODO: the algorithm.
            return markExtractedOrRemoved().also { if (it) physicalRemove() }
        }
        fun physicalRemove() {
            // TODO: In the second phase, the node should be removed
            // TODO: physically, updating the `next` field of the previous
            ...
            prevNode?.let {
                it.next.compareAndSet(this, nextNode)
                if (it.extractedOrRemoved) it.physicalRemove()
            }
            nextNode?.let {
                it.prev.compareAndSet(this, prevNode)
                if (it.extractedOrRemoved) it.physicalRemove()
            }
        }
    }
