...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            var wasNext: Node<E>
            while (true) {
                wasPrev = prev.value ?: return murderer
                wasNext = next.value ?: return murderer
                if (wasPrev.next.compareAndSet(this, wasNext)
                    || wasPrev.next.value == wasNext) {
                    if (wasNext.prev.compareAndSet(this, wasPrev)
                        || wasNext.next.value == wasPrev) {
                        break
                    }
                }
            }
