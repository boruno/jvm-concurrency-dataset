...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun physicalRemove() {
            ...
            curNext.prev.setIfNotNull(curPrev) //curNext.prev

            if (curPrev.extractedOrRemoved) curPrev.physicalRemove()
            if (curNext.extractedOrRemoved) curNext.physicalRemove()
        }

//        private fun findPrev(): MSQueueWithLinearTimeRemove.Node? {
//            var curHead = head.get()
//            while (true) {
//                if (curHead.next.get() == this) {
//                    return curHead
//                }
//                curHead = curHead.next.get() ?: return null
//            }
//        }
    }
}

private fun <V> AtomicReference<V>.setIfNotNull(curPrev: V) {
    while (true) {
        val curNextPrev = get()
