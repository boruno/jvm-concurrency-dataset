...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        val prev = AtomicReference<Node<E>?>(prev)
        ...
        fun doPhysicalRemove() {
            val currentPrevious = prev.get() ?: return
            val currentNext = next.get() ?: return

            currentPrevious.next.set(currentNext)
            currentNext.prev.setIfNotNull(currentPrevious)

            if (currentPrevious.extractedOrRemoved) doPhysicalRemove()
            if (currentNext.extractedOrRemoved) doPhysicalRemove()
        }
