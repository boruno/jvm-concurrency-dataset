...
//            }
//
//            if (myPrev.extractedOrRemoved) {
//                myPrev.removePhysically()
//            }

            if (myPrev.next.compareAndSet(this, myNext)) {
                next.set(null)
                myNext.prev.compareAndSet(this, myPrev)
                if (myPrev.extractedOrRemoved) {
                    myPrev.removePhysically()
                }
...
//            if (prev.compareAndSet(myPrev, null)) {
//                if (myPrev.next.compareAndSet(this, myNext)) {
...
//            if (next.compareAndSet(myNext, newNextPointingToUs)) {
//            }

//            val newNextPointingToUs = Node(myNext.element, this)
//            if (next.compareAndSet(myNext, newNextPointingToUs)) {
//                if (myPrev.next.compareAndSet(this, myNext)) {
//                    if (myNext.prev.compareAndSet(this, myPrev)) {
//                        if (myNext.extractedOrRemoved) {
