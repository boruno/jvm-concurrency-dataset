...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun removePhysically() {
            ...
            val curNextOfPrev = curPrev.next.value
            val curPrevOfNext = curNext.prev.value

            if (curNextOfPrev != null) {
                curPrev.next.compareAndSet(curNextOfPrev, curNext)
            }
            if (curPrevOfNext != null) {
                curNext.prev.compareAndSet(curPrevOfNext, curPrev)
            }
