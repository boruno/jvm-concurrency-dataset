        ...
        while (true) {
            ...
            if (head.compareAndSet(curHead, curHeadNext)) {
                ...
                if (curHeadNext.markExtractedOrRemoved()) {
                    ...
                    val curHeadNextNext = curHeadNext.next.value ?: continue
                    val curHeadNextNextPrev = curHeadNextNext.prev.value
                    if (curHeadNextNextPrev != null) {
                        curHeadNextNext.prev.compareAndSet(curHeadNextNextPrev, curHeadNext)
                    }
                }
            }
        }
