...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
        ...
        while (true) {
            ...
            if (curTail.next.compareAndSet(null, node)) {
                if (tail.compareAndSet(curTail, node)) {
                    if (curTail.extractedOrRemoved && curTail != head.value) curTail.removeFromMemory()
                }
                return
            } else {
    ...
    private class Node<E>(
        ...
        fun removeFromMemory() {
            ...
            if (prevNode.extractedOrRemoved) prevNode.removeFromMemory()
            if (nextNode != null && nextNode.extractedOrRemoved) nextNode.removeFromMemory()
        }
