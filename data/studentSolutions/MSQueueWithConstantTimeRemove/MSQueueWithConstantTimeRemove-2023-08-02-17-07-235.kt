...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            if (newHead.prev.compareAndSet(currentHead, null) && head.compareAndSet(currentHead, newHead) && newHead.markExtractedOrRemoved()) {
    ...
    class Node<E>(
        ...
        fun replace(curNext: Node<E>? = next.value): Boolean {
            val curPrev = prev.value
            if (curPrev == null || curNext == null)
                return false
            return curPrev.next.compareAndSet(this, curNext)
