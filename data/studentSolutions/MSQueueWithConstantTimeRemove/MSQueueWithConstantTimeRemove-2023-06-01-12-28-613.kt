...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            val updatedTail = if (success) newTail else curTail.next.value!! /* may fire, IDK */
            tail.compareAndSet(curTail, updatedTail)
    ...
    override fun checkNoRemovedElements() {
        ...
        check(tail.value.next.value == null) {
            "tail.next must be null, state: $this"
        }
    ...
    override fun toString(): String {
        ...
        return buildString {
            while (true) {
                ...
                append("<@${Integer.toHexString(System.identityHashCode(node))} ${node.element}")
