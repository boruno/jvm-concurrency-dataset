    ...
    private class Node<E>(
        ...
        fun removePhysically() {
            while (true) {
                ...
                var prevPrev = prev.prev.value
                while (prevPrev != null && prevPrev.extractedOrRemoved) {
                    prev = prevPrev
                    prevPrev = prev.prev.value
                }
                if (prevPrev == null) prevPrev = prev!!

                var nextNext = next.next.value
                while (nextNext != null && nextNext.extractedOrRemoved) {
                    next = nextNext
                    nextNext = next.next.value
                }
                if (nextNext == null) nextNext = next!!

                prevPrev.next.value = nextNext
                nextNext.prev.value = prevPrev
