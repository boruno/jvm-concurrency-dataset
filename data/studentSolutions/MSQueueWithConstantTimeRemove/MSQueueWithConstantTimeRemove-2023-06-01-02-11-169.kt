...
class MichaelScottQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            val prevNodeInit = prev.value
            if (prevNodeInit?.extractedOrRemoved == true) prevNodeInit.remove()
            val nextNodeInit = next.value
            if (nextNodeInit?.extractedOrRemoved == true) nextNodeInit.remove()
