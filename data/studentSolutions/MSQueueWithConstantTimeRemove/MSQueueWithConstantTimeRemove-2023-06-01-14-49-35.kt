...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (head.compareAndSet(oldHead, newHead) && newHead.prev.compareAndSet(oldHead, null) && newHead.markExtractedOrRemoved()) {
                return newHead.element
            }
            println("newHead.prev should be $oldHead, change to ${null}, but it's ${newHead.prev.value}")
        }
    }
