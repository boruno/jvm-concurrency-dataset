...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        val curTailMarked = curTail.extractedOrRemoved
        if (curTail.next.compareAndSet(null,newNode)) {
            tail.compareAndSet(curTail, newNode)
            if (curTailMarked) curTail.remove()
        } else {
    ...
    override fun dequeue(): E? {
        ...
        else if (head.compareAndSet(curHead, curHeadNext) && curHeadNext.prev.compareAndSet(curHead, null) && curHeadNext.markExtractedOrRemoved()) {
            curHeadNext.element
        }
        else dequeue()
    }
