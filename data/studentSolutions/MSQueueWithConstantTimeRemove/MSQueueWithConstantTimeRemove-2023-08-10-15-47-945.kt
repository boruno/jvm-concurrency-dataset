    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (curTail.next.compareAndSet(null, newNode)) {
                ...
                if (curTail.extractedOrRemoved) curTail.physicallyRemove()
                return
            } else {
                // helping the other thread
...
//            return removed
        ...
        fun physicallyRemove() {
            ...
            curPrev.next.setIfNotNull(curNext)
            curNext.prev.setIfNotNull(curPrev)

            if (curPrev.extractedOrRemoved) curPrev.physicallyRemove()
            if (curNext.extractedOrRemoved) curNext.physicallyRemove()
        }
