...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private inner class Node(
        ...
        fun physicallyRemove() {
            ...
            if (next != null && previous != null && previous.accessedFromHead()) {
                next.prev.compareAndSet(this, previous)
            }
//            moveHead()
//            moveTail()
//            if (previous != null && previous.extractedOrRemoved) previous.physicallyRemove()
//            if (next != null && next.extractedOrRemoved) next.physicallyRemove()
        }
        fun accessedFromHead(): Boolean {
            var node = head.value
            while (true) {
                val next = node.next.value ?: return false
