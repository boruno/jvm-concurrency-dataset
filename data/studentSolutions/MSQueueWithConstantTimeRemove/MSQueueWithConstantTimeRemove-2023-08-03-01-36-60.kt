...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun removePhysically() {
            var next = next.value ?: return
            var prevNode = prev.value ?: return
            while (true) {
                if (!prevNode.next.compareAndSet(this, next)) {
            ...
            while (true) {
                if (!next.prev.compareAndSet(this, prevNode)) {
                    prevNode = prevNode.prev.value ?: prevNode
                } else {
                    break
                }
            }
