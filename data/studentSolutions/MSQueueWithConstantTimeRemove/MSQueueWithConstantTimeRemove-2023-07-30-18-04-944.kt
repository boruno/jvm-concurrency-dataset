    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (currentTail.next.compareAndSet(null, node)) {
                if (tail.compareAndSet(currentTail, node) && currentTail.extractedOrRemoved && currentTail != head.value) {
                    currentTail.deleteNode()
                }
                return
            } else {
        ...
        fun deleteNode() {
            ...
            if (nextNode != null) {
                while (true) {
                    ...
                    if (nextNode.prev.compareAndSet(curNextNode, previousNode)) break
                }
            }
