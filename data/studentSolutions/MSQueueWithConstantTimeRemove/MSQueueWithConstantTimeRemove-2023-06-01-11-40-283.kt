...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private inner class Node(
        ...
        private val _removedPhysically = atomic(false)
        val removedPhysically get() = _removedPhysically.value
        ...
        fun removePhysically() {
            ...
            if (!curPrev.removedPhysically) {
                curNext.prev.value = curPrev
            }
            _removedPhysically.compareAndSet(false, true)
