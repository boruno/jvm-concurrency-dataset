...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
        ...
        while (true) {
            ...
            if (head.compareAndSet(curHead, curHeadNext)) {
                if (curHeadNext.markExtractedOrRemoved()) {
                    val nextValue = curHeadNext.next.value
                    if (nextValue != null) {
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            if (currNext == null) return removed

            val previousNode = prev.value ?: return removed
//            if (previousNode.prev.value == null) return removed

            previousNode.next.value = currNext
            currNext.prev.value = previousNode
