...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            if (head.compareAndSet(curHead, next) && next.markExtractedOrRemoved()) {
                curHead.next.compareAndSet(next, null)
    ...
    private class Node<E>(
        ...
        fun removePhysically() {
            ...
            if(curPrev != null) curPrev.next.compareAndSet(this, curNext)
            if (curPrev?.extractedOrRemoved == true) curPrev.removePhysically()
