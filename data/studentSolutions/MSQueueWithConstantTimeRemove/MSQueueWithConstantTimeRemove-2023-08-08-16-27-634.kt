    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            while (true) {
                ...
                when {
                    nextNode.extractedOrRemoved && nextNode.next.get() != null -> continue
                    !nextNode.prev.compareAndSet(this, prevNode) -> continue
                    prevNode.extractedOrRemoved && prevNode.prev.get() != null -> continue
                    !prevNode.next.compareAndSet(this, nextNode) -> continue
                    else -> return removed
                }
            }
        }
