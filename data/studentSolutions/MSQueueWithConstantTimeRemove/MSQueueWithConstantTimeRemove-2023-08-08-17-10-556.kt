...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        // all like in single-linked queue
        while (true) {
    ...
    private inner class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            return markExtractedOrRemoved().also {
                val curPrev = prev.get() ?: return@also
                val curNext = next.get() ?: return@also
                curPrev.next.set(curNext)
                curNext.prev.set(curPrev)
                if (curPrev.markExtractedOrRemoved()) {
                    curPrev.remove()
                }
