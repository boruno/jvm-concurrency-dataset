    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            if (!(this.prev.value == null || this.next.value == null)) {
                ...
                if (next.value!!.prev.value != null) next.value!!.prev.compareAndSet(this, prev.value!!)
                if (prev.value?.extractedOrRemoved==true) prev.value!!.remove()
                if (myNext?.extractedOrRemoved == true) myNext.remove()
                next.value = null
                prev.value = null
            }
            return result
