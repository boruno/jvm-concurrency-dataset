...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    override fun enqueue(element: E) {
        ...
        val node = Node(element, prev = null)
        while (true) {
...
//            }
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            if (next == null || prev == null) return res

//            this.prev.compareAndSet(prev, null)
//            this.next.compareAndSet(next, null)

            if (prev.next.compareAndSet(this, next) or next.prev.compareAndSet(this, prev)) {
...
//                if (next == null || prev == null) return res
//
//                if (this.prev.compareAndSet(prev, null) && this.next.compareAndSet(next, null)) {
//                    if (prev.next.compareAndSet(this, next) or next.prev.compareAndSet(this, prev)) {
//                        if (prev.extractedOrRemoved) prev.remove()
//                        if (next.extractedOrRemoved) next.remove()
//                    }
...
//                }
//
//                this.prev.compareAndSet(null, prev)
//                this.next.compareAndSet(null, next)
//            }
