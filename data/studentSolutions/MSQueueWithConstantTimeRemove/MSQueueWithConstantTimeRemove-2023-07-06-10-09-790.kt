...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            val myNext = next.value?:return result
            val prev = this.prev.value?:return result
//            if (prev !=null&& myNext != null) {
            myNext.prev.compareAndSet(this, prev)
            prev.next.compareAndSet(this, myNext)
            if (prev.extractedOrRemoved) prev.remove()
            if (myNext.extractedOrRemoved) myNext.remove()
//            }
            return result
        }
    }
