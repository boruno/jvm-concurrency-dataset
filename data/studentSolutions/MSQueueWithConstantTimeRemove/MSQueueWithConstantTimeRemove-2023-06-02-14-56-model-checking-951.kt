...
class MSQueueWithConstantTimeRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun physicallyRemove() : Boolean {
            var newNext = this.next.value ?: return false
            var curHead = this.prev.value ?: return false
            while (true) {
                if (!curHead.next.compareAndSet(this, newNext)) {
                    newNext = this.next.value ?: return false
                    curHead = this.prev.value ?: return false
                    continue
                } else break
            }
