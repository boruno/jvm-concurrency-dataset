    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            if (curTail.next.compareAndSet(null, node)) {
                ...
                val value = curTail.next.value?:continue
                tail.compareAndSet(curTail, value)
            }
        }
    }
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            ...
            if (curHeadNext.markExtractedOrRemoved()) {
                if (curHeadNext.extractedOrRemoved) curHeadNext.remove()
...
//            if ( this.prev.value != null && this.next.value!=null) {
            val p = prev.value
            val n = next.value
            if (p!=null) p.next.value=null
            if (n != null) n.prev.value = null
            if (p != null) p.next.compareAndSet(null, n)
            if (n != null) n.prev.compareAndSet(null, p)
            if (p != null) if (p.extractedOrRemoved) p.remove()
            if (n != null) if (n.extractedOrRemoved) n.remove()
//            }
            return result
        }
    }
