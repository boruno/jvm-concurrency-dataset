    ...
    override fun dequeue(): E? {
        while (true) {
            ...
            if (head.compareAndSet(currentHead, nextHead)) {
                ...
                nextHead.prev.compareAndSet(currentHead, null)
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            while (true) {
                ...
                if (this.prev.get() == previousNode) { // check if tail or not
                    if (previousNode.element == null) {
                        // so previous node is dummy
                        nextNode.prev.compareAndSet(this, null)
                    } else {
