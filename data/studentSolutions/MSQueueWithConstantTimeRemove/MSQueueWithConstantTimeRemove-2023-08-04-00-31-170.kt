    ...
    override fun enqueue(element: E) {
        while (true) {
            ...
            if (curTail.next.compareAndSet(null, node)) {
                ...
                tail.value.prev.compareAndSet(null, curTail)
    ...
    private class Node<E>(
        ...
        fun remove(): Boolean {
            ...
            if (removed) {
                ...
                //tail
                if (next.value == null ||prev.value == null) return true
                val curNext = next.value
                val curPrev = prev.value
                prev.value!!.next.compareAndSet(this, curNext)
                //next.value!!.prev.compareAndSet(this, curPrev)
                return true
            }
            return false
        }
