        ...
        private fun installDescriptor(): Boolean {
         ...
         private fun getExpectedValue(): E {
             while (true) {
                 ...
                 when {
                     currentState is AtomicArrayWithDCSS<*>.DCSSDescriptor -> {
                         if (currentState.index2 == index2) return currentState.expected2 as E
                         if (currentState.status.value === Status.SUCCESS) {
                             return currentState.update1 as E
                         } else {
                             return currentState.expected1 as E
                         }
                     }
                     else -> {
