...
class AtomicArrayWithDCSS<E : Any>(size: Int, initialValue: E) {
    ...
    fun get(index: Int): E? {
        ...
        if (value is AtomicArrayWithDCSS<*>.DCSSDescriptor) {
            when (value.status2.value) {
                day3.AtomicArrayWithDCSS.Status.UNDECIDED -> value.expected1
                day3.AtomicArrayWithDCSS.Status.SUCCESS -> value.update1
                day3.AtomicArrayWithDCSS.Status.FAILED -> value.expected1
            }
        }
