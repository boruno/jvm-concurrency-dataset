...
//        return array[index].value as E?
    ...
    fun cas(index: Int, expected: E?, update: E?): Boolean {
        ...
        while (true) {
            when (curValue) {
                is AtomicArrayWithDCSS<*>.DCSSDescriptor -> continue
    ...
    fun dcss(
        ...
        val description = DCSSDescriptor(index = index1, expected = expected1, update = update1)
        description.apply()
        return true
    }
    ...
    inner class DCSSDescriptor(
        ...
        fun value(): E? = if (status.value == Status.SUCCESS) update else expected
