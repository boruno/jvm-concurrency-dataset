...
class AtomicArrayWithDCSS<E : Any>(size: Int, initialValue: E) {
    ...
    fun dcss(
        ...
        var current1 = array[index1].value
        var current2 = array[index2].value

        if (current1 == expected1 && current2 == expected2) {
            return array[index1].compareAndSet(expected1, update1) && array[index2].compareAndSet(expected2, expected2)
        }
        return false
    }
