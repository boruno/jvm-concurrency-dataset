...
class AtomicArrayWithDCSS<E : Any>(size: Int, initialValue: E) {
    ...
    private inner class DCSSDescriptor(
        ...
        private val cell2 = array[index2]
        ...
        fun proceed() {
            while (true) {
                ...
                val cell2Descriptor = cell2.descriptorRef.value
                val existing2 = if (cell2Descriptor != null) {
                    if (cell2Descriptor.statusRef.value == Status.SUCCESS)
                        cell2Descriptor.update1
                    else {
                        cell2Descriptor.proceed()
                        continue
                    }
                } else
                    cell2.valueRef.value
