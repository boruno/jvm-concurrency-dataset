...
class AtomicCounterArray(size: Int) {
    ...
    fun inc2(index1: Int, index2: Int) {
        ...
        while (true) {
            ...
            val condition = index1 < index2
            val descriptor = if (condition) IncrementDescriptor(index1, val1 as Int, index2, val2 as Int) else
                IncrementDescriptor(index2, val2 as Int, index1, val1 as Int)
