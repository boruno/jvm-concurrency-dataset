...
class AtomicCounterArray(size: Int) {
    ...
    fun inc2(index1: Int, index2: Int) {
        ...
        while (true) {
            ...
            if (firstValue is IncrementDescriptor) {
                ...
                val minValue = if (index1 < index2) firstValue else secondValue
                if (array[minInd].compareAndSet(minValue, descriptor)) {
    ...
    private inner class IncrementDescriptor(
        ...
        fun applyOperation() {
            ...
            if (status.value == FAILED) throw Exception("failed")
