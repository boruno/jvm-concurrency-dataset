...
class AtomicCounterArray(size: Int) {
    ...
    private inner class IncrementDescriptor(
        ...
        private fun applyIndex(index: Int, before: Int): Boolean {
            ...
            } while (status.value == UNDECIDED && !array[index].compareAndSet(before, this))
            return true
        }
