...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun install(): Boolean {
            return worklist.all { (idx, exp, upd) -> installOne(idx, exp, upd) }
        }

        private fun installOne(idx: Int, exp: E?, upd: E?): Boolean {
            while (true) {
                when (status.get()) {
                    SUCCESS -> return true
                    FAILED -> return false
                ...
                when (val cur = array.get(idx)) {
                    ...
                    exp ->
                        ...
                        // But don't bother with nop-cas.
                        if (exp == upd || array.compareAndSet(idx, exp, this)) {
                            return true
                        }
