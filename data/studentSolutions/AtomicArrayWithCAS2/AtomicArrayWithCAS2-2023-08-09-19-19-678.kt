...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun installTo(index: Int, expected: Any): Boolean {
            while (true) {
                ...
                else if (v is AtomicArrayWithCAS2<*>.CAS2Descriptor) {
    ...
    inner class DCSS(
        ...
        val expected: Any?,
        val update: Any?,
        val statusSource: AtomicReference<Status>,
        val dcssStatus: AtomicReference<Status>,
    ) {
        fun finish() {
            dcssStatus.compareAndSet(statusSource.get(), SUCCESS)
    ...
    fun dcss(
        ...
        val descriptor = DCSS(index, expectedCellState, updateCellState, statusReference, AtomicReference(expectedStatus))
        if (!array.compareAndSet(index, expectedCellState, descriptor)) {
            return false
        }
        descriptor.finish()
