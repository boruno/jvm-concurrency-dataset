...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        val descriptor = DCSSDescriptor(index2, expected2, this)
    ...
    inner class DCSSDescriptor(
        ...
        fun apply() {
            ...
            if (status.value == UNDECIDED) {
                val success = update1.status.value === UNDECIDED
                val statusValue = if (success) SUCCESS else FAILED
                status.compareAndSet(UNDECIDED, statusValue)
            }
        ...
        fun getValue(): Any {
            if (status.value === SUCCESS) return update1
            return expected1
        }
    }
