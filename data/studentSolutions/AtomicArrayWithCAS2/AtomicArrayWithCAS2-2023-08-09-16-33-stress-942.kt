...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    private inner class DCSSDescriptor(
        ...
        fun apply() {
            val newValue = if (statusReference.get() == expectedStatus) updateCellState else expectedCellState
    ...
    private fun dcss(
        ...
        return array.compareAndSet(index,  expectedCellState, dcssDescriptor)
    }
}
