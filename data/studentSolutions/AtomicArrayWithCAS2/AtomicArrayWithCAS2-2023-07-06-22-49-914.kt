...
//                        if (array[index].compareAndSet(expected, this)) {
    ...
    fun dcss(index1: Int, expected1: E, cas2: CAS2Descriptor): Boolean {
//        require(index1 != index2) { "The indices should be different" }
        // TODO This implementation is not linearizable!
        // TODO Store a DCSS descriptor in array[index1].
        val descriptor = DCSSDescriptor(index1, expected1, cas2)
    ...
    inner class DCSSDescriptor(
        ...
        fun tryInstallDescriptor(): Boolean {
            return tryInstallDescriptor(index, expected)
        }
