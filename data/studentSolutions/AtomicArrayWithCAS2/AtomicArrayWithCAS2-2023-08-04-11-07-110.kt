...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas(index: Int, expected: E?, update: E?): Boolean {
        ...
        while (!array[index].compareAndSet(expected, update)) {
            ...
            else if (actual is AtomicArrayWithCAS2<*>.CAS2Descriptor) {
    ...
    inner class CAS2Descriptor(
        ...
        fun apply() {
            ...
            val (firstIndex, secondIndex) = if (index1 < index2 || true) index1 to index2 else index2 to index1
            val (firstExpected, secondExpected) = if (index1 < index2 || true) expected1 to expected2 else expected2 to expected1
