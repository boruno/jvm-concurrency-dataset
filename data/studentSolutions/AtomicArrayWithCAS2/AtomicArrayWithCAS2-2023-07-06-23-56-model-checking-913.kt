...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    fun get(index: Int): E? {
        ...
        if (value is AtomicArrayWithCAS2<*>.CAS2Descriptor.DSSDescriptor) {
            ...
            if (status == Status.UNDECIDED || status == Status.FAILED) return getFromCAS2Descriptor(value.expected as AtomicArrayWithCAS2<*>.CAS2Descriptor, index) as? E
            value.apply()
            return getFromCAS2Descriptor(value.update as AtomicArrayWithCAS2<*>.CAS2Descriptor, index) as? E
        }
        return value as? E
    }
