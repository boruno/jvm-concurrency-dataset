        ...
        private fun tryInstallDescriptorDcss(index: Int, expected: E): Boolean {
            while (true) {
                ...
                when {
                    ...
                    curState === expected -> {
                        if (dcss(index, expected, this, this, UNDECIDED)) {
//                        if (array[index].compareAndSet(expected, this)) {
                            return true // successfully installed
                        } else {
                            continue // retry
    ...
    fun dcss(
        ...
        descriptor2: CAS2Descriptor, expected2: Status
    ): Boolean {
//        require(index1 != index2) { "The indices should be different" }
        // TODO This implementation is not linearizable!
        // TODO Store a DCSS descriptor in array[index1].
        val descriptor = DCSSDescriptor(index1, expected1, update1, descriptor2, expected2)
    ...
    inner class DCSSDescriptor(
        ...
        val expected1: E,
        val update1: Any,
        private val descriptor2: CAS2Descriptor,
        ...
        fun apply() {
            ...
            if (status.value == UNDECIDED) {
                val success = descriptor2.status.value === expected2
                val statusValue = if (success) SUCCESS else FAILED
                status.compareAndSet(UNDECIDED, statusValue)
            }
