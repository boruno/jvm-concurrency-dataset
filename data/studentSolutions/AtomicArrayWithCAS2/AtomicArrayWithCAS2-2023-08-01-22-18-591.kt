        ...
        while (true) {
            ...
            when (currentValue) {
                is AtomicArrayWithCAS2<*>.CAS2Descriptor -> {
                    return if (currentValue.status.value == Status.SUCCESS) {
                ...
                is AtomicArrayWithCAS2<*>.DCSSDescriptor<*> -> {
                    ...
                    val resultOfDCSS = if (currentValue.status.value == Status.SUCCESS) currentValue.update1 else currentValue.expected1
                    if (resultOfDCSS is AtomicArrayWithCAS2<*>.CAS2Descriptor) continue
                    return resultOfDCSS as E?
                }
