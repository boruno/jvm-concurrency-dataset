...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    fun get(index: Int): E? {
        ...
        if (status == AtomicArrayWithCAS2Simplified.Status.UNDECIDED || status == AtomicArrayWithCAS2Simplified.Status.FAILED) return if (value.index1 == index) value.expected1 as E else value.expected2 as E
