...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    fun get(index: Int): E {
        return when (val currentValue = array[index]) {
            is AtomicArrayWithCAS2<*>.CAS2Descriptor -> currentValue.get(index) as E
    ...
    fun cas(index: Int, expected: E, update: E): Boolean {
        while (true) {
            ...
            when {
                value == expected -> return array.compareAndSet(index, expected, update)
                value is Descriptor2 -> value.apply()
...
private typealias Descriptor2 = AtomicArrayWithCAS2<*>.CAS2Descriptor
