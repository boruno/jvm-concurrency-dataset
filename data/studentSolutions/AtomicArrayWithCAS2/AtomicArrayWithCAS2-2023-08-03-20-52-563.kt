                    ...
                    UNDECIDED -> {
                        install1@ while (true) {
                            ...
                            if (witness1 === expected1 || witness1 === this) {
                                ...
                                when (val statusWitness = _status.compareAndExchange(UNDECIDED, HALF)) {
                                    UNDECIDED -> {
                                    ...
                                    HALF -> {
                                        // another thread changed status to HALF
                                        status = HALF
                                    }
...
//                                            array.compareAndExchange(index1, this, expected1)
                                        ...
                                        status = statusWitness // complete this CAS
                                    }
                                }
                                continue@status
                    ...
                    HALF -> {
                        install2@ while (true) {
                            ...
                            if (witness2 === expected2 || witness2 === this) {
                                ...
                                val statusWitness = _status.compareAndExchange(HALF, SUCCESS)
                                when (statusWitness) {
                                    UNDECIDED -> error("")
                                    HALF -> {
                                        // this thread changed status
                                    ...
                                    SUCCESS, FAILED -> {
                                        // another thread completed this cas
                                        if (witness2 == expected2) {
                                            // this thread published this cas
                                            // => unpublish this cas
