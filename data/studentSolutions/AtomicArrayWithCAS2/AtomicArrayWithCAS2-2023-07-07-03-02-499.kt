        ...
        inner class DSSDescriptor(val dssIndex: Int, val dssExpected: Any?, val dssUpdate: Any?, val dssExpected2: Status) {
            ...
            fun apply(): Status {
                ...
                while (true) {
                    ...
                    if ((localItem !is AtomicArrayWithCAS2<*>.CAS2Descriptor.DSSDescriptor && localItem !is AtomicArrayWithCAS2<*>.CAS2Descriptor && localItem != dssExpected) ||
                        (localStatus !is AtomicArrayWithCAS2<*>.CAS2Descriptor.DSSDescriptor && localStatus !is AtomicArrayWithCAS2<*>.CAS2Descriptor && localStatus != dssExpected2)
                    ) {
                        dssStatus.value = Status.FAILED
                        return Status.FAILED
                    }

                    val localState = dssStatus.value
                    if (localState != Status.UNDECIDED) {
                        return localState
                    }
