...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    inner class CAS2Descriptor(
        ...
        private fun installInto2(): Boolean {
            val descriptor = DCSSDescriptor(index2, expected2, update2, descriptorToCheckStatus = this, expectedStatus = UNDECIDED)
            descriptor.apply()
            return descriptor.status.value == SUCCESS
        }
    ...
    inner class DCSSDescriptor(
        ...
        private val expected1: E?,
        private val update1: E?,
        private val descriptorToCheckStatus: CAS2Descriptor,
        ...
        private fun install(): Boolean {
            while (true) {
                ...
                val curStatus = descriptorToCheckStatus.status.value
                when {
                    // the descriptor is already installed
                    ...
                    value1 == expected1 && curStatus == expectedStatus -> {
                        if (array[index1].compareAndSet(expected1, this)) {
                            // installed successfully
                            return true
                        }
