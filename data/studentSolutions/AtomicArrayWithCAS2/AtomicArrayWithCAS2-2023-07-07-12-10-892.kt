...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    fun get(index: Int): E {
        ...
        if (value is AtomicArrayWithCAS2<*>.CAS2Descriptor) {
            ...
            if (value.index2 == index && value.status.value != Status.SUCCESS) return value.expected2 as E
            if (value.index2 == index && value.status.value == Status.SUCCESS) return value.update2 as E
        }
        return value as E
    }
