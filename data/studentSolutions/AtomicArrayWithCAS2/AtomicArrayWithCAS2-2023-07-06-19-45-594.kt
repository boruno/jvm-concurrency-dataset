...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    private inner class CAS2Descriptor(
        ...
        override fun apply(): Boolean = help()
    ...
    private inner class DCSSDescriptor(
        ...
        override fun apply(): Boolean = apply(false)

        override fun help(): Boolean = apply(true)

        private fun apply(isHelp: Boolean): Boolean {
        ...
        override fun getValue(index: Int): E {
            return if (status.value === SUCCESS) {
                if (update is AtomicArrayWithCAS2<*>.Descriptor) update.getValue(index) as E
                else update as E
            }
            else expected1
        }
