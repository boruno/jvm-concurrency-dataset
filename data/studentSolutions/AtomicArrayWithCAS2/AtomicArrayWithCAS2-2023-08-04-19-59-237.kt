...
class AtomicArrayWithCAS2<E : Any>(size: Int, initialValue: E) {
    ...
    fun cas2(
        ...
        println("CAS: ${index1} ${expected1} ${update1} ${index2} ${expected2} ${update2}")
    ...
    inner class CAS2Descriptor(
        ...
        private fun installCell(index: Int, expected: E) {
            while (true) {
                ...
                when (cell) {
                    ...
                    expected -> {
                        // todo replace this cas with DCSS
        ...
        override fun toString(): String {
            return "CAS2Descriptor(index1=$index1, expected1=$expected1, update1=$update1, index2=$index2, expected2=$expected2, update2=$update2, status=${status.value})"
        }
...
//            }
        ...
        override fun toString(): String {
            return "DCSSDescriptor(index1=$index1, expected1=$expected1, update1=$update1, cas2Descriptor=$cas2Descriptor, cas2StatusExpected=$cas2StatusExpected, status=${status.value})"
        }
