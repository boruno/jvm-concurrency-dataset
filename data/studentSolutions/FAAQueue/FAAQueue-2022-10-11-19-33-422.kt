...
class FAAQueue<E> {
    ...
    fun enqueue(element: E) {
        while (true) {
            ...
            if (segment.cas((enqIdx.value.toInt() % SEGMENT_SIZE).toInt(),null, element)) {
                return
            }
        }
    }
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            if (segment.index > head.value.index)
            {
            ...
            return segment.get((deqIdx.value.toInt() % SEGMENT_SIZE).toInt()) as E
        }
    }
