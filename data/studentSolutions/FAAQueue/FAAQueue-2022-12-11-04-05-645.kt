...
private class Segment<E> {
    ...
    fun isEmpty(): Boolean {
        ...
        if (oldDeqIdx == oldEnqIdx && oldDeqIdx >= SEGMENT_SIZE || elements[oldEnqIdx].value!!.type != ValueType.VALUE) {
    ...
    private fun canDeq(i: Int) = i < enqIdx.value && elements[i].value!!.type == ValueType.VALUE
