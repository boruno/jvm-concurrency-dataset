...
class FAAQueue<E> {
    ...
    fun enqueue(element: E) {
        while (true) {
            ...
            if (tail.value.id != segment.id) {
                // Trying to replace current tail with new segment
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            // If new or different from current head segment was received
            if (head.value.id != segment.id) {
                // Trying to replace current head with new segment
