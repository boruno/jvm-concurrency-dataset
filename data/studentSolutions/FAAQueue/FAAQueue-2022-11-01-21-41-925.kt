...
class FAAQueue<E> {
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            if (index > currentSegmentBound) {
                val nextSegment = currentHead.next.value ?: return null

                // We should anyway continue: to update currentHead or to try again.
            ...
            return currentHead.get((index % SEGMENT_SIZE).toInt()) as E?
        }
    }
