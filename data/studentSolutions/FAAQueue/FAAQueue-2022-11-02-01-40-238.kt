...
class FAAQueue<E> {
    ...
    fun enqueue(element: E) {
        while (true) {
            ...
            if (!moveTailForward(s, curTail)) continue
    ...
    private fun moveTailForward(s: Segment, curTail:Segment) :Boolean {
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            if (!moveHeadForward(s, curHead)) continue
    ...
    private fun moveHeadForward(s: Segment, curHead:Segment):Boolean {
