...
class FAAQueue<E> {
    ...
    fun enqueue(element: E) {
        while (true) {
            ...
            var curTail = findSegment(tail.value, i, 0) ?: continue
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            var curHead = findSegment(head.value, i, 1) ?: continue
    ...
    private fun findSegment(start: Segment, i: Long, isHead : Int): Segment? {
        if (start.id < (i / SEGMENT_SIZE).toInt()) {
            val next = start.next
