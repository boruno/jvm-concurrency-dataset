...
class FAAQueue<E> {
    ...
    fun enqueue(element: E) {
        while (true) {
            ...
            if (tail.value.id < index / SEGMENT_SIZE && !tail.compareAndSet(_tail, segment)) continue
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            if (head.value.id < index / SEGMENT_SIZE && !head.compareAndSet(_head, segment)) continue
