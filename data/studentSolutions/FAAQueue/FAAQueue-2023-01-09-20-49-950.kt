...
class FAAQueue<E> {
    ...
    fun enqueue(element: E) {
        while (true)
        {
            ...
            else if (tail.value.elements[index % SEGMENT_SIZE].compareAndSet(null, element)) {
                return
            }
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            else
            {
                ...
                val segment = findSegment(curHead, index, Operation.deque)
                if (segment.getId() == 0)
                    continue
