...
class FAAQueue<E> {
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            if (segment.cas(i.toInt() % SEGMENT_SIZE, null, -100001)) {
                continue
            }
            return segment.elements[i.toInt() % SEGMENT_SIZE].value as? E
//            val res = segment.getAndSet(i.toInt() % SEGMENT_SIZE, -100001) ?: continue
//            return res as? E
        }
    }
