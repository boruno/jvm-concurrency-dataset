...
class FAAQueue<E> {
    ...
    fun enqueue(element: E) {
        while (true) {
            ...
            while (tail.value.id < my.id && !tail.compareAndSet(curTail, my)) {
                continue
            }

            if (my.cas(curIndex, null, Segment.Element(element))) {
                return
            }
        }
    }
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            while (head.value.id < my.id && !head.compareAndSet(curHead, my)) {
                continue
            }

            if (my.cas(curIndex, null, Segment.Broken)) {
                continue
            }
