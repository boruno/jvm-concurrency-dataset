...
class FAAQueue<E> {
    ...
    private fun findSegment(start: Segment, id: Long): Segment {
        ...
        while(true)
        {
            println("Searching for " + id + ". Current segment " + currentSegment.id)
            iteration++
            if (iteration > 1000) {
                println("Current segment: " + currentSegment.id + " Searching segment id: " + id)
            ...
            if (currentSegment.next.value == null)
            {
                ...
                println("New current segment id: " + currentSegment.id + " Searching for " + id)
            }
        }
    }
