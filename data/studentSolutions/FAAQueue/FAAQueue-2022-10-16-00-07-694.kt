...
class FAAQueue<E> {
    ...
    private val enqIdx = atomic(0L) // Head pointer
    private val deqIdx = atomic(0L) // Tail pointer
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            moveHeadForward(s)
            if (s.cas((i % SEGMENT_SIZE).toInt(), null, done)) continue
     ...
     */
    var isEmpty: Boolean = deqIdx.value >= enqIdx.value
