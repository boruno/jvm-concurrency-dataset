...
class FAAQueue<E> {
    ...
    private val enqProcessing = atomic(0L)
    ...
    fun dequeue(): E? {
        while (true) {
            ...
            val value = curHead.elements[(i % SEGMENT_SIZE).toInt()].value
            if (value != null && value != "0") {
                if (curHead.elements[(i % SEGMENT_SIZE).toInt()].compareAndSet(value, "0")) {
