...
class MSQueueWithOnlyLogicalRemove<E> : QueueWithRemove<E> {
    ...
    private class Node<E>(
        ...
        fun markExtractedOrRemoved(): Boolean =
            _extractedOrRemoved.compareAndSet(false, true).alsoIfTrue { element = null }
         ...
         */
        fun remove(): Boolean {
            return _extractedOrRemoved.compareAndSet(true, false)
...
inline fun Boolean.alsoIfTrue(sideEffect: () -> Unit) = this.also { if (this) sideEffect() }