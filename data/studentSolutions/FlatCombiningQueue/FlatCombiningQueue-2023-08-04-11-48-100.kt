    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            if (combinerLock.compareAndSet(false, true)) {
                ...
                if (value is Result<*>) {
                    tasksForCombiner[indexWithResult!!].compareAndSet(value, null)
                    return
                }
            }
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            if (combinerLock.compareAndSet(false, true)) {
                ...
                val result: E?
                if (indexWithResult != null) {
                    val value = tasksForCombiner[indexWithResult!!].value
                    if (value is Result<*>) { result = value.value as E } else { result = queue.removeFirstOrNull() }
