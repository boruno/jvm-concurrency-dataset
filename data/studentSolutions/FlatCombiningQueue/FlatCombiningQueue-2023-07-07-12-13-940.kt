...
class FlatCombiningQueue<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            ...
            val myTask = if (taskIndex != -1) tasksForCombiner[taskIndex].value else null
            if (myTask != null && myTask is Result<*>) {
                tasksForCombiner[taskIndex].compareAndSet(myTask, null)
                return
            }
        }
    }
