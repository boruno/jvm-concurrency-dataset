...
class FlatCombiningQueue<E> : Queue<E> {
    ...
    override fun enqueue(element: E) {
        ...
        // (2b)
        waitUntilResultOrEnqueueWithLock(element)
    }

    private fun waitUntilResultOrEnqueueWithLock(element: E) {
        val index = randomCellIndex()
        val success = tasksForCombiner.compareAndSet(index, null, element)
        if (success) {
            while (true) {
            ...
            if (tryLock()) {
                ...
                return waitUntilResultOrEnqueueWithLock(element)
            }
        }
    }
    ...
    override fun dequeue(): E? {
        ...
        // (2b)
        return waitForResultOrDequeueWithLock()
    }
