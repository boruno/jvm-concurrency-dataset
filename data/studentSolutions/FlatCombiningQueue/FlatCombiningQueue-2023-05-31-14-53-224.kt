...
class FlatCombiningQueue<E> : Queue<E> {
    ...
    private val tasksForCombiner = atomicArrayOfNulls<State<E>?>(TASKS_FOR_COMBINER_SIZE)
    ...
    private fun combine() {
        for (i in 0 until TASKS_FOR_COMBINER_SIZE) {
            ...
            } else if (task?.operationState != null) {
                queue.add(task.operationState as E)
    ...
    override fun dequeue(): E? {
        ...
        if (combinerLock.compareAndSet(expect = false, update = true)) {
            ...
            val request = State<E>(DEQUE_TASK)
    ...
    private data class State<E>(val operationState: Any?, val operationResult: E? = null)
}
