    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            if (combinerLock.compareAndSet(false, true)) {
                if (!isPlaced || tasksForCombiner.compareAndSet(i, element, null)) {
                ...
                for (i in 0..TASKS_FOR_COMBINER_SIZE - 1) {
                    ...
                    if (cell is Dequeue) {
                        ...
                        tasksForCombiner.compareAndSet(i,  result, Result(result))
                    }
                }
        ...
        while (true) {
            if (combinerLock.compareAndSet(false, true)) {
                ...
                if (isPlaced && !tasksForCombiner.compareAndSet(i, Dequeue, null)) {
                    result = (tasksForCombiner.getAndSet(i, null) as Result<*>).value as E?
                } else {
