...
class FlatCombiningQueue<E> : Queue<E> {
    ...
    private class enqueElement<E>(val value: E) {}

    private class dequeElement<E>(val value: E?) {}
    ...
    override fun enqueue(element: E) {
        ...
        while (!combinerLock.compareAndSet(false, true)) {
            if (pushed) {
                ...
                if (tasksForCombiner[index].compareAndSet(null, enqueElement(element))) pushed = true
        ...
        for (taskIndex in 0..(tasksForCombiner.size - 1)) {
            ...
            if (localElement is enqueElement<*>) {
            ...
            if (localElement == DEQUE_TASK) {
                tasksForCombiner[taskIndex].compareAndSet(DEQUE_TASK, dequeElement(queue.removeFirstOrNull()))
            }
        }
    ...
    override fun dequeue(): E? {
        ...
        if (!pushed) {
            ...
            val node = tasksForCombiner[index].value as dequeElement<E?>
            element = node.value
