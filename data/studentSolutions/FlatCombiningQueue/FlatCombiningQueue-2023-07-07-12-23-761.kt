    ...
    override fun enqueue(element: E) {
        ...
        while (true) {
            if (combinerLock.compareAndSet(false, true)) {
                ...
                if (tasksForCombiner[index].compareAndSet(null, element)) continue
                if (tasksForCombiner[index].compareAndSet(OK, null)) return
            }
        }
    }
    ...
    override fun dequeue(): E? {
        ...
        while (true) {
            if (combinerLock.compareAndSet(false, true)) {
                ...
                if (tasksForCombiner[index].compareAndSet(null, Dequeue)) continue
                val curVal = tasksForCombiner[index].value
                if (curVal is Result<*>){
                    if (tasksForCombiner[index].compareAndSet(curVal, null)) return curVal.value as? E?
                }
            }
        }
    }
