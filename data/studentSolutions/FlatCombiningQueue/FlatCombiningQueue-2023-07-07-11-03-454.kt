        ...
        while (true) {
            if (combinerLock.tryLock()) {
                ...
                if (tasksForCombiner[index].compareAndSet(null, element)) {
                    ...
                    if (!tasksForCombiner[index].compareAndSet(element, null)) {
        ...
        while (true) {
            if (combinerLock.tryLock()) {
                ...
                if (tasksForCombiner[index].compareAndSet(null, Dequeue)) {
                    ...
                    if (!tasksForCombiner[index].compareAndSet(Dequeue, null)) {
                        val result = tasksForCombiner[index].value as Result<*>
                        tasksForCombiner[index].compareAndSet(result, null)
                        return result as E
                    }
...
private const val COUNT_OF_ATTEMPTS = 10 // Do not change this constant!
