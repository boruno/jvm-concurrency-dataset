...
class FlatCombiningQueue<E> : Queue<E> {
    ...
    fun enqueueIfAcquired(element: E, idx: Int? = null) {
        queue.addLast(element)
        if (idx != null) { tasksForCombiner[idx].getAndSet(null) }
        go()
    }
    ...
    fun dequeueIfAcquired(idx: Int? = null): E? {
        val res = queue.removeFirstOrNull()
        if (idx != null) { tasksForCombiner[idx].getAndSet(null) }
        go()
        return res
