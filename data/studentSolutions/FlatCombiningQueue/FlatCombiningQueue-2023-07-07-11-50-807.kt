    ...
    override fun enqueue(element: E) {
        ...
        if (isCombiner) {
            ...
            while (true) {
                ...
                if (tryLock()) {
                    val taskState = tasksForCombiner[index].getAndSet(null)
                    if (taskState is Result<*>) {
                        return
                    }
                    enqueueCombiner(element)
                    return
        ...
        for (i in 0 until tasksForCombiner.size) {
            ...
            when {
                task is Dequeue -> {
                    ...
                    tasksForCombiner[i].value = Result(res)
                }
