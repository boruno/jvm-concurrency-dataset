...
class MpscChunkedArrayQueueTest {
    private val queue = MpscChunkedArrayQueue<Int>(1024, 2048)
    ...
    @Test
    fun mpscChunkedArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpscChunkedArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
