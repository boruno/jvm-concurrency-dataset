...
class MpscCompoundQueueTest {
    private val queue = MpscCompoundQueue<Int>(1024)
...
//    fun size() = queue.size
    ...
    @Test
    fun mpscCompoundQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpscCompoundQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
