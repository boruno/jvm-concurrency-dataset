...
class MpscLinkedUnpaddedQueueTest {
    private val queue = MpscLinkedUnpaddedQueue<Int>()
...
//    fun size() = queue.size
    ...
    @Test
    fun mpscLinkedUnpaddedQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpscLinkedUnpaddedQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
