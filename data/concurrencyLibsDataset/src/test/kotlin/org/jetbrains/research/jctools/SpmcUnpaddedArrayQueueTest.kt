...
class SpmcUnpaddedArrayQueueTest {
    private val queue = SpmcUnpaddedArrayQueue<Int>(1024)
    ...
    @Test
    fun spmcUnpaddedArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spmcUnpaddedArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
