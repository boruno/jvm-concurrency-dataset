...
class MpmcArrayQueueTest {
    private val queue = MpmcArrayQueue<Int>(1024)
    ...
    @Test
    fun mpmcArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpmcArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
