...
class MpscUnpaddedArrayQueueTest {
    private val queue = MpscUnpaddedArrayQueue<Int>(1024)
    ...
    @Test
    fun mpscUnpaddedArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpscUnpaddedArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
