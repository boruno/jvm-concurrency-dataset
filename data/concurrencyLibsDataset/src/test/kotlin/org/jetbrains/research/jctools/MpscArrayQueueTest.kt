...
class MpscArrayQueueTest {
    private val queue = MpscArrayQueue<Int>(1024)
    ...
    @Test
    fun mpscArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpscArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
