...
class ForwardingBlockingDequeTest {
    ...
    @Test
    fun forwardingBlockingDequeStressTest() = StressOptions().check(this::class)

    @Ignore("Blocking structures are currently unsupported")
    @Test
    fun forwardingBlockingDequeModelCheckingTest() = ModelCheckingOptions().check(this::class)
