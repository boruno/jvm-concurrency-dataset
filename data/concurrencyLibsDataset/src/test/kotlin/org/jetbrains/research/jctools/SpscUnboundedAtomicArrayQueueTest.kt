...
class SpscUnboundedAtomicArrayQueueTest {
    private val queue = SpscUnboundedAtomicArrayQueue<Int>(1024)
...
//    fun size() = queue.size
    ...
    @Test
    fun spscUnboundedAtomicArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spscUnboundedAtomicArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
