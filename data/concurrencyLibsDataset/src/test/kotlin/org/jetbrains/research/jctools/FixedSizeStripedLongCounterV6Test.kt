...
class FixedSizeStripedLongCounterV6Test {
    ...
    @Test
    fun fixedSizeStripedLongCounterV6StressTest() = StressOptions().check(this::class)

    @Ignore("Temporary ignored due to being an internal class of JCTools")
    @Test
    fun fixedSizeStripedLongCounterV6ModelCheckingTest() = ModelCheckingOptions().check(this::class)
}