...
class SpmcAtomicArrayQueueTest {
    private val queue = SpmcAtomicArrayQueue<Int>(1024)
    ...
    @Test
    fun spmcAtomicArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spmcAtomicArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
