...
class MpscGrowableUnpaddedArrayQueueTest {
    ...
    @Test
    fun mpscGrowableUnpaddedArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpscGrowableUnpaddedArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
