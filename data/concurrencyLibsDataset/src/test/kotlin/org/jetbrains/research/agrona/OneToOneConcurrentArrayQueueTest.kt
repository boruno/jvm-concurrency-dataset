...
class OneToOneConcurrentArrayQueueTest {
    private val queue = OneToOneConcurrentArrayQueue<Int>(1024)
...
//    fun size() = queue.size
    ...
    @Test
    fun oneToOneConcurrentArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun oneToOneConcurrentArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
