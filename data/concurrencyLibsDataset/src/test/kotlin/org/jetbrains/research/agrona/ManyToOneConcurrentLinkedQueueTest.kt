...
//    fun size() = queue.size
    ...
    @Test
    fun manyToOneConcurrentLinkedQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun manyToOneConcurrentLinkedQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
