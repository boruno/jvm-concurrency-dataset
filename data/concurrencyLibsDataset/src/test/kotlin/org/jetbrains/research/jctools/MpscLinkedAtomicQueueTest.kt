...
class MpscLinkedAtomicQueueTest {
...
//    fun size() = queue.size
    ...
    @Test
    fun mpscLinkedAtomicQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpscLinkedAtomicQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
