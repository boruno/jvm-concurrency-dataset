...
class SpscChunkedUnpaddedArrayQueueTest {
    private val queue = SpscChunkedUnpaddedArrayQueue<Int>(1024, 2048)
...
//    fun size() = queue.size
    ...
    @Test
    fun spscChunkedUnpaddedArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spscChunkedUnpaddedArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
