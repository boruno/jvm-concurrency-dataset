...
class MpscBlockingConsumerArrayQueueTest {
    ...
    @Test
    fun mpscBlockingConsumerArrayQueueStressTest() = StressOptions().check(this::class)

    @Ignore ("Blocking structures are currently unsupported")
    @Test
    fun mpscBlockingConsumerArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
