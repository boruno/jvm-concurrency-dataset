...
class SpscGrowableAtomicArrayQueueTest {
    private val queue = SpscGrowableAtomicArrayQueue<Int>(1024, 2048)
...
//    fun size() = queue.size
    ...
    @Test
    fun spscGrowableAtomicArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spscGrowableAtomicArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
