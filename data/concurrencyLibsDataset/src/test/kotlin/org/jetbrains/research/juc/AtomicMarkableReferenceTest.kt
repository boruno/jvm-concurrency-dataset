...
class AtomicMarkableReferenceTest {
    ...
    @Test
    fun atomicMarkableReferenceStressTest() = StressOptions().check(this::class)

    @Test
    fun atomicMarkableReferenceModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
