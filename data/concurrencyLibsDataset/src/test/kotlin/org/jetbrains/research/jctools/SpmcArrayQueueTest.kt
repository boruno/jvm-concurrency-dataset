...
class SpmcArrayQueueTest {
    private val queue = SpmcArrayQueue<Int>(1024)
    ...
    @Test
    fun spmcArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spmcArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
