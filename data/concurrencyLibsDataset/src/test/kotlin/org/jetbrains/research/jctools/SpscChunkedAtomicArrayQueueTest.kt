...
class SpscChunkedAtomicArrayQueueTest {
    private val queue = SpscChunkedAtomicArrayQueue<Int>(1024, 2048)
...
//    fun size() = queue.size
    ...
    @Test
    fun spscChunkedAtomicArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spscChunkedAtomicArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
