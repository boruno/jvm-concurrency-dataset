...
class SpscUnpaddedArrayQueueTest {
    private val queue = SpscUnpaddedArrayQueue<Int>(1024)
...
//    fun size() = queue.size
    ...
    @Test
    fun spscUnpaddedArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spscUnpaddedArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
