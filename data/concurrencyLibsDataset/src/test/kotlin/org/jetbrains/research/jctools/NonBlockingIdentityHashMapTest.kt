...
//    fun size() = map.size
    ...
    @Test
    fun nonBlockingIdentityHashMapStressTest() = StressOptions().check(this::class)

    @Test
    fun nonBlockingIdentityHashMapModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
