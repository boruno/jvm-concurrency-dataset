...
//    fun size() = queue.size
    ...
    @Test
    fun spscUnboundedUnpaddedArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spscUnboundedUnpaddedArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
