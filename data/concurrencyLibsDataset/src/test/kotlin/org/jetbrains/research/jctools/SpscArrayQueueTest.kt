...
class SpscArrayQueueTest {
    private val queue = SpscArrayQueue<Int>(1024)
...
//    fun size() = queue.size
    ...
    @Test
    fun spscArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun spscArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
