...
class MpscUnboundedArrayQueueTest {
    private val queue = MpscUnboundedArrayQueue<Int>(1024)
    ...
    @Test
    fun mpscUnboundedArrayQueueStressTest() = StressOptions().check(this::class)

    @Test
    fun mpscUnboundedArrayQueueModelCheckingTest() = ModelCheckingOptions().check(this::class)
}
