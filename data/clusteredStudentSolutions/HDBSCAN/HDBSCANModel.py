...
dataset_path = "../../studentSolutions"
output_path = "."
tokenizer = RobertaTokenizer.from_pretrained("microsoft/codebert-base", force_download=True)
model = RobertaModel.from_pretrained("microsoft/codebert-base", force_download=True)
...
def process_task_folder(task_folder):
    ...
    print(f"Completed processing for {task_name}. Time taken: {elapsed_time:.2f} seconds")
    print(f"Results stored in {json_path} and {result_file_path}")
